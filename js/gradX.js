...
var gradX = function(id, _options) {
    ...
    gradx = {
        ...
        get_style_value: function() {
            ...
            if (len === 1) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    $("#duotone_bg_rgba" + (i + 1)).val(this.sliders[i][0]);
                    $("#duotone_bg_pos" + (i + 1)).val(this.sliders[i][1]);
        ...
        load_gradx: function(id, sliders, name) {
            this.me = gradx.gx(id);
            this.id = id.replace("#", "");
            id = this.id;
            name = this.name;
            ...
            var html = "<div class='gradx'>\n\
                        ...
                        <input type='hidden' name='" + name + "' class='gradx_code' id='gradx_code'>\n\
                    </div>";
