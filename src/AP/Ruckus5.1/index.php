...
{
	protected $url_postfix = '/wsg/api/public/v8_0';
	protected $switch_url_postfix = '/switchm/api/v8_0';
    protected $ap;
...
public function deleteSwitch($switch_id){
    ...
    public function addDPSKClient($zoneId,$wlanId,$mac,$passPhrase,$nickName=null){
        ...
        if(is_null($nickName)){
            ...
            $user_name = preg_replace('/[^A-Za-z0-9]/', '', $nickName);
		}
