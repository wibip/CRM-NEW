...
{
    protected $url_postfix = '/wsg/api/public/v6_1';
    protected $ap;
...
//$this->log(__FUNCTION__,'Check Zones', $url2 ,'GET', $status , $message , '');
	...
	*/
	...
	///////////////creat network///////////////
	 public function createnetwork($zoneid,$name,$ssid, array $data = NULL,$accessVlan){
...
public function ACLdelete($zoneid,$id){
	...
	$input=$this->session();
	$url = $input[baseurl].'/rkszones/'.$zoneid.'/wlans/'.$id.'/l2ACL';
	$curl = curl_init($url);
...
function hideSSID($zoneid,$id,$enable){
    ...
    public function modifyZoneDNSServerProfile($zone,$dnsProfileId,$dnsProfileName){
        ...
        //$this->log(__FUNCTION__,'Create CPE', $api_path,'POST', $status, $message, json_encode($jsonData));
        $url2 = 'modifyWLanDNSServerProfile()';
        $message = '';
    ...
    public function disableZoneDNSServerProfile($zone){
        ...
        //$this->log(__FUNCTION__,'Create CPE', $api_path,'POST', $status, $message, json_encode($jsonData));
        $url2 = 'disableWLanDNSServerProfile()';
        $message = '';
    ...
    /////////////////disable wlan DNS Profile details///////////////////
...
//echo $response;
    ...
    public function createHotspot($zoneid, array $data_ar){
        ...
        $url2=$input[baseurl].'/rkszones/'.$zoneid.'/portals/hotspot/external';
...
//echo $response;
        ...
        $this->log(__FUNCTION__,'Create hotspot', $url2,'POST', $status, $message, $data,$this->realm);
    ...
    public function createGuestSSID($zoneid, array $data_ar,$guestAddParametres=[]){
        ...
        $url2=$input[baseurl].'/rkszones/'.$zoneid.'/wlans/wisprmac';
...
//echo $response;
        ...
        $this->log(__FUNCTION__,'Create Guest SSID', $url2,'POST', $status, $message, $data,$this->realm);
...
//echo $response;
        ...
        $this->log(__FUNCTION__,'Create DHCP Pool', $url2,'POST', $status, $message, $data,$this->realm);
 ...
 ///////////////creat zones/////////////////
	...
	public function createZoneDual($name,array $data,$domain_id=NULL,$latitude=NULL,$longitude=NULL){
		...
		$url2=$input[baseurl].'/rkszones/dual';
		$ch2 = curl_init($url2);
    ...
    public function getGreProfile(){
        ...
        $url2=$input[baseurl].'/profiles/tunnel/ruckusgre';
        $ch2 = curl_init($url2);
    ...
    public function getRadius(){
        ...
        $url2=$input[baseurl].'/services/auth/radius';
        $ch2 = curl_init($url2);
    ...
    public function getAccountingService(){
        ...
        $url2=$input[baseurl].'/services/acct/radius';
        $ch2 = curl_init($url2);
