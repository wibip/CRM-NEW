...
class network_functions
{
	...
	public function __construct($network_name,$access_method,$system_package)
	{
		...
		$this->networkArr = $this->initialConfig();
	...
	private function initialConfig(){
		...
		$query = "SELECT * FROM exp_network_profile WHERE network_profile = 'vtenant' LIMIT 1";
	...
	public function network($parameter) {
        ...
        /* $query = "SELECT $parameter AS val FROM mdu_network_profile p WHERE p.network_profile='vtenant'";
		$query_results=mysql_query($query);
	...
	public function masterAcc($username,$password,$organization,$first_name,$last_name,$email,$mobile_number,$user_data_string,$product,$validity_time){
		...
		if ($err) {
			...
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date``portal`)
					VALUES ('Create Account', '$username','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
...
/* 				$status_code = $result['result']['!code'];
	...
	//	echo '<h2>Response</h2><pre>' . htmlspecialchars($client->response, ENT_QUOTES) . '</pre>';
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
          		VALUES ('Create Account', '$username', '$u_id','$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function subAcc($mac,$username,$organization,$first_name,$last_name,$email,$mobile_number,$vlanid=NULL){
		...
		if ($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Add Device', '$mac','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
      ...
      $params = array(
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Add Device', '$mac','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function modifyAcc($username,$email,$password,$first_name,$last_name,$organization,$mobile_number,$user_data_string){
		...
		if ($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Modify Account', '$username','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
		...
		$result = $client->call('updateAccountRequest', $params_update,'User-Name',$username,'Aptilo-WiFi-Account-DB', 'http://soap.amazon.com');
...
/*  				$status_code = $result['code'];
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Modify Account', '$username','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function resetPassword($email,$password){
		...
		if ($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,unique_id,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Modify Password', '$email','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
        ...
        if ($client->fault) {
			...
			if ($err) {
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,unique_id,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Modify Password', '$email','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function AUP_Activate($email,$violation){
		...
		if ($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Reconnect User', '$email','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
...
/* 				$status_code = $result['!code'];
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Reconnect User', '$email','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
...
/* 		$fields = array(
	 ...
	 */
		...
		if($err) {
			...
			$desc = $client->getError();
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Search Users', '$search_string_log','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
		...
		$request_html = $client->request;
		$response_html = $client->response;
		$advanced_log = sprintf("INSERT INTO `mdu_network_logs_detail` (`unique_id`,`request`,`response`,`create_date`,`create_user`)
		VALUES ('$u_id',%s,%s,now(),'LOG')",  mysql_real_escape_string($request_html),  mysql_real_escape_string($response_html));
		$advanced_log_ex= mysql_query($advanced_log);
		...
		if ($client->fault) {
			...
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Search Users', %s,'$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($search_string_log),  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
...
/* 				$status_code = $result['result']['!code'];
			...
			//	echo $profile_string_final;
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Search Users', %s,'$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($search_string_log),  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function findUsersByMaster($master_user){
		...
		if ($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Get Devices', '$master_user','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
	...
	$sync_limit = $this->network('record_limit');
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Get Devices', '$master_user','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
	...
	public function delUser($network_user){
		...
		$client = new nusoap_client("$this->url", false,'', '', '', '');
					...
					$desc = $client->getError();
					$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
							VALUES ('Delete Account', '$network_user','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
							$ex_1 = mysql_query($q_lo);
					...
					if ($client->fault) {
						...
						if ($err) {
							...
							$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
									VALUES ('Delete Account', '$network_user','$u_id', '$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
							$ex_1 = mysql_query($q_lo);
	...
	public function disconnectDeviceSessions($user_name,$aaa_user_name = NULL){
		...
		if($err) {
			...
			$desc = $client->getError();
			$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
					VALUES ('Disconnect User Sessions', '$user_name','$u_id', '', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
			$ex_1 = mysql_query($q_lo);
		...
		$result = $client->call('disconnectSessionRequest', $params,$params2, 'Aptilo-WiFi-Account-DB', 'http://soap.amazon.com');
...
/* 				$status_code = $result['!code'];
				...
				//	echo $profile_string_final;
				$q_lo = sprintf("INSERT INTO `mdu_network_logs` (`function`,`reference`,`unique_id`,`status`,`status_description`,`create_user`,`create_date`,`portal`)
						VALUES ('Disconnect User Sessions', '$user_name', '$u_id','$status_code', '%s', 'API', NOW(),'scp')",  mysql_real_escape_string($desc));
				$ex_1 = mysql_query($q_lo);
