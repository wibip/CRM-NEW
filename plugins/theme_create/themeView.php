...
<head>
    ...
    <?php 
        require_once __DIR__.'/../../layout/'.$camp_layout.'/index.php';
    ?>
...
<body>
    ...
    $src = "themeCreate.php?reg_type=".$reg_type."&page=".$page."&template_name=".$template_name."&theme_id=".$theme_id."&enc=".$enc."&action=".$action."&modify_st=".$modify_st."&dist=".$user_distributor.$str;
...
<iframe src="<?php echo $src; ?>" onload="setHeight(this)">
</iframe>
<script type="text/javascript">
  function setHeight(iframe) {
      var x = iframe.contentWindow.document.getElementsByClassName("main-inner")[0].scrollHeight;
      if(x > $(document).height()){
          iframe.style.height =  x + "px";
      }
  }
</script>  
</div>
