...
$dirname=  'res_cox_block_template';
...
$jpeg_quality = 100;
$img_name = $discode."_".rand();
$output_filename = "../../$baseportal/ads/temp/".$img_name;
...
break;
	...
	$response = Array(
	    "status" => 'success',
	    "url" => $globle_url.'/'.$base_portal_folder.'/ads/temp/'.$img_name.$ext,
		"ori"  => $imgUrl,
		"itag" => 'logo1_up_bc'	
    );
