...
if(!$db->ajaxAccess($module_array,$system_package)){
...
$img_id = $_POST["img_id"];
//echo "<script> console.log('".$img_id."'); </script>";
...
$output_filename = "../../import/temp_images/".$discode."_".rand();

//echo "<input type='hidden' id='old_img_5' value='".$output_filename."'>";
...
break;
	...
	$response = Array(
	    "status" => 'success',
	    "url" => 'import/temp_images/'.$output_filename.$ext,
		"ori"  => $imgUrl,
