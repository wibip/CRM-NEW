<div class="tab-pane <?php echo isset($tab_tenant_session)?'in active':''; ?>" id="tenant_session">
      ...
      <div class="" align="center" style="vertical-align:top;">
         <h2 style="text-align: left;"> Session Search <img data-toggle="tooltip" title="You can search for a tenant's online sessions using Email, First Name or device MAC Address. To get a list of all sessions, click the Search Button." src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h2>
         </div>
      <br>
      <form id="edit-profile" action="?t=tenant_session" method="post" class="form-horizontal middle" >
        ...
        <fieldset>
          ...
          <label class="control-label" for="radiobtns">Search Tenants <img data-toggle="tooltip" title="You can search for a tenant sessions using First Name or Email or use the Search MAC field." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
