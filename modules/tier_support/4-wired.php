<?php $db = new db_functions();
 ?>					
								   ...
								   <style>  
									...
									<table id="device_sessions" class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
										...
										?>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="10">Client IP</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="10">VLAN Subnet</th>
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="10">Device Type</th>
										...
										if(isset($_POST['search_mac_sessions']) || isset(
											...
											foreach ($newjsonvalue as $value2) {
                                                ...
                                                array_push($tb_arr,$Client_IP);
												array_push($tb_arr,$vLAN);
                                                array_push($tb_arr,$Device_Type);
         ...
         */
									...
									<form style="display: none;" action="?t=tier_support" class="form-horizontal" method="post" id="add_mac_form" name="add_mac_form">
