<div <?php if(isset($tab_private_schedule)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?>  id="private_schedule">
    <?php if(isset($_SESSION['private_schedule'])){
    echo $_SESSION['private_schedule'];
    unset($_SESSION['private_schedule']);
    } 
    /*$isDynamic = $package_functions->isDynamic($system_package);
    if ($isDynamic) {
        $user_system_package="DYNAMIC_SIMP_001";
    }else{
        $user_system_package=$system_package;
    }*/
    $gst_wifi_schedule_intro=$message_functions->getPageContent('private_wifi_schedule_content',$system_package);
    if (strlen($gst_wifi_schedule_intro)>0) {
    $txt_replace = array(
    ...
    $gst_wifi_schedule_intro = strtr($gst_wifi_schedule_intro, $txt_replace);
    echo $gst_wifi_schedule_intro;
    } ?>
    <style type="text/css">
        ...
        .ui-slider-horizontal .ui-slider-rangep {
            top: -1px;
            height: 100%;
        }
        .ui-slider .ui-slider-rangep {
            position: absolute;
            z-index: 1;
            height: 8px;
            font-size: .7em;
    ...
    <script type="text/javascript">
        ...
        function AllP(all,id){
            ...
            if(all=='on'){
                $(".slider-rangep-"+id).slider('values',0,0);
                $(".slider-rangep-"+id).slider('values',1,1440);

            }
            else if(all=='off'){
                $(".slider-rangep-"+id).slider('values',0,0);
                $(".slider-rangep-"+id).slider('values',1,0);
            }
            else{
                $(".slider-rangep-"+id).slider('values',0,540);
                $(".slider-rangep-"+id).slider('values',1,1020);
            }
        }
    ...
    if(method_exists($wag_obj,'retrieveSchedule')){
        ...
        if($ssid_res['rowCount']>0){
            ...
            foreach ($ssid_res['data'] as $row){
                ...
                ?>
                <form id="tab5_form<?php echo$sID; ?>" name="tab5_form1" method="post" action="modules/ssid_schedule/1-submit?t=private_schedule&script=<?php echo $script; ?>" class="form-horizontal">
                    <br/>
                    <fieldset class="fieset">
                        ...
                        <div>
                            ...
                            <div class="power_box1" style="    padding: 28px;    border: 1px solid #dec8c8;    width: 60%;;float: left;">
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-mon<?php echo$sID; ?>" data-time="mon"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-tue<?php echo$sID; ?>" data-time="tue"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-wed<?php echo$sID; ?>" data-time="wed"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-thu<?php echo$sID; ?>" data-time="thu"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-fri<?php echo$sID; ?>" data-time="fri"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-sat<?php echo$sID; ?>" data-time="sat"></div>
                                ...
                                <div class="days">
                                    ...
                                    <div class="slider-rangep slider-rangep-<?php echo$sID; ?>" id="slider-rangep-sun<?php echo$sID; ?>" data-time="sun"></div>

                                </div>

                            </div>

                            <div class="power_box2" style="height: 469px !important;width: 30%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;padding: 20px">
                                <h2>SSID :  <br>
                                ...
                                <input type="radio" class="radio-black" name="all" onclick="AllP(this.value,<?php echo$sID; ?>)" value="on" <?php if($WLan_schedule_type=='AlwaysOn'){ ?> checked="checked" <?php } ?>> Always On <br><br>
                                <input type="radio" class="radio-black" name="all" onclick="AllP(this.value,<?php echo$sID; ?>)" value="off" <?php if($WLan_schedule_type=='AlwaysOff'){ ?> checked="checked" <?php } ?>> Always Off <br><br>
                                <input type="radio" class="radio-black" name="all" onclick="AllP(this.value,<?php echo$sID; ?>)" value="custom" <?php if($WLan_schedule_type=='Customized'){ ?> checked="checked" <?php } ?>> Schedule <br><br>
                ...
                <script>
                    $("#slider-rangep-mon<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-tue<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-wed<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-thu<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-fri<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-sat<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
                    ...
                    $("#slider-rangep-sun<?php echo$sID; ?>").slider({
                        range: true,
                        min: 0,
                        max: 1440,
                        step: 60,
