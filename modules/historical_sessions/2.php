...
.alert-manual strong {
    font-weight: normal !important;
                                            ...
                                            <div class="alert-manual alert-danger" id="gatewayTimeoutError" style="display: none;"><button type="button" class="close" data-dismiss="alert">×</button><strong><?php echo $message_functions->showMessage('gateway_timeout_error'); ?></strong></div>

                                     <form name="lawful_form1" id="lawful_form" class="form-horizontal" method="post" action="?t=historical_sessions" onchange="change_li_view()">
                                                        ...
                                                        <script type="text/javascript">
                                                         ...
                                                         <div class="form-actions">
                                                            <input type="hidden" name="secret" value="<?php echo $secret;?>">
                                                                <button name="li_view_cox" id="li_view_cox"  class="btn btn-primary" style="text-decoration:none">
                                                                ...
                                                                <?php if($camp_layout!="COX"){ ?>
                                                                    <script type="text/javascript">
                                                                        $(document).ready(function() {
                                                                            $("#li_view_cox").easyconfirm({locale: {
                                                                    ...
                                                                    <script>
                                                                        $(document).ready(function () {
                                                                            $("#li_view_cox").click(function() {
                                                                                $('#report_loader').css('visibility', 'visible');
                                                                                $.ajax({
                                                                                        type: 'POST',
                                                                                        url: 'ajax/statistics.php',
                                                                                        data: { to: $('#to_li_date').val(),from: $('#from_li_date').val(),ipaddress: $('#ipaddress').val(),from_time: $('#from_li_time').val(),to_time: $('#to_li_time').val(),port_number_from: $('#port_number').val()  },
                                                                                        success: function(data) {
                                                                                            $('#report_loader').css('visibility', 'hidden');
                                                                                            window.location = "?t=historical_sessions&li_reports=1&response="+data;
                                                                                        },
                                                                                        error: function(){
                                                                                            $('#gatewayTimeoutError').show();
                                                                                            $('#report_loader').css('visibility', 'hidden');
                                                                                        }
                                                            ...
                                                            <?php }  ?>
                                                            <img id="report_loader" src="img/loading_ajax.gif" style="visibility: hidden;">
                                                            </div>
...
<script type="text/javascript">
                                                                ...
                                                                $(document).ready(function() {
                                                                    ...
                                                                    document.getElementById("li_view_cox").disabled = true;
                                                                ...
                                                                function change_li_view(){
                                                                    ...
                                                                    if(ipv4Regex.test($('#ipaddress').val()) || ipv6Regex.test($('#ipaddress').val())){
                                                                        ipValid = true;
                                                                    }

                                                                    if((ipValid)&&($('#from_li_date').val()!='')&&($('#to_li_date').val()!='')){
                                                                        document.getElementById("li_view_cox").disabled = false;
                                                                        //console.log('f');
                                                                        }
                                                                    else{
                                                                        document.getElementById("li_view_cox").disabled = true;
