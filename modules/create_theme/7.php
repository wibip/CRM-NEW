	...
	<div class="tab-pane <?php if (isset($tab_create_theme )){ echo 'active'; } ?>" id="create_theme">
...
<input type="hidden" id="using">
									   ...
									   <form id="edit-profile1" name="editprofile" class="form-horizontal" method="POST" action="theme.php?t=active_theme" autocomplete="off">
...
$gt_template_optioncode= $pack_func->getOptions('TEMPLATE_ACTIVE',$sys_pack,'MVNO');
...
$gt_reg_optioncode= $pack_func->getOptions('THEME_REG_TYPE',$sys_pack,'MVNO');
...
<div id="divlogo1" class="control-group">
		   ...
		   if($back_or_logo=='logo'){ ?>
											   ...
											   <div id="logo1_up">
			   <?php if($modify_mode==1 && pathinfo($th_background_image, PATHINFO_EXTENSION) && $upload_img->is_exists($th_background_image,'bg') == 1){?>
...
<small id="back2_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="back2_up_validate" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
			   ...
			   <?php if($modify_mode==1 && pathinfo($th_background_image2, PATHINFO_EXTENSION) && $upload_img->is_exists($th_background_image2,'bg') == 1){?>
											   <!-- <img id="back2_up_img" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image2; ?>" style="max-width: 100%;"> -->

											   <img id="back2_up_img" class="croppedImg" src="<?php echo $upload_img->get_image($th_background_image2,'bg'); ?>" style="max-width: 100%;">
				   <?php }?>
			   ...
			   <?php } ?>
											   ...
											   <input type="hidden" name="image_back_name_prev" id="image_back_name_prev" value="<?php echo $th_background_image2; ?>" />
...
<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
   ...
   var croppicContaineroutputMinimallogo9 = {
		   ...
		   rotateControls: false,
		   loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
		   onBeforeImgUpload: function(){ window.img_id2 = $('#image_back_name').val(); },
		   ...
		   setColor($('.slider').slider("option", "value"));deleteImg(img_id2);console.log('DeletedonAfterImgCrop')  },
...
<small id="back3_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="back3_up_validate" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
			   ...
			   <?php if($modify_mode==1 && pathinfo($th_background_image3, PATHINFO_EXTENSION) && $upload_img->is_exists($th_background_image3,'bg') == 1){?>
											   <!-- <img id="back3_up_img" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image3; ?>" style="max-width: 100%;"> -->

											   <img id="back3_up_img" class="croppedImg" src="<?php echo $upload_img->get_image($th_background_image3,'bg'); ?>" style="max-width: 100%;">
				   <?php }?>
			   ...
			   <?php } ?>
											   ...
											   <input type="hidden" name="image_back3_name_prev" id="image_back3_name_prev" value="<?php echo $th_background_image3; ?>" />
...
<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
   ...
   var croppicContaineroutputMinimallogo12 = {
		   ...
		   rotateControls: false,
		   loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
		   onBeforeImgUpload: function(){ window.img_id3 = $('#image_back3_name').val(); },
		   ...
		   onImgZoom: function(){ console.log('onImgZoom') },
		   onBeforeImgCrop: function(){ console.log('onBeforeImgCroplogo1_up_bc') },
		   onAfterImgCrop:function(){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check3').val('1'); $('#back3_up').prepend('<div class="slider_change"></div>'); setColor($('.slider').slider("option", "value"));deleteImg(img_id3);console.log('DeletedonAfterImgCrop') },
...
<br>
			   ...
			   <?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION)){?>
											   ...
											   <img id="logo_hi_2" class="croppedImg" src="<?php echo $upload_img->get_image($th_logo_image, 'logo') ; ?>" style="width: 230px;height: 79px;">
			   <?php }?>
											   </div>
