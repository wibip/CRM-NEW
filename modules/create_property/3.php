  ...
  <div <?php if (isset($tab_create_property)) { ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="create_property">
      ...
      <form onkeyup="location_formfn();" onchange="location_formfn();" autocomplete="off" id="location_form" name="location_form" method="post" class="form-horizontal" action="<?php if ($_POST['p_update_button_action'] == 'add_location' || isset($_GET['location_parent_id'])) {
          ...
          <fieldset>
              ...
              <?php }
                //print_r($field_array);
                if ((array_key_exists('new_features', $field_array) || $package_features == "all") && ($edit_account != 1 && !isset($edit_parent_id))) {
                ?>
                  <div class="control-group">
                      <div class="controls col-lg-5 form-group">
                ...
                ?>
                  ...
                  <script type="text/javascript">
                      $(function() {
                          ...
                          changeadminType(0, vt_select);

                          $('#parent_package1').change(function() {
                              changeadminType(1, vt_select);
                          })
                      });
                  </script>
              <?php } else {
                    ...
                    <div class=" control-group" id="icomme_div">
                      ...
                      <?php }
                        ...
                        ?>
                                  ...
                                  <select <?php if ($field_array['business_type'] == "mandatory") { ?>required<?php } ?> class="span4 form-control" id="business_type" name="business_type">
                                      ...
                                      <?php
                                        ...
                                        if (!empty($business_vertical_mno)) {
                                            foreach ($business_vertical_mno as $key) {
                          ...
                          <?php
                                        } elseif (!empty($business_vertical)) {
...
WHERE t1.bzname='1' AND t1.ok";
                  ...
                  <select <?php if ($field_array['p_QOS'] == "mandatory") { ?>required<?php } ?> name="AP_contrl" id="AP_contrl" class="span4 form-control">
                      ...
                      <?php
                                            $q1 = "SELECT product_id,product_code,product_name,QOS,time_gap
                                                        FROM exp_products
                                                        WHERE network_type='private' AND mno_id='$user_distributor'  AND (default_value='0' || default_value IS NULL)";
      ...
      <script type="text/javascript">
          $(document).ready(function() {
              optional_feature();
              optional_feature_pvt();
          });
          document.getElementById("gateway_type").onchange = function() {
              optional_feature()
          };

          function optional_feature() {
              nas_type = $("#gateway_type").val();
              //alert(nas_type);
              if (nas_type == 'WAG') {
                  $('#gateway').show();
                  $('#content_filter_div').hide();
              } else if (nas_type == 'VSZ') {
                  $('#gateway').hide();
          ...
          document.getElementById("network_type").onchange = function() {
              optional_feature_pvt()
          };
          document.getElementById("pr_gateway_type").onchange = function() {
              optional_feature_pvt()
          };

          function optional_feature_pvt() {
              network_type_arr = $("#network_type").val();
              //alert(network_type_arr);
              nas_type = $("#pr_gateway_type").val();
              if (network_type_arr === null) {} else {

                  if (network_type_arr.indexOf("GUEST") < 0) {
                      //alert(network_type_arr);
                      if (nas_type == 'WAG') {
                          $('#gateway').show();
                          $('#content_filter_div').hide();
              ...
              <div class="controls col-lg-5 form-group">
                  ...
                  <select class="span4 form-control" id="wag_name" name="wag_name" style="display: inline-block">
                      <?php echo '<option value="">Select WAG Option</option>';
                        ...
                        ?>
                  </select><input id="wag_toggle_btn" onchange="wag_control()" type="checkbox" <?php if ($edit_distributor_wag_profile_enable == '1' || strtolower($edit_distributor_wag_profile_enable) == 'on') {
                                                                                                    echo 'checked';
                                                                                                } ?> name="content_filter" class="hide_checkbox" style="display: inline-block;" data-toggle="toggle">
              </div>
              <div class="controls col-lg-5 form-group" style="margin-bottom: 15px;">
      ...
      <?php } else { ?>
          <div class="control-group" id="gateway" <?php if ($edit_distributor_gateway_type == 'ac' || $field_array['ne_WAG'] == 'display_none') {
              ...
              <div class="controls col-lg-5 form-group">
                  ...
                  <input onchange="wag_control()" id="wag_toggle_btn" type="checkbox" <?php if ($edit_distributor_wag_profile_enable == '1' || strtolower($edit_distributor_wag_profile_enable) == 'on') {
                                                                                            echo 'checked';
                                                                                        } ?> name="content_filter" class="hide_checkbox" style="display: inline-block" data-toggle="toggle">
              </div>
              <small>Note: Turn switch to ON to enable content filtering</small>
      ...
      <script type="text/javascript">
          function wag_control() {
              var add_ap_form_validator = $('#location_form').data('bootstrapValidator');
              var wagcheckBox = $('#wag_toggle_btn').is(':checked');
              // alert(dnscheckBox);
              if (wagcheckBox) {
                  add_ap_form_validator.enableFieldValidators('wag_name', true);
              } else {
                  add_ap_form_validator.enableFieldValidators('wag_name', false);
              }

          }
      </script>
      <?php if ($edit_distributor_gateway_type != 'ac' || $field_array['ne_WAG'] != 'display_none') { ?>
          <script type="text/javascript">
              //wag_control();
          </script>
      <?php  } ?>
