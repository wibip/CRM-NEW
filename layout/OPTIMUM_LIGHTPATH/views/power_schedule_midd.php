    ...
    if(isset($_POST['schedule_submit_mid'])) {
        ...
        switch ($all) {
            case 'on': {
                ...
                $wag_obj->modifySchedule($zone_id, $WLanID, 'AlwaysOn','','');
                break;
            }
            case 'off': {

                $wag_obj->modifySchedule($zone_id, $WLanID, 'AlwaysOff','','');
                break;
            }
            case 'custom': {
                ...
                if ($mon_all == "on") {
                    ...
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'mon');

                    //$data_array["mon"] = array("00:00-24:00");
                } elseif ($mon_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $mon_from, $mon_to, $api_data_array, 'mon');
                }
                ...
                if ($tue_all == "on") {
                    ...
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'tue');
                } elseif ($tue_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $tue_from, $tue_to, $api_data_array, 'tue');
                }
                ...
                if ($wed_all == "on") {
                    ...
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'wed');
                } elseif ($wed_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $wed_from, $wed_to, $api_data_array, 'wed');
                }
                ...
                if ($thu_all == "on") {
                    ...
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'thu');
                } elseif ($thu_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $thu_from, $thu_to, $api_data_array, 'thu');
                }
                ...
                if ($fri_all == "on") {
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'fri');
                    //$api_data_array["fri"] = array("00:00-24:00");
                } elseif ($fri_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $fri_from, $fri_to, $api_data_array, 'fri');
                }
                ...
                if ($sat_all == "on") {
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'sat');
                    //$api_data_array["sat"] = array("00:00-24:00");
                } elseif ($sat_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $sat_from, $sat_to, $api_data_array, 'sat');
                }
                ...
                if ($sun_all == "on") {
                    timeComvert($user_time_zone, $user_time_zone, '00:00', '24:00', $api_data_array, 'sun');
                    //$api_data_array["sun"] = array("00:00-24:00");
                } elseif ($sun_all == "off") {
                } else {
                    timeComvert($user_time_zone, $user_time_zone, $sun_from, $sun_to, $api_data_array, 'sun');
                }
                //print_r($api_data_array);
                //echo json_encode($api_data_array);

                if (strlen($schedule_UUID) > 0) {
                    parse_str($wag_obj->modifyPowerSchedule($zone_id, $schedule_UUID, $api_data_array), $modify_sche_respo);
                    //print_r($modify_sche_respo);
                    if ($modify_sche_respo['status_code'] == '200') {
                        $wag_obj->modifySchedule($zone_id, $WLanID, 'Customized', $schedule_UUID, $schedule_name);
                    }


                } else {
                    parse_str($wag_obj->createScheduler($zone_id, $api_data_array), $new_schedule);
                    $new_schedule_id = json_decode($new_schedule['Description'], true)['id'];

                    if ($new_schedule['status_code'] == '200') {
                        $wag_obj->modifySchedule($zone_id, $WLanID, 'Customized', $schedule_UUID, $schedule_name);

                        $local_update_q = "UPDATE exp_distributor_network_schedul_assign SET shedule_uniqu_id = '$new_schedule_id' WHERE distributor = '$user_distributor' AND network_id = '$WLanID'";
                        mysql_query($local_update_q);
                    }
            ...
            switch($WLan_schedule_type){
                case 'Customized' : {
                    ...
                    if($schedule['status_code']=='200'){
                        ...
                        $Description=json_decode($schedule['Description'],true);
                ...
                case 'AlwaysOn' : {
                    ...
                    if(strlen($WLan_schedule_ID)<1){*/
                        ...
                        $schedule_in_controller_ar = json_decode($schedule_in_controller['Description'],true);
                       ...
                       // print_r($controller_shID);
                        ...
                        $local_assigned_schedule_r = mysql_query($local_assigned_schedule_q);
                        while ($row = mysql_fetch_assoc($local_assigned_schedule_r)){
...
?>
<form id="tab5_form1" name="tab5_form1" method="post" action="?t=2" class="form-horizontal">
                                                <br/>
                                                ...
                                                <br>
                                                    <div class="control-group" id="feild_gp_taddg_divt">
                                                        ...
                                                        <div class="controls ">
                                                            <input type="hidden" name="schedule_name" id="schedule_name" class="span4" maxlength="20" value="<?php echo $WLan_schedule_name; ?>"> <!-- onkeyup="validateShedulname(this.value)" --> <div style="display:none;" class="help-block error-wrapper bubble-pointer mbubble-pointer" id="shedule_name_dup"><p><?php echo _POWER_SCHEDULE_NAME_; ?>Schedule name already exists</p></div>
                                                            ...
                                                            <input type="hidden" name="schedule_UUID" id="schedule_UUID" value="<?php echo $WLan_schedule_ID; ?>">
                                                            <input type="hidden" name="WLanID" id="WLanID" value="<?php echo $WLanID;?>">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="power_box1" style="    padding: 30px;    border: 1px solid #dec8c8;    width: 60%;;float: left;">
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="mon_all" value="<?php echo $mon_all; ?>" class="all">
                                                                <div class="slider-range" id="slider-range-mon" data-time="mon"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="tue_all" value="<?php echo $tue_all; ?>" class="all">
                                                                <div class="slider-range" id="slider-range-tue" data-time="tue"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="wed_all" value="<?php echo $wed_all; ?>" class="all">
                                                                <div class="slider-range" id="slider-range-wed" data-time="wed"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="thu_all" value="<?php echo $thu_all; ?>" class="all">
                                                                <div class="slider-range" id="slider-range-thu" data-time="thu"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="fri_all" value="<?php echo $fri_all; ?>" class="all">

                                                                <div class="slider-range" id="slider-range-fri" data-time="fri"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="sat_all" value="<?php echo $sat_all; ?>" class="all">

                                                                <div class="slider-range" id="slider-range-sat" data-time="sat"></div>
                                                            ...
                                                            <div class="days">
                                                                ...
                                                                <input type="hidden" name="sun_all" value="<?php echo $sun_all; ?>" class="all">
                                                                
                                                                <div class="slider-range" id="slider-range-sun" data-time="sun"></div>
                                                                
                                                            </div>
                                                            
                                                        </div>

                                                        <div class="power_box2" style="    height: 518px;width: 30%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;padding: 20px">
                                                            <h2>SSID :  <br>
                                                            ...
                                                            <input type="radio" name="all" onclick="All(this.value)" value="on" <?php if($WLan_schedule_type=='AlwaysOn'){ ?> checked="checked" <?php } ?>> Always On <br><br>
                                                            <input type="radio" name="all" onclick="All(this.value)" value="off" <?php if($WLan_schedule_type=='AlwaysOff'){ ?> checked="checked" <?php } ?>> Always Off <br><br>
                                                            <input type="radio" name="all" onclick="All(this.value)" value="custom" <?php if($WLan_schedule_type=='Customized'){ ?> checked="checked" <?php } ?>> Schedule <br><br>

                                                             <button type="submit" disabled="disabled" name="schedule_submit_mid" id="schedule_submit"  class="btn btn-primary">Set</button>
...
<script type="text/javascript">
    ...
    function All(all){
        ...
        if(all=='on'){
            ...
            $(".slider-range").slider('values',0,540);
...
.ui-slider .ui-slider-range {
    ...
    font-size: .7em;
    display: block;
    border: 1px solid #23d3be !important;
    box-shadow: 0 1px 0 #AAD6F6 inset;
    -moz-border-radius: 6px;
    -webkit-border-radius: 6px;
    -khtml-border-radius: 6px;
    border-radius: 6px;
    background: #23d3be !important;
...
.ui-slider .ui-slider-handle:after {
    ...
    margin-left: -4px;
    background: #23d3be !important;
    -webkit-box-shadow: 0 1px 1px 1px rgb(35, 211, 190) inset, 0 1px 0 0 #FFF;
    -moz-box-shadow: 0 1px 1px 1px rgb(35, 211, 190) inset, 0 1px 0 0 white;
    box-shadow: 0 1px 1px 1px rgb(35, 211, 190) inset, 0 1px 0 0 #FFF !important;
}
