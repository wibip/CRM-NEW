...
function display_btn() {
	var btn1 = document.getElementById("bt_text1");
...
<div class="back-parent one">
													...
													<div id="logo1_up_bc" style="display: block;">

														<div class="slider_change" style="background-color: #191919;opacity: 0.85;"></div> <!-- remove this style - used for demo only -->
...
<br>
					...
					<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION)){?>
													<img id="logo_hi_2" class="croppedImg" src="<?php echo $original_logo_Image_Folder.$th_logo_image; ?>" style="width: 230px;height: 79px;">
					<?php }?>
													</div>
...
<label class="filebutton" style="width:100px !important;text-align:center">
								Browse 
          ...
          <div class="controls" style="margin-left:0px">
				...
				<div id="logo1_up_bc" style="width: 400px; height: 500px" class="input-prepend input-append"> 
					...
					<?php if(!(isset($_GET['modify']))){?>
						...
						<img src="layout/<?php echo $camp_layout; ?>/img/capture2.jpg" style='width:400px;height:500px;object-fit: cover; display:inline;' class=""/>	
						...
						else if(strlen($bg_dft_img)>0){ ?>
						<img src="<?php echo $original_bg_Image_Folder.$bg_dft_img; ?>" style='width:400px; height:500px;object-fit: cover; display:inline;' class="span4">
						<input type="hidden" name="image_1_name" id="image_1_name" value="<?php echo $bg_dft_img; ?>" />
						<div id="load_grad" style="width: 400px; height: 500px;position: absolute;margin-top: -500px;" class="input-prepend input-append"></div>
					...
					<div class="input-prepend input-append" id="img_div2" style="width: 125px; height: 100px;position: absolute;margin-top: -450px;margin-left: 137.5px;">


					<?php if(!(isset($_GET['modify']))){?>
						
						<img src="layout/<?php echo $camp_layout; ?>/img/logo2.png" style='width:125px !important;height:100px !important; display:inline;' class=""/>	
						<div id="load_grad" style="width: 400px; height: 500px;position: absolute;margin-top: -500px;" class="input-prepend input-append"></div>
						<?php } ?>
					...
					<img src="img/logo2.png" style='width:125px !important;height:100px !important; display:inline;' class=""/>
					<?php } ?>
					
				

						<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION) && file_exists($original_bg_Image_Folder.$th_logo_image)){?>

								<img src="<?php echo $original_logo_Image_Folder.$th_logo_image; ?>" style='width:125px;height:100px; display:inline;'>
								<input type="hidden" name="image_2_name" id="image_2_name" value="<?php echo $th_logo_image; ?>" />
				...
				<div class="input-prepend input-append" id="text_dis" style="position:absolute;margin-top:-300px;margin-left:25px;width: fit-content;">
					
					<input class="" type="text" name="txt_display" id="txt_display" style="text-align:center;width:300px;background:transparent;color:#fff" value="<?php if(empty($text1)){ echo "Welcome to the free wifi service"; }else{ echo $text1;} ?>" readonly>

				</div>

				<div class="input-prepend input-append" id="btn_dis" style="position:absolute;margin-top:-250px;margin-left:100px;width: fit-content;">

					<input type="button" name="btn_display" id="btn_display" style="width:200px;background: linear-gradient(to right, #ffffff2e , #ffffff24 );color:#fff;border-radius: 5px !important;height: 40px !important;" value="<?php if(empty($bt_text1)){ echo "Click here to start"; }else{ echo $bt_text1;} ?>" onclick="">
