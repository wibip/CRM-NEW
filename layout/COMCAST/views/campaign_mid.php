...
<script type="text/javascript">
    ...
    $('[data-toggle="tooltip"]').tooltip();
									...
									<form id="create_campaign" name="create_campaign" action="campaign.php?t=2"
										...
										$count_ad_cat = mysql_num_rows($query_results1);
                                    ...
                                    WHERE t.distributor = '$user_distributor'";
										$query_results2 = mysql_query($key_query2);
										$count_gt = mysql_num_rows($query_results2);
										...
										<fieldset>
                                            ...
                                            <?php if(getOptions('CAMPAIGN_CREATE_SIMPLE',$system_package,$user_type)=="ON"){ ?>
...
<option <?php if($secslider=='https://'){echo 'selected';} ?> value="https://">https://</option>
	...
	<!-- /control-group -->	
					...
					<input id="background_color" name="background_color" type="hidden" value="#FFFFFF">
...
<option <?php if($sec_wvideo=='https://'){echo 'selected';} ?> value="https://">https://</option>
											...
											<?php if (getSectionType("CAMP_CREATE_LOCATION", $system_package, $user_type) == "locations" || $package_features == "all") { ?>
												<div class="control-group form-group">
											...
											<?php if (getSectionType("CAMP_CREATE_LOCATION", $system_package, $user_type) == "system_package") { ?>
												<div class="control-group form-group">
