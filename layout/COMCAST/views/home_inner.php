...
/* ul.tree {
 ...
 .treeDesc table td, .treeDesc table th{
    padding-left: 0px;
 }
...
#big_stats .stat.stat-no-border{
  border: none !important; 
}

body svg .highcharts-button text{
  fill: #0e79c4 !important;
}
...
.zg-ul-select:not(.active) li.active{
  background-image: url(layout/<?php echo $camp_layout; ?>/img/down.png);
...
.zg-ul-select.active > li:nth-child(1){
    background-image: url(layout/<?php echo $camp_layout; ?>/img/up.png);
    background-size: 20px;
    background-repeat: no-repeat;
