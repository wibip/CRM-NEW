                    ...
                    <div class="control-group">
                        ...
                        <div>
                            <div class="controls col-lg-5 form-group">
                                ...
                                <input autocomplete="off" required title="8 to 12 characters" class="span4 form-control" id="password" onkeyup="strbar()" name="password" type="password" required minlength="8" maxlength="12" />
