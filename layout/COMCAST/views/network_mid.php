                                                              ...
                                                              <div class="controls col-lg-5 form-group">
                                                                ...
                                                                <label class="" for="ssid_name">Current SSID Name : <img data-toggle="tooltip" title="Select the SSID name you wish to change from the drop-down below. Then, enter the new name of your Guest WiFi Network." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
                                                                      ...
                                                                      <select required class="span4 form-control" id="ssid_name" name="ssid_name" <?php echo $ssidName; ?> onchange="loadSSIDForm(this.value)">
                                                                        ...
                                                                        <a href="?t=7&st=7&action=sync_data_tab1&tocken=<?php echo $secret; ?>" class="btn btn-primary mar-top" style="align: left; margin-top: 5px;"><i class="btn-icon-only icon-refresh"></i> Refresh</a>
