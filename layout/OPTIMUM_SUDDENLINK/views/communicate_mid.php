...
//echo $query_set;
	...
	$query_set="WHERE mdo.distributor_code='$user_distributor' AND mdo.property_id = '$property_id'";
	$find_customers=mysql_query("SELECT `customer_id` AS f FROM `mdu_vetenant` mv JOIN mdu_distributor_organizations mdo ON mv.property_id=mdo.property_id ".$query_set);
...
<div class="main">
  ...
  <form id="edit-profile" class="form-horizontal" method="POST">
					   ...
					   <h1 class="head"><span>
    Individual Message <img data-toggle="tooltip" title="You can use this feature to communicate via email directly with an individual tenant. The message will be sent to the tenant's email on record." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></span>
</h1> 
									  ...
									  <fieldset>
													  ...
													  <div class="control-group">
														  ...
														  <div class="controls">
														  	 ...
														  	 <label class="" for="radiobtns">Search Tenants <img data-toggle="tooltip" title=" Note: You can search using First Name, Last Name or Email Address." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"> </label>
...
<h1 class="head"><span>
    Group Messaging Editor <img data-toggle="tooltip" title="You can use this feature to communicate via email directly with all tenants at a property. Select the property group to send the email to from the drop-down. The message goes to the tenant's email on record." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></span>
</h1>
