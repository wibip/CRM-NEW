                    ...
                    <div class="control-group">
                        ...
                        <div>
                            <div class="controls col-lg-5 form-group">
                                ...
                                <label class="" for="radiobtns">Password <img data-toggle="tooltip" title='Your password must be atleast 8 characters long and maximum of 12 characters long. You must use combination of numbers, letters and special characters: $ ! # @.' src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
