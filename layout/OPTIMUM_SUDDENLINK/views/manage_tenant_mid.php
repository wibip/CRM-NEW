...
WHERE uo.user_name='$user_name' LIMIT 1");
  ...
  $acc_response = $nf->findUsers("User-Name",$group,$mg_uname);
...
WHERE uo.user_name='$user_name' LIMIT 1");
  ...
  $cus_property_type= $db->getValueAsf("SELECT `property_type` AS f FROM `mdu_organizations` WHERE `property_id`='$cust_property_id'");
   ...
   if($status_code == 200 || $status == 200){
    ...
    $del_ses_response = $nf->getSessionsbymac($mac_address,"USER-NAME");
...
$nf = null;
  ...
  $profile_type = strtoupper($_GET['type']);
    ...
    echo $sqlpro="SELECT email,username FROM  mdu_vetenant WHERE customer_id='".$mg_customer_id."'";
...
//alert('aa');
        ...
        <div align="center" style="vertical-align:top;">
         <h2 style="font-size: 28px;"><strong>Manage Tenants</strong></h2>
         </div>
         </div>
         <br>
         <br>
               ...
               <h3><strong>Tenant Bandwidth Profile</strong></h3>
                 ...
                 <div class="widget-content">
                    ...
                    <?php
                        ...
                        // default profile
                        $get_dist_profile="SELECT  p.service_profile AS f FROM mdu_service_profile p JOIN  `mdu_organizations` o ON o.default_prof=p.profile_code WHERE o.property_id='$mg_property_id'";
                        /*
                         * $service_profile=mysql_query($get_dist_profile);
                        while($dist_profile_arr=mysql_fetch_assoc($service_profile)){
                          $match_value=0;
                          //$profile_type=$dist_profile_arr['profile_type'];
                          $profile_name=$dist_profile_arr['default_prof'];
                        } */
                        ...
                        $dif2=array_diff($tenant_profile_arry,$profile_name_array);
                        if(count($dif1)==0){
                          if(count($dif2)==0){
                            $match_value=1;
                          }else{
                        ...
                        <label class="control-label" for="switch">Default Profile <br><font size="1">(<?php echo $tenant_profile_arry[0];?>) </font><sup><font color="#FF0000" >*</font></sup></label>
                            ...
                            <div class="controls">
                                ...
                                <?php
                                if($match_value==1){
                                    echo "<input id=\"default_act\" type=\"checkbox\" data-toggle=\"toggle\"  data-height=\"15\" checked disabled=\"disabled\">";
                                }else{
                                    echo"<a id=\"default_act_i\"><input id=\"default_act\" type=\"checkbox\" data-toggle=\"toggle\"  data-height=\"15\"> </a>";
                                }
                                ?>
...
<?php
                         ...
                         // probation profile
                        $get_dist_profile="SELECT  p.service_profile AS f FROM mdu_service_profile p JOIN  `mdu_organizations` o ON o.probation_prof=p.profile_code WHERE o.property_id='$mg_property_id'";
                        $profile_name = $db->getValueAsf($get_dist_profile);
                                            ...
                                            <label class="control-label" for="switch">Probation Profile <br><font size="1">(<?php echo $tenant_profile_arry[1];?>)</font><sup><font color="#FF0000" >*</font></sup></label>
                                            ...
                                            <div class="controls">
                                                    ...
                                                    if($match_value==1){
                                                        ...
                                                        echo "<input id=\"probation_act\" type=\"checkbox\" data-toggle=\"toggle\"   data-width=\"50\" data-height=\"20\" checked disabled=\"disabled\"> ";
                                                    }else{
                                                        echo"<a id=\"probation_act_i\"><input id=\"probation_act\" type=\"checkbox\" data-toggle=\"toggle\"   data-width=\"50\" data-height=\"20\"></a>";
                                                    }
                                                    ?>
                                            </div>
                                            <script>
            ...
            <!-- /controls -->
             ...
             <p><font size="2px">Activate the probation profile to temporarily reduce the tenants bandwidth.</font></p>
                       ...
                       $profile_name_ar=array();
                        ...
                        $get_dist_profile="SELECT  p.service_profile AS f FROM mdu_service_profile p JOIN  `mdu_organizations` o ON o.premium_profile=p.profile_code WHERE o.property_id='$mg_property_id'";
                       $service_profile=mysql_query($get_dist_profile);
                       
                       while($dist_profile_arr=mysql_fetch_assoc($service_profile)){
                        $profile_name=$dist_profile_arr['f'];
                                            
                        array_push($profile_name_ar,$profile_name);
            ...
            /*  echo "====================".count($dif1)." ".count($dif2)." ".$match_value."</br>";
             ...
             print_r($profile_name_array); */
                       ...
                       // $get_profile_type /  $duration_details / $service_profile_details
                                            ...
                                            <label class="control-label" for="switch">Premium Profile <br><font size="1">(<?php echo $tenant_profile_arry[2];?>)</font><sup><font color="#FF0000" >*</font></sup></label>
                           ...
                           <fieldset>
                                    ...
                                    <!-- <div class="control-group">
                                     ...
                                     <div class="controls">
                                         ...
                                         <a  id="sync_all" name="sync_all" class="btn btn-default" style="text-decoration:none"><i class="btn-icon-only icon-refresh"></i> Sync Records</a>&nbsp;<img data-toggle="tooltip" title="If a tenant record appears to be missing from the search results, then click [Synch Records] to download missing records that you may have added manually." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                   ...
                                   <div class="control-group middle-large">
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" for="radiobtns">Search Tenants <img data-toggle="tooltip" title="You can search for a tenant using full or partial First Name, Last Name, or Email or use the Search MAC field." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" style="margin-top: 10px" for="radiobtns">Search MAC <img data-toggle="tooltip" title="You can search for a tenant using full or partial MAC address of a device or use the Search Tenant field." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <div class="controls se_ownload_cr">
                                         <button class="btn" style="margin-bottom: 10px" type="submit" name="search_btn" id="search_btn">Search</button> <img data-toggle="tooltip" title="Click [SEARCH] to show a full list of tenants" src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                         <br />
...
<div class="tab-pane <?php if($active_tab=="session"){echo"active";}?>" id="session">
      ...
      ?>
       <h1 class="head"><span>
    Session Search <img data-toggle="tooltip" title="You can search for a tenant's online sessions using Email, First Name, Last Name or device MAC Address. To get a list of all sessions, click the Search Button." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></span>
</h1>
        ...
        <fieldset>
          ...
          <div class="control-group middle-large">
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" for="radiobtns">Search Tenants <img data-toggle="tooltip" title="You can search for a tenant sessions using full or partial First Name, Last Name, or Email or use the Search MAC field." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" style="margin-top: 10px" for="radiobtns">Search MAC <img data-toggle="tooltip" title="You can search for a tenant sessions using MAC address of a device or use the Search Tenant field." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
