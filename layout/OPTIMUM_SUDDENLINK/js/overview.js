...
function makeCanvas(data, a, b, c, camp_layout, propName) {
    ...
    $('#innerCanvasContainer').html('<h1 class="headName">Overview</h1><label class="headlabel">Click on an element to see a detailed view of its status and performance.</label><div class="overviewDiv"><div class="treeDiv"><div class="treeDivInner"><label class="internet"><img src="layout/' + camp_layout + '/img/internet.png"><span>' + propName + '</span></label><ul class="tree treeUl">' + ul + '</ul></div></div><div class="detailsTree"><span class="arrow left"> BACK</span><div class="treeDivDetails"><h2><b>ASSET INVENTORY</b></h2><table><tbody><tr><th style="text-align: left">TYPE</th><th style="text-align: left">QTY</th><th style="text-align: left">STATUS</th></tr>'+txtStr+'</tbody></table></div>' + details + '</div></div>');
