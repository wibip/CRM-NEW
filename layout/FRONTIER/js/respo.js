$(window).on("load resize",function(){
    ...
    var width_table_res1 = width_table_res*92/100;
...
$(document).ready(function() {
    ...
    $("input:radio:not(.hide_rad)").after("<label style='display: inline-block;vertical-align: middle;margin-bottom: 0px''></label>");
