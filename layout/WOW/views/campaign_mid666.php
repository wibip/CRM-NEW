			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls form-group">
																	  ...
																	  <h3 style="display: inline-block;">Set background color</h3><img data-toggle="tooltip" title="Either select with the color picker or type in the HEX value of your preferred color." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
