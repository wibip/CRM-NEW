...
$query_results1=$db->selectDB($qg1);
if($query_results1['rowCount']==1){
	$d1 = '" ",';
	$c1 = '0,';
}
...
$query_results2=$db->selectDB($qg2);
if($query_results2['rowCount']==1){
	$d2 = '" ",';
	$c2 = '0,';
}
...
$query_results3=$db->selectDB($qg3);
if($query_results3['rowCount']==1){
	$d3 = '" ",';
	$c3 = '0,';
}
foreach ($query_results2['data'] as $row2) {
