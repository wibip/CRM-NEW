...
make yours a splash page. <img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest WiFi network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
...
<?php } ?>
													...
													<!-- /control-group -->
				                       				...
				                       				<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Select  Location/Property<img data-toggle="tooltip" title='You can create a unique splash page for each of your locations.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Select Language<img data-toggle="tooltip" title='[Coming soon] You can create multiple language versions of your splash page.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Browser Heading<img data-toggle="tooltip" title='Set the text you want your user to see in the splash page browser window.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
												...
												<!-- *************************** Text ************************** -->
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Progression<img data-toggle="tooltip" title='Set the progression text your visitors will see while the registration page is loading. Special characters allowed are _.-' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
?>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Redirection<img data-toggle="tooltip" title='Set the redirection URL  where the visitor will land after finalizing the registration. The Custom URL is the URL of your choice. The Default Website is the URL of your service provider. The Thank You Page is a static local system page.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Template<img data-toggle="tooltip" title='[Coming soon] Select from a list of predefined templates to modify to fit your location.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
    ...
    function choice2(select) {
        ...
        if(x=="default_theme" || x=="red_template" || x=="altice_business_default"  || x=="arris_business_default"){
        ...
        if(x=="red_template" || x=="altice_business_default"  || x=="arris_business_default"){
...
temp_image();
	...
	$(document).ready(function() {
        ...
        var y = '<img id="preview_img" src="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=15" data-zoom-image="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=15" style="max-height:100px;width:60%;max-width: 100%"><p><a id="pre_id" class="fancybox fancybox.iframe" href="<?php echo $base_portal_folder; ?>/checkpoint.php?client_mac=DEMO_MAC&theme='+template_name1+'&realm=<?php echo $db->getValueAsf("SELECT `verification_number` AS f FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor' LIMIT 1");?>">Preview Template Layout</a>';
	...
	$(document).ready(function() {
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Registration Type<img data-toggle="tooltip" title=' Select the type of registration you would require your visitors to complete to gain access to the Internet.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
<img data-toggle="tooltip" title='Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum size 1000KB. Recommended aspect ratio is 2 by 1.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;">
...
<input type="hidden" id="back_color1">
                                                ...
                                                <div class="control-group" id="duotone">
                                                        ...
                                                        <div class="controls">
                                                        	<label style="display:  inline-block;"> Overlay of background <span> image<img data-toggle="tooltip" title='Select the overlay color and use the slider to set the transparency.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></span></label>
...
<br>
															...
															<div class="controls uprel">
																...
																<label style="display: inline-block;">Upload logo image<img data-toggle="tooltip" title="Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum Size 200KB. Recommended aspect ratio is 8 by 3." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
					...
					<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION)){?>
													...
													<img id="logo_hi_2" class="croppedImg" src="<?php echo $upload_img->get_image($th_logo_image, 'logo') ; ?>" style="width: 193px;height: 71px;">
					<?php }?>
													</div>
...
?>
													<div id="alttxt2" class="control-group">
														...
														<div class="controls">
																...
																<label style="display: inline-block;">Logo Alternative Text  <img data-toggle="tooltip" title="Check the box and add in your message instead of a logo. You can use up to 20 characters including space." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
...
<label class="control-label" for="radiobtns" id="banner-label" style="display: none;">Banner Text</label>
													<div id="wtxt" class="controls">
															...
															<label style="display: inline-block;">Banner text<img data-toggle="tooltip" title="You can use up to 30 characters including spaces" src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
    ...
    if($(a).is(":checked")) {
		...
		$("#m_male").removeAttr('required');
													...
													<div class="control-group">
														...
														<div class="controls">
															<label style="display: inline-block;">Select manual registration <span> fields<img data-toggle="tooltip" title='Collecting demographic data from your visitors will give you additional insights and will allow you to create targeted campaigns based on those demographics.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ><span></label>
														</div>
													</div>
...
<div id="field_color" class="control-group feild">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Field Color<img data-toggle="tooltip" title="You can set the color of the fields depending on the background used." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
													...
													<div id="field_txt_color" class="control-group feild">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Field Text Color<img data-toggle="tooltip" title="You can set the color of the field text based on the field color used." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
...
<div id="manualbutton">
												...
												<div id="mregbtn" class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Button text<img data-toggle="tooltip" title="You can use up to 20 characters including spaces." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
