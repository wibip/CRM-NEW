...
<input type="hidden" name="image_5_name_prev" value="<?php echo $mg_image5_name; ?>" id="image_5_name_prev" onkeyup="valid_check()"/>
		...
		<h3 style="display: inline-block;">Upload slider images</h3><img data-toggle="tooltip" title="The images must be a .png or jpg. Maximum size 600Kb. Use aspect ratio 1 by 1." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
                ...
                <input type="hidden" value="<?php echo $mg_image1_name; ?>"  name="image_1_name" id="image_1_name" onkeyup="valid_check()"/>
                <input type="hidden" value="<?php echo $mg_image1_name; ?>"  name="image_1_name_prev" id="image_1_name_prev" onkeyup="valid_check()"/>
...
$slider1red_http=$slider1red[0].'//';
      ...
      <!-- <div class="" style="vertical-align:top;">
			...
			<input type="hidden" name="image_2_name_prev" value="<?php echo $mg_image2_name; ?>" id="image_2_name_prev" onkeyup="valid_check()"/>
...
$slider2red_http=$slider2red[0].'//';		
			...
			<?php } ?>
               ...
               <!--  <label class="filebutton">
                ...
                <input type="hidden" name="image_3_name_prev" value="<?php echo $mg_image3_name; ?>" id="image_3_name_prev" />
...
$slider3red_http=$slider3red[0].'//';		
			...
			<?php } ?>
                ...
                <input type="hidden" name="image_4_name_prev" value="<?php echo $mg_image4_name; ?>" id="image_4_name_prev" />
...
<option <?php if($secslider=='https://'){echo 'selected';} ?> value="https://">https://</option>
                                                 ...
                                                 <br>  
                                                 	...
                                                 	<div class="control-group">
															...
															<div class="controls form-group">
																...
																<div id="logo_su2_up_bc" class="no_crop_parent " style="vertical-align:top;">
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo_su2_up_bc','image_5_name','campaign_img_logo');">
											</span>
										</label>
										<?php if (strlen($mg_image5_name) > 0) { ?>
...
<?php } ?>
	...
	<!-- /control-group -->	
                ...
                <input type="hidden" name="image_1_name_prev" value="<?php echo $mg_image1_name; ?>" id="image_1_name_prev" onkeyup="valid_check()"/>
...
<option <?php if($sec_survay_url=='https://'){echo 'selected';} ?> value="https://">https://</option>
                                                 			...
                                                 			<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div class=""
																		 ...
																		 <div id="logo_co_up_bc" class="no_crop_parent " style="vertical-align:top;">
                <!-- <label class="filebutton">
                Browse Image
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo_co_up_bc','image_5_name','campaign_img_logo');">
											</span>
										</label>
...
<option <?php if($sec_wvideo=='https://'){echo 'selected';} ?> value="https://">https://</option>
											...
											<?php if ($package_functions->getSectionType("CAMP_CREATE_LOCATION", $system_package, $user_type) == "system_package") { ?>
												<div class="control-group form-group" style="display:none">
													...
													<div class="controls form-group">
													<h3 style="display: inline-block;">Campaign target location1</h3><img data-toggle="tooltip" title="If you have more then one location you could create multiple campaigns and select which locations receive which campaign. Click the location in the left box to move it to the right box to activate the campaign for that location." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
														<div class="input-prepend input-append multi_sele_parent">
															<select name="group_tag[]" id="group_tag"
