...
//echo "user-".$PropertyDeleteStatus;
...
$cunst_var['mno_package'] = $mno_sys_package;
							...
							<div class="widget-content" id="now">
								...
								<div class="tabbable">
									<ul class="nav nav-tabs newTabs">
										<li class="active"><a href="#create_acc" data-toggle="tab">Add Resident</a></li>
