...
<div class="main">
                        ...
                        <div class="widget-content">
                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li <?php if (isset($tab1)){ ?>class="active" <?php } ?>><a href="#tab1"
                                                                                                data-toggle="tab">Active
                                            Sessions</a></li>

                                    <?php if (in_array("AUP_VIOLATION", $features_array) || $package_features == "all") { ?>
                                        <li <?php if (isset($tab11)){ ?>class="active" <?php } ?>><a href="#tab11"
                                                                                                     data-toggle="tab">AUP
                                                Violation</a></li>
                                    <?php } ?>
                                    <?php if (in_array("HISTORICAL_SESSIONS", $features_array) || $package_features == "all") { ?>
                                        <li <?php if (isset($tab2)) { ?>class="active" <?php } ?>><a href="#tab2" data-toggle="tab">Historical Sessions</a></li>
                                    <?php } ?>

                                    <li <?php if (isset($tab3)){ ?>class="active" <?php } ?>><a href="#tab3"
                                                                                                data-toggle="tab">Blacklist</a>
                                    </li>

                                    <?php if (in_array("PORTAL_USAGE_REPORT", $features_array) || $package_features == "all") { ?>
                                        <li <?php if (isset($tab12)){ ?>class="active" <?php } ?>><a href="#tab12"
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <div class="input-prepend input-append">
                                                            <select style="    margin-right: 20px;    margin-bottom: 15px;"
                                                                    class="span4" name="vanue_id" id="vanue_id"
                                                                    required>
    ...
    margin-bottom: 15px;" class="btn btn-primary" type="submit" name="search_btn_session" id="search_btn">Search
                                                            </button>
                                                ...
                                                <div class="widget widget-table action-table">
                                                    ...
                                                    <div class="widget-content table_response">
                                                        <div style="overflow-x:auto">
                                                            <table id="session_search_table"
                                                                   class="table table-striped table-bordered tablesaw"
                                                                   data-tablesaw-mode="columntoggle"
                                                                   data-tablesaw-minimap>
                                                                <thead>
                                                                <tr>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="persist">DEVICE MAC
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="4">AP MAC/GW MAC
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="1">Session State
                                                                    </th>
                                                                    <?php if ($private_module == 1) { ?>
                                                                        <th scope="col" data-tablesaw-sortable-col
                                                                            data-tablesaw-priority="2">Session Type
                                                                        </th>
                                                                    <?php } ?>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="10">START TIME
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="5">SSID
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="3">Customer Account#
                                                                        (realm)
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="7">GATEWAY IP
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="6">GATEWAY TYPE
                                                                    </th>


                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="1">Delete
                                                                    </th>
                                    ...
                                    <?php if (in_array("AUP_VIOLATION", $features_array) || $package_features == "all") { ?>
                                        <div
                                            <?php if (isset($tab11)){ ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?>
                                            id="tab11">
                                            ...
                                            <?php if (isset($send_customer_mail_enable)) { //show send mail area ?>
                                                ...
                                                <p>In the below text editor you will send an email to the subscriber and
                                                    post the violation message that will appear on the subscribers
                                                    self-care portal. This action will also trigger a forced redirect of
                                                    the user to his self care management portal to accept the violation
                                                    to regain service<br/>

                                                    Please verify that the name in the greeting line is correct and add
                                                    the violation description before posting.
                                                </p> <br/>
                                                ...
                                                <form id="edit-profile" class="form-horizontal" method="POST">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <label for="radiobtns"><strong>Violation Message
                                                                        :</strong></label>


                                                                <textarea name="aup_msg" id="aup_msg" cols="150"
                                                                          style="" maxlength="256" required></textarea>
                                                                <script type="text/javascript">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="radiobtns"><strong>User Message :</strong></label>
                                       ...
                                       -->
                                                        ...
                                                        <textarea width="100%" id="aup_message" name="aup_message"
                                                                  class="jqte-test1"><?php echo $message_full; ?></textarea>


                                                        <br>
                                                        <button type="submit" name="submit_aup" class="btn btn-primary">
                                                            Send & Post
                                                        </button>
                                            ...
                                            <?php }else{ ?>
                                                ...
                                                <form id="edit-profile" action="?t=11" method="post"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <h3>Tenant Search <img data-toggle="tooltip"
                                                                                       title="Use the Search Tenant field to search tenants that have been identified for AUP Violation."
                                                                                       src="layout/ATT/img/help.png"
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <label class="control-label" for="radiobtns">Limit
                                                                    Search to</label>
                                                                ...
                                                                <img data-toggle="tooltip"
                                                                     title="You can search a tenant across all your properties or limit the search to a specific property."
                                                                     src="layout/ATT/img/help.png"
                                                                     style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <label class="control-label" for="radiobtns">Search
                                                                    Tenant</label>
                                                                ...
                                                                <img data-toggle="tooltip"
                                                                     title="Note: You can search using First Name, Last Name or Email Address."
                                                                     src="layout/ATT/img/help.png"
                                                                     style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <a href="ajax/export_customer.php?task=tab11&searchid=<?php echo $search_id; ?>"
                                            ...
                                            ?>
                                                ...
                                                <div class="widget widget-table action-table">
                                                    ...
                                                    <div class="widget-content table_response">
                                                        ...
                                                        <p align="left">
                                                            Records <?php echo $start_row_count + 1 ?>
                                                            - <?php echo $last_row_number + 1 ?>
                                                            of <?php echo $customer_list_array_count ?>
                                                        </p>

                                                        <div style="overflow-x:auto">
                                                            <table class="table table-striped table-bordered tablesaw i-enable"
                                                                   id="tenent_search_table"
                                                                   data-tablesaw-mode="columntoggle"
                                                                   data-tablesaw-minimap>
                                                                <thead>
                                                                <tr>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="persist"><span>First Name</span><i
                                                                                style="float: right"
                                                                                class="icon-sort"></i></th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="1">
                                                                        <span>Last Name</span><i style="float: right"
                                                                                                 class="icon-sort"></i>
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="2"><span>Email</span><i
                                                                                style="float: right"
                                                                                class="icon-sort"></i></th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="3">
                                                                        <span>Group Name</span><i style="float: right"
                                                                                                  class="icon-sort"></i>
                                                                    </th>

                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="4"><span>#of AUPs</span><i
                                                                                style="float: right"
                                                                                class="icon-sort"></i></th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="5">Action
                                                                    </th>
                                                                    <th scope="col" data-tablesaw-sortable-col
                                                                        data-tablesaw-priority="6">Re Activate
                                                                    </th>
                                ...
                                $(\'#REACT_' . $customer_id . '\').easyconfirm({locale: {
                                    ...
                                    $(\'#REACT_' . $customer_id . '\').click(function() {
                                        window.location = "session.php?t=11&token=' . $secret2 . '&re_customer_id=' . $customer_id . '"
                                            ...
                                            <?php } else if ($record_found == 0 && isset($_POST['search_btn'])) {
                                                echo $msg;
                                            } ?>
                                    ...
                                    <div
                                        ...
                                        <form name="lawful_form" id="lawful_form" class="form-horizontal" method="post"
                                              action="?t=2" onchange="change_li_view()">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <input autocomplete="off" type="text" id="ipaddress"
                                                                   name="ipaddress"
                                                                   class="span4 li_download_class form-control">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls col-lg-5 form-group"
                                                            ...
                                                            <input autocomplete="off" type="text"
                                                                   class="inline_error inline_error_1 span2 li_download_class form-control li-time"
                                                                   name="from" id="from_li_date"
                                                                   placeholder="mm/dd/yyyy">

                                                            To

                                                            <input autocomplete="off" type="text"
                                                                   class="inline_error inline_error_2 span2 li_download_class form-control li-time"
                                                                   name="to" id="to_li_date" placeholder="mm/dd/yyyy">
                                                    ...
                                                    <div class="control-group" id="search_time_range">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <label class="control-label" for="radiobtns">Time Range
                                                                (GMT)</label>


                                                            <select autocomplete="off"
                                                                    class="span2 li_download_class li-time"
                                                                    name="from_time" id="from_li_time">
                                                                <?php
                                                                $dt = new DateTime('GMT');
                                                                $dt->setTime(0, 0);
                                                            ...
                                                            <input type="hidden" name="timeValidation"
                                                                   id="timeValidation" value="valid">
                                                        </div>
                                                        <!-- /controls -->
                                                    </div>
                                                    <!-- /control-group -->
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <input autocomplete="off" class="span2 form-control"
                                                                   name="port_number_from" id="port_number"> [1-65535] <!--  &nbsp; to
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <button name="li_view" id="li_view" type="submit"
                                                        ...
                                                        if ($li_success == 'success') {
                                                            ?>
                                                            <a id="li_download"
                                                               href="ajax/export_report.php?li_report=<?php echo $li_view_id; ?>&user_name=<?php echo $user_name; ?>"
                                                               class="btn btn-info" style="text-decoration:none">
                                                                <i class="btn-icon-only icon-download"></i> Download as
                                                                CSV</a>
                                                        <?php } ?>
                                                    </div>
                                                            ...
                                                            <div class="widget-content table_response">
                                                                <div style="overflow-x:auto;">
                                                                    <table class="table table-striped table-bordered tablesaw"
                                                                        ...
                                                                        <tr>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="persist">PUBLIC
                                                                                IP
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="1">CUSTOMER
                                                                                ACCOUNT NUMBER
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="2">START Time
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="3">End Time
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="4">DURATION
                                                                                (Sec)
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="6">DEVICE MAC
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="7">AP/AC MAC
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">AC/WAG
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">VLAN
                                                                            </th>

                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">DL (Bytes)
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">UP (Bytes)
                                                                            </th>

                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">PROPERTY ID
                                                                            </th>

                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">SSID/Network
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">Port Range
                                                                                From
                                                                            </th>
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">Port Range
                                                                            ...
                                                                            <th scope="col" data-tablesaw-sortable-col
                                                                                data-tablesaw-priority="10">Internal IP
                                                                            </th>
                                                                        </tr>
                                                                        </thead>
                                                                        <tbody>
                                    ...
                                    <div
                                        ...
                                        <form name="whitelist_form" id="whitelist_form" class="form-horizontal"
                                              method="post" action="?t=3">
                                            <div class="form-group">


                                                <fieldset>

                                                    <input type="hidden" id="check_post_val"
                                                           name="blacklist_all_search_dis">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <label class="control-label" for="customer_type">MAC
                                                            Address</label>

                                                        <div class="controls col-lg-5 form-group">

                                                            <input maxlength="17" autocomplete="off" type="text"
                                                                   id="search_mac" name="search_mac" class="span4"
                                                                   data-toggle="tooltip"
                                                                   title="The MAC Address can be added manually or you can paste in an address. The system will autoformat the MAC Address to either aa:bb:cc:dd:ee:ff or AA:BB:CC:DD:EE:FF.">
                                                    ...
                                                    <div class="form-actions border-non">
                                                        ...
                                                        <button name="blacklist_mac_search" id="blacklist_mac_search"
                                                                type="submit" class="btn btn-primary"
                                                                style="text-decoration:none">Search
                                                        </button>
                                                        <button id="blacklist_all_search" type="submit"
                                                                class="btn btn-info inline-btn"
                                                                style="text-decoration:none">List all disabled MACs
                                                        </button>
                                        ...
                                        <form name="blacklist_form" id="blacklist_form" class="form-horizontal"
                                              method="post" action="?t=3">
                                            <div class="form-group">
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <input maxlength="17" data-toggle="tooltip"
                                                                   autocomplete="off" type="text" id="black_mac"
                                                                   name="black_mac" class="span4"
                                                                   title="The MAC Address can be added manually or you can paste in an address. The system will autoformat the MAC Address to either aa:bb:cc:dd:ee:ff or AA:BB:CC:DD:EE:FF.">
                                                            <small id="bl_mac_ext" class="help-block"
                                                    ...
                                                    <div class="control-group" id="search_time_range">
                                                        ...
                                                        <label class="control-label" for="radiobtns">Suspension
                                                            Period</label>
                                                        <div class="controls">
                                                            <div class="input-prepend input-append">
                                                                <select autocomplete="off" class="span2"
                                                                        name="blacklist_period" id="blacklist_period">
                                                    ...
                                                    <div class="form-actions">
                                                        ...
                                                        <input type="hidden" name="black_form_secret"
                                                               value="<?php echo $secret; ?>">

                                                        <button disabled name="blacklist" id="blacklist" type="submit"
                                                                class="btn btn-primary" style="text-decoration:none">
                                        ...
                                        <div class="widget widget-table action-table">
                                            ...
                                            <div class="widget-content table_response">
                                                <div style="overflow-x:auto">
                                                    <table id="blacklist_search_table"
                                                           class="table table-striped table-bordered tablesaw"
                                                           cellspacing="0" data-tablesaw-mode="columntoggle"
                                                           data-tablesaw-minimap>
                                                        <thead>
                                                        <tr>
                                                            <th scope="col" data-tablesaw-sortable-col
                                                            ...
                                                            <th scope="col" data-tablesaw-sortable-col
                                                                data-tablesaw-priority="3">Blacklist Date
                                                            </th>
                                                            <th scope="col" data-tablesaw-sortable-col
                                                                data-tablesaw-priority="5">Suspension
                                                            </th>
                                                            <th scope="col" data-tablesaw-sortable-col
                                                                data-tablesaw-priority="4">Whitelist Date
                                                            </th>
                                                            <!-- <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">remove MAC</th> -->

                                                            <?php if (isset($_POST[blacklist_mac_search])) { ?>
                                                                <th scope="col" data-tablesaw-sortable-col
                                                                    data-tablesaw-priority="2">Whitelist type
                                                                </th>
                                                            ...
                                                            <th scope="col" data-tablesaw-sortable-col
                                                                data-tablesaw-priority="2">WI-FI Access
                                                            </th>
                                                        </tr>
                                                        </thead>
                                                        <tbody>
                                    ...
                                    <?php if (in_array("PORTAL_USAGE_REPORT", $features_array) || $package_features == "all") { ?>
                                        <div
                                            <?php if (isset($tab12)){ ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?>
                                            id="tab12">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#property_camp_submit').formValidation({
            framework: 'bootstrap',
            button: {
                selector: '#property_activation',
                disabled: 'disabled'
            },
            fields: {
                from_date_camp: {
    ...
    $(function() {
        ...
        $( "#to_date_camp" ).datepicker({
            beforeShow: function (input, inst) {
                ...
                if (maxDate > dat) {
                    $('#to_date_camp').datepicker('option', 'maxDate', dat);
                }
                else {
                    $('#to_date_camp').datepicker('option', 'maxDate', dat);
                    //$('#to_li_date').datepicker('option', 'maxDate', maxDate);
