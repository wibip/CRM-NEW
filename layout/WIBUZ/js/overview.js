...
function makeCanvas(data, a, b, c, camp_layout, propName) {
    ...
    for (key12 in vEdgeObj) {
        ...
        vEdgeStr = vEdgeStr + '<li><label data-ref="' + allved + '" data-type="vEdge" data-desc="' + vEdgeObj[allved].AP_Description + '" data-uniq="' + vdUniq + '"  class="tree_label vedgeChild ' + vdstatus + '">' + vEdgeObj[allved].mac + '</label></li>';
    ...
    for (key in switchObj) {
        ...
        if (switchObj[x].mac != 'noSwitch') {
            ...
            SwitchStr = SwitchStr + '<li><label data-ref="' + x + '" data-type="switch" data-desc="' + switchObj[x].AP_Description + '" data-uniq="' + swUniq + '"  class="tree_label switchChild ' + swStatus + '">' + switchObj[x].mac + '</label></li>';
            ...
            for (key1 in jObjAP) {
                ...
                var apUniq = (jObjAP[y].ap_code.replace(/:/g, "") + jObjAP[y].apName.split(' ').join(""));
                ApStr = ApStr + '<li><label data-ref="' + x + y + '" data-type="AP" data-mac="' + jObjAP[y].ap_code + '" data-uniq="' + apUniq + '"  class="tree_label apChild ' + apstatus + '">' + jObjAP[y].ap_code + '</label></li>';
                y++;
                allAp++;
                details = details + a;
            }
