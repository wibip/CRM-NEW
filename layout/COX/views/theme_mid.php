...
$(document).on("click","#logo1_up .cropControls", function(e){
...
$(document).on("click","#logo_txt2_enable", function(e){
    ...
    val_check1("logo_txt2_enable");
										...
										var theme_ele = new Array("theme_name1", "location_ssid","language", "title_t","loading" ,"redirect_type","template_name", "reg_type" , <?php if($back_or_logo=='logo'){ ?> "logo1_up","logo_txt1_enable", <?php } ?> "logo2_up", "logo_txt2_enable" , "varimg", "horimg", "btncolor" ,"welcome","greeting_txt","is_active");
											...
											for (i = 0; i < parseInt(a); i++) { 
												...
												if ( $( '#'+theme_ele[i]+'_validate' ).length ) {
													...
													if(theme_ele[i]=='logo1_up' || theme_ele[i]=='logo2_up'){

														var logoo1 = "#logo1_up img"; 
...
<input type="hidden" id="using">
											<div class="header2_part1"><h2><?php echo ucwords(__THEME_TEXT__); ?> Creator</h2></div>


                                                  <p>The face of your Guest <?php echo __WIFI_TEXT__; ?> Service.</p>
											...
											<form id="edit-profile1" name="editprofile" class="form-horizontal" method="POST" action="theme.php" autocomplete="off">
												...
												<div id="val_1">
													<div class="control-group">
														...
														<label class="control-label" for="radiobtns"><?php echo ucwords(__THEME_TEXT__); ?> Name</label>
														...
														<div class="controls">
															...
															<?php if($modify_mode == 1) echo "value = \"".$theme_name_set."\""; ?>
                                                             ...
                                                             <!-- onkeyup="validateShedulname(this.value)" --> <div style="display:none;" class="help-block error-wrapper bubble-pointer mbubble-pointer" id="shedule_name_dup"><p><?php echo ucwords(__THEME_TEXT__); ?>name already exists</p></div>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
    ...
    function choice2(select) {
		...
		if(x=='<?php echo $edit_template_name; ?>'){
			...
			welcome_old = "<?php
                $welcome_txt = str_replace("\n", "\\n", $welcome_txt);
                echo $welcome_txt = str_replace("\r", "\\r", $welcome_txt); ?>";
        ...
        if(x=="default_theme" || x=="red_template" || x=="altice_business_default" || x=="frontier_business_default" || x=="arris_business_default" || x=="att_business_default"){
        ...
        if(x=="red_template" || x=="altice_business_default" || x=="frontier_business_default" || x=="arris_business_default" || x=="att_business_default"){
...
temp_image();
	...
	$(document).ready(function() {
        ...
        var y = '<center><img id="preview_img" src="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=14" data-zoom-image="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=14" style="max-height:200px;width:60%;max-width: 100%"><p><a id="pre_id" class="fancybox fancybox.iframe" href="<?php echo $base_portal_folder; ?>/checkpoint.php?client_mac=DEMO_MAC&theme='+template_name1+'&realm=<?php echo $db->getValueAsf("SELECT `verification_number` AS f FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor' LIMIT 1");?>">Preview Template Layout</a></center>';
		...
		if((x=='res_cox_standard_template')){
	      ...
	      var z2 = '<?php echo $user_distributor; ?>';
	            ...
	            $.ajax({
					...
					if($('#logo_txt2_enable').is(":checked") && $('#alttxt2').is(":visible")){
											$('#divlogo2').hide();
										}
...
<div class="movertxt" style="margin: auto;text-align: center;">Move over to zoom in <i class="icon-zoom-in" style="display: inline !important"></i></div>
...
<div id="imgupload"> 
                                                    ...
                                                    <p class=""><b>Step 2.</b> <!-- <small class="a" >Note all sections are required with exception of background color, font color and horizontal line color.</small>  -->Upload your company logo and a background image to give the <?php echo ucwords(__THEME_TEXT__); ?> a familiar look & feel for your guests. Please click the "Save" icon at the bottom of the page to save the uploaded image.</p>
                                                    <p><b>File size restrictions:</b></p>
                                                    <p class="p-left" style="margin-left: 80px;"><b>Logo:</b> Max 200KB<br>
                                                    <b>Images and photos:</b> Max 600KB<br>
                                                   <!--  <b>Vertical  horizontal:</b> x  Width by z Height. Max 600KB</p> -->
<p  class="p-left small" style="margin-left: 50px;">We impose a size restriction on the images to optimize the loading time of your <?php echo __THEME_TEXT__; ?>. Please be sure to resize heavy files to meet our size restrictions to ensure a good experience for your users. Many websites offer free online tools that will allow you to quickly resize photo and logo files.<!-- We impose a size restriction on the images to optimize the loading time of your themes. You can resize images using free websites, the free image editing program on your computer, or with free apps on your mobile device. Read more at:<a style="font: -1px/1.7em 'Open Sans';" href="https://www.wikihow.com/Resize-a-JPEG">https://www.wikihow.com/Resize-a-JPEG</a> --></p>
													</div>
...
<div id="divlogo1" class="control-group">
				...
				if($back_or_logo=='logo'){ ?>
					...
					<?php if($modify_mode==1 && pathinfo($th_background_image, PATHINFO_EXTENSION)){?>
													<!-- <img id="logo_hi_1" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image; ?>" > -->

													<img id="logo_hi_1" class="croppedImg" src="<?php echo $upload_img->get_image($th_background_image,'bg'); ?>" >

					<?php }?><label class="no_crop_label">
 													<span>
														<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo1_up','image_1_name','theme_img_logo');">
													</span>
                                                        </label>
													</div>
	...
	<!-- <p style="font-size: 90%; margin-bottom: -1px;"><b>Note: Upload your primary logo. Best aspect ratio is 8 Width x 3 Height and Max Size: 200Kb.</b> <br>
	We impose a size restriction on the images to optimize the loading time of your themes.<br> You can resize images using free websites, the free image editing program on your computer, <br> or with free apps on your mobile device. Read more at: <a style="font: -1px/1.7em 'Open Sans';" href="https://www.wikihow.com/Resize-a-JPEG">https://www.wikihow.com/Resize-a-JPEG</a></p> -->
...
<?php }else{ ?>
					...
					<?php if($modify_mode==1 && pathinfo($th_background_image, PATHINFO_EXTENSION)){?>
													...
													<img id="logo_hi_3" class="croppedImg" src="<?php echo $upload_img->get_image($th_background_image,'bg'); ?>" style="width: 300px; height: 150px;">
						<?php }?>
													</div>
	...
	<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
		...
		var croppicContaineroutputMinimallogo1 = {
			    ...
			    rotateControls: false,
				loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
				onBeforeImgUpload: function(){ window.img_id = $('#image_1_name').val();console.log('onBeforeImgUpload') },
...
<br>
					...
					<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION)){?>
													...
													<img id="logo_hi_2" class="croppedImg" src="<?php echo $upload_img->get_image($th_logo_image, 'logo'); ?>" style="width: 200px;height: 114px;">
					<?php }?>
													</div>
									...
									<!-- ///////////////// -->
												...
												<div id="fontcolor" class="control-group">
                                                        ...
                                                        <div class="controls">
															...
															<div id="fontcolor1_div" class="input-group colorpicker-component"><input id="fontcolor1" name="fontcolor1" type="hidden" value="primary" ><span class="input-group-addon"><i></i></span></div>
...
<div id="color">
													...
													<div id="btncolor" class="control-group">
														...
														<div style="display: inline-block;" id="button_color_div" class="input-group colorpicker-component"><input id="button_color" name="button_color" type="hidden" value="primary" ><span class="input-group-addon"><i></i></span>
															<p>(Active)</p></div>

														<div style="display: inline-block;" id="btn_color_disable_div" class="input-group colorpicker-component"><input id="btn_color_disable" name="btn_color_disable" type="hidden" value="primary" ><span class="input-group-addon"><i></i></span>
														<p>(Disabled)</p></div>

														<div style="display: inline-block;" id="button_ho_color_div" class="input-group colorpicker-component"><input id="button_ho_color" name="button_ho_color" type="hidden" value="primary" ><span class="input-group-addon"><i></i></span>
														<p>(Border)</p></div>

														<div style="display: inline-block;" id="button_text_color_div" class="input-group colorpicker-component"><input id="button_text_color" name="button_text_color" type="hidden" value="primary" ><span class="input-group-addon"><i></i></span>
														<p>(Text)</p></div>
...
<?php if(!in_array("welcomepage", $hide_divs_gene_arr)){ ?>
													...
													<div id="isactive" class="control-group">
														...
														<div class="controls">
															...
															data-toggle="tooltip" title="CHECKING THE BOX will activate this <?php echo __THEME_TEXT__ ; ?> and make it visible to all your guests immediately. Or you can leave the box unchecked and enable the <?php echo __THEME_TEXT__ ; ?> later from within the Manage section."
															...
															<p style="font-style: italic;"><b>Check this box to make this the active <?php echo__THEME_TEXT__; ?>.</b></p>
										...
										function ck_topval(set_val){
											...
											if($('#shedule_name_dup:visible').length == 0){
											...
											if($('#logo1_up').length){
												...
												var logo1_up_validate = $("#logo1_up img").hasClass("croppedImg");
										...
										if(tname=='' || !horizontal_validate || !vertical_validate || !logo2_up_validate || !logo1_up_validate || locid=='' || redirect_type == '' ||  welcome == ''){
												...
												<form id="tag_form" class="form-horizontal">
													...
													<fieldset>
														...
														<div class="control-group">
															...
															<label class="control-label" for="radiobtns"><?php echo ucwords(__THEME_TEXT__); ?></label>
															...
															<div class="controls">
																...
																<div class="input-prepend input-append">
																	...
																	<select name="theme_id" class="span4" id="theme_id" onchange="loadap1();">

																	<option value="-1">Select <?php echo ucwords(__THEME_TEXT__); ?></option>
														...
														<div class="control-group" id="type_div">
															...
															<div class="controls">
																...
																<div class="input-prepend input-append">
																	...
																	<select name="theme_type" class="span4" id="theme_type" required>
														...
														<div class="form-actions" >
															...
															<button disabled="disabled" id="preview_btn" type="button" name="submit" onclick="preview();"
																...
																class="btn btn-primary inline-btn" data-toggle="tooltip" title="The PREVIEW button will allow you to visualize the mobile view of the splash page.">
																Preview
																</button>
															...
															<button disabled="disabled" type="button" name="submit" id="gen_url" onclick="url_creation();"
																...
																class="btn btn-danger inline-btn" data-toggle="tooltip" title="The GENERATE URL button creates a URL that can be shared electronically and will allow the recipient to test and view the splash page layout natively on his or her laptop or other device.">
																Generate URL</button>
...
if(theme_id != -1){
	...
	document.getElementById('new_div').innerHTML = '<a href="'+loc+'" target="_blank" class="btn btn-info" data-toggle="tooltip" title="The OPEN URL IN A NEW TAB button will allow you to launch the splash page on the device and browser you are currently using.">Open URL in new tab</a>';
