														...
														<script type="text/javascript">
                                                            ...
                                                            $(\'#SESSION_DELETE_' . $mac .'\').easyconfirm({locale: {
                                                                ...
                                                                $(\'#SESSION_DELETE_' . $mac .'\').click(function() {
                                                                    window.location = "?token=' . $secret . '&rm_session_realm='.$sh_realm.'&rm_session_token='.$ses_id.'&mac='.$mac.'&state='.$state.'&t=1&rm_session_mac='.$session_mac.'&' . $next_search_pram . '=' . $mac . '"
                                                                });
                                                                });
                                                        </script>
													...
													echo'<a href="" id="SESSION_DELETE_' . $mac .'"  class="btn btn-small btn-danger">
														...
														<script type="text/javascript">
                                                            ...
                                                            $(\'#SESSION_DELETE_' . $mac .'\').easyconfirm({locale: {
                                                                ...
                                                                $(\'#SESSION_DELETE_' . $mac .'\').click(function() {
                                                                    window.location = "?token=' . $secret . '&rm_session_realm='.$sh_realm.'&rm_session_token='.$ses_id.'&mac='.$mac.'&state='.$state.'&t=1&rm_session_mac='.$session_mac.'&' . $next_search_pram . '=' . $next_search_value . '"
                                                                });
                                                                });
                                                        </script>
