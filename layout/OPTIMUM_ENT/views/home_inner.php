...
<style type="text/css">
#big_stats .stat:hover i {color:#0084d6 !important;}
.WIFI_INFORMATION_BOX .widget-header {
    display: none;
}

  .main-inner .container, .subnavbar-inner .container {
    padding-left: 0px !important;
    padding-right: 0px !important;
  }
  #clients_wrapper .dataTables_filter{
    display: block;
    text-align: left;
    float: none;
  }
  #clients_wrapper .dataTables_paginate .paginate_button:hover{
    border:1px solid whitesmoke !important;
    background-color: whitesmoke;
    background-image:none   !important;
  }

  #clients_wrapper .dataTables_paginate .paginate_button:hover a{
  ...
  .fit_info #clients_filter{
    display: inline-block;
  }
  .fit_info .dataTables_info{
    display: inline-block;
  ...
  #clients_paginate ul.pagination {
    position: static;
    background: #fff;
}
#clients_wrapper .dataTables_length{
  display: block;
  margin: 18px 0;
}
.dataTables_wrapper .dataTables_paginate .paginate_button{
  ...
  td.Offline{
    background-image: url(layout/<?php echo $camp_layout; ?>/img/client-off.png?v=1);
    background-repeat: no-repeat;
    background-position: center;
    text-indent: -877777777777771px;
    background-size: 15%;
  }
  td.Online{
    background-image: url(layout/<?php echo $camp_layout; ?>/img/client-on.png?v=1);
    background-repeat: no-repeat;
    background-position: center;
    text-indent: -877777777777771px;
    background-size: 15%;
  ...
  #clients_wrapper .dt-button.buttons-csv{
    background: none;
    border: none;
  ...
  #select_filter_div.opened{
    background-color: black;
    font-size: 16px;
  }
  #clients_filter label{
    position: relative;
  }
.search_select{
  background: url(layout/<?php echo $camp_layout; ?>/img/form-fields-biz.png) 0 -37px no-repeat, url(layout/<?php echo $camp_layout; ?>/img/form-fields-biz.png) 100% 0 no-repeat;
    height: 27px;
    margin-top: 0px;
}
  .col-sm-6 {
...
/* ul.tree {
 ...
 .treeUl li label.firewall.dsf{
    background-image: url(layout/<?php echo $camp_layout; ?>/img/RouterOpen.png);
 }

 .treeUl li input:checked~label.firewall.dsf{
    background-image: url(layout/<?php echo $camp_layout; ?>/img/RouterClosed.png);
 }
