    ...
    $('[data-toggle="tooltip"]').tooltip();
                                    ...
                                    WHERE t.distributor = '$user_distributor'";
										...
										<fieldset>
											...
											<input type="hidden" name="user_distributor" id="user_distributor" value="<?php echo "$user_distributor"; ?>">
													...
													switch ($mg_ad_type) {
														...
														case 'slider' :
															...
															<div class="controls">
																...
																<h3 style="display: inline-block;">Illustrative rendering of the template</h3><img data-toggle="tooltip" title="The arrows indicates which elements of the template that can be changed" src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
																										

																<img src="img/slider_img.png" width="400px; max-height:250px">
															...
															<div class="control-group form-group">
																...
																<div class="controls form-group">
																	...
																	<h3 style="display: inline-block;">Welcome Message</h3><img data-toggle="tooltip" title="A maximum of 30 characters allowed including spaces" src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Upload logo image</h3><img data-toggle="tooltip" title="The logo image must be a transparent png, gif, png, jpeg, jpg Maximum size 600 Kb. Use aspect ratio 8 by 3." src="layout/OPTIMUM_LIGHTPATH/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">

																	<div class="input-prepend input-append"
																		 style="vertical-align:top;">
																		
																	</div>
																	<div id="logo1_up_bc" class="no_crop_parent " style="vertical-align:top;">
													               
																	<input type="hidden" name="image_5_name" value="<?php echo $mg_image5_name; ?>" id="image_5_name" onkeyup="valid_check()"/>
													                <div class="cropControls cropControlsUpload"> </div>
													                <?php if (strlen($mg_image5_name) > 0) { ?>
															

																	<img class="croppedImg"
																	src="<?php echo $upload_img->get_image($mg_image5_name); ?>"
																	style='width:193px; display:inline;'>
																
																<?php } ?>
																	<label class="no_crop_label">
																		<span>
																		<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo1_up_bc','image_5_name','campaign_img_logo');">
																								</span>
																							</label>
																</div>  
																	<div class="input-prepend input-append"
		...
		<h3 style="display: inline-block;">Upload slider images</h3><img data-toggle="tooltip" title="The images must be a .png or jpg. Maximum size 600Kb. Use aspect ratio 1 by 1." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	<div id="slide_image_1" class="no_crop_parent " style="vertical-align:top;">
				
                <!-- <label class="filebutton">
                Browse Image 01
                <span><input class="span4 form-control" required="required" id="image1" name="image1" type="file" style="width:90px;" onchange="return ajaxFileUpload(1);"></span>
                </label>&nbsp;&nbsp;<img id="loading_1" src="img/loading_ajax.gif" style="display:none;"> -->
											
                <input type="hidden" name="image_1_name" value="<?php echo $mg_image1_name; ?>" id="image_1_name" onkeyup="valid_check()"/>
				<!-- <div class="dooo" id='yourId1' onclick="img_val('yourId1','image_1_name')"></div> -->
				<div class="cropControls cropControlsUpload"> </div>
			...
			<?php } ?>
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'slide_image_1','image_1_name','campaign_img');">
											</span>
										</label>
...
$slider1red_http=$slider1red[0].'//';
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	<div id="slide_image_2" class="no_crop_parent "  style="vertical-align:top;">
      <!-- <div class="" style="vertical-align:top;">
                <label class="filebutton">
                Browse Image 02
                <span><input class="span4 form-control" id="image2" name="image2" type="file" style="width:90px;" onchange="return ajaxFileUpload(2);"></span>
                </label>&nbsp;&nbsp;<img id="loading_2" src="img/loading_ajax.gif" style="display:none;">
			</div> -->

			<input type="hidden" name="image_2_name" value="<?php echo $mg_image2_name; ?>" id="image_2_name" onkeyup="valid_check()"/>
				<!-- <div class="dooo" id='yourId2' onclick="img_val('yourId2','image_2_name')"></div> -->
			...
			<?php } ?>
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'slide_image_2','image_2_name','campaign_img');">
											</span>
										</label>
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div id="slide_image_3" class="no_crop_parent "  style="vertical-align:top;">
               <!--  <label class="filebutton">
                Browse Image 03
                <span><input class="span4 form-control" id="image3" name="image3" type="file" style="width:90px;" onchange="return ajaxFileUpload(3);"></span>
                </label>&nbsp;&nbsp;<img id="loading_3" src="img/loading_ajax.gif" style="display:none;"> -->

                <input type="hidden" name="image_3_name" value="<?php echo $mg_image3_name; ?>" id="image_3_name" />
				<!-- <div class="dooo" id='yourId3'></div> -->
				<div class="cropControls cropControlsUpload"> </div>
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'slide_image_3','image_3_name','campaign_img');">
											</span>
										</label>
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div id="slide_image_4" class="no_crop_parent "  style="vertical-align:top;">
                <!-- <label class="filebutton">
                Browse Image 04
                <span><input class="span4 form-control" id="image4" name="image4" type="file" style="width:90px;" onchange="return ajaxFileUpload(4);"></span>
                </label>&nbsp;&nbsp;<img id="loading_4" src="img/loading_ajax.gif" style="display:none;"> -->

                <input type="hidden" name="image_4_name" value="<?php echo $mg_image4_name; ?>" id="image_4_name" />
				<!-- <div class="dooo" id='yourId4'></div> -->
				<div class="cropControls cropControlsUpload"> </div>
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'slide_image_4','image_4_name','campaign_img');">
											</span>
										</label>
                                                 ...
                                                 <br>  
															...
															<div class="control-group form-group">
																...
																<div class="controls form-group">
																	   ...
																	   <h3 style="display: inline-block;">Redirect button</h3><img data-toggle="tooltip" title="The button text field can use a maximum of 15 characters including spaces. The redirect URL is where the visitor will land after watching this campaign." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">

																	<div class="">

												<input class="span4 form-control" id="slider_bottom_text" maxlength="15" name="slider_bottom_text"
...
<option <?php if($secslider=='https://'){echo 'selected';} ?> value="https://">https://</option>
														...
														case 'survey' :
															...
															<div class="controls">
																...
																<img src="img/mini_survy.JPG" width="400px; max-height:250px">
															</div>
                                                 ...
                                                 <br>  
                                                 	...
                                                 	<div class="control-group">
															...
															<div class="controls form-group">
																...
																<h3 style="display: inline-block;">Upload logo image</h3><img data-toggle="tooltip" title="The logo image must be a transparent png, gif, png, jpeg, jpg Maximum size 600 Kb. Use aspect ratio 8 by 3." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
																<div id="logo_su1_up_bc" class="no_crop_parent " style="vertical-align:top;">
               <!--  <label class="filebutton">
                Browse Image
                ...
                <input type="hidden" name="image_5_name" value="<?php echo $mg_image5_name; ?>" id="image_5_name" onkeyup="valid_check()"/>
				<!-- <div class="dooo" id='yourId5' onclick="img_val('yourId5','image_5_name')"></div> -->
				<?php if (strlen($mg_image5_name) > 0) { ?>
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo_su1_up_bc','image_5_name','campaign_img_logo');">
											</span>
										</label>
															...
															<!-- /control-group -->	
																...
																<div class="controls form-group">
																	...
																	<h3 style="display: inline-block;">Survey Question</h3><img data-toggle="tooltip" title="The question must be a simple multiple choice question. A maximum of 30 characters are allowed including spaces. EX. Which of these colors do you prefer?. You have to provide a minimum of two and maximum three possible predetermined answers. Ex. Yellow, Blue, Other. Each answer must be accompanied by an image." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
			...
			<div class="controls form-group">
				...
				<h3 style="display: inline-block;">Possible Answers</h3><img data-toggle="tooltip" title="Each predetermined answer can be a maximum of 20 characters. The image must be a .png or .jpg. Maximum size 200 Kb. Use aspect ratio 1 by 1." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
	...
	<!-- /control-group -->	
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div id="su_image_1" class="no_crop_parent "  style="vertical-align:top;">
															...
															<label class="no_crop_label">
											 													<span>
																							<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'su_image_1','image_1_name','campaign_img');">
																						</span>
																					</label>
...
$slider1red_http=$slider1red[0].'//';
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div id="su_image_2" class="no_crop_parent "  style="vertical-align:top;">
               <!--  <label class="filebutton">
                Browse Image 02
                <span><input class="span4 form-control" id="image2" name="image2" type="file" style="width:90px;" onchange="return ajaxFileUpload(2);"></span>
                </label>&nbsp;&nbsp;<img id="loading_2" src="img/loading_ajax.gif" style="display:none;"> -->
			...
			<?php } ?>
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'su_image_2','image_2_name','campaign_img');">
											</span>
										</label>

			</div>
               <div class="" id="img_div2"></div>
...
$slider2red_http=$slider2red[0].'//';		
		...
		<?php } ?>
             ...
             <div id="su_image_3" class="no_crop_parent "  style="vertical-align:top;">
				...
				<div class="cropControls cropControlsUpload"> </div>
				<?php if (strlen($mg_image3_name) > 0) { ?>
				<img class="croppedImg" src="<?php echo $upload_img->get_image($mg_image3_name); ?>"
											style='width:193px; display:inline; max-height: 160px; height: 160px;'>
										<?php } ?>
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'su_image_3','image_3_name','campaign_img');">
											</span>
										</label>

			</div>   
            	<div class="" id="img_div3"></div>
			</div>
																	<div class=""
																		 id="img_div3">
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div class="">
																		...
																		<input class="span3 form-control special_input" id="countdown_bottom_text "
...
<option <?php if($sec_survay_url=='https://'){echo 'selected';} ?> value="https://">https://</option>
														...
														case 'countdown_image' :
															...
															<div class="controls">
																...
																<img src="img/count_down_img.JPG" width="400px; max-height:250px">
															</div>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div class="">
																		...
																		<input class="countdown_top_text span4 form-control special_input" id="countdown_top_text" placeholder="Welcome Message" 
                                                 ...
                                                 <br> 
                                                 			...
                                                 			<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div iv id="logo_co_up_bc" class="no_crop_parent "
																		 style="vertical-align:top;">
																		 <input type="hidden" name="image_5_name" value="<?php echo $mg_image5_name; ?>" id="image_5_name" onkeyup="valid_check()" />
														<!-- <div class="dooo" id='yourId5' onclick="img_val('yourId5','image_5_name')"></div> -->
														...
														<label class="no_crop_label">
										 													<span>
																						<input value="" type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo_co_up_bc','image_5_name','campaign_img_logo');">
																					</span>
																				</label>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Upload Campaign image</h3><img data-toggle="tooltip" title="The image must be a .png or jpg. Maximum size 600Kb. Use aspect ratio 1 by 1." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">

																	<div id="co_image_1" class="no_crop_parent " style="vertical-align:top;">

											               <input type="hidden" name="image_1_name" value="<?php echo $mg_image1_name; ?>" id="image_1_name" onkeyup="valid_check()" />
															<!-- <div class="dooo" id='yourId1' onclick="img_val('yourId1','image_1_name')"></div> -->

															<div class="cropControls cropControlsUpload"> </div>
															<img class="croppedImg" src="<?php echo $upload_img->get_image($mg_image1_name); ?>"
																			style='width:193px; display:inline; max-height: 160px; height: 160px;'>
															<label class="no_crop_label">
											 													<span>
																							<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'co_image_1','image_1_name','campaign_img');">
																						</span>
																					</label>
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Countdown</h3><img data-toggle="tooltip" title="Set the amount of time the progression bar will show before the user is redirected to the final redirect URL." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div class="">
																			...
																			<input class="span3 form-control special_input" id="countdown_bottom_text" placeholder="Button text" 
																			   name="countdown_bottom_text" type="text" maxlength="15" 
...
<option <?php if($seccountdown=='https://'){echo 'selected';} ?> value="https://">https://</option>
														...
														case 'video' :
															...
															<div class="controls">
																...
																<img src="img/video_add.JPG" width="400px; max-height:250px">
															</div>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div class="">
																		...
																		<input class="countdown_top_text span4 form-control special_input" placeholder="Welcome Message" id="countdown_top_text"
																			   name="countdown_top_text" type="text" maxlength="30"
																			   value="<?php echo $mg_top_text; ?>">
																		<!--					<input class="span4" id="countdown_top_text" name="countdown_top_text" type="text" required value="-->
																		<?php // echo $mg_top_text;
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<div id="logo_vi_up_bc" class="no_crop_parent "  style="vertical-align:top;">
                <!-- <label class="filebutton">
                Browse Image
                <span><input class="span4 form-control" id="image5" name="image5" type="file" style="width:90px;" onchange="return ajaxFileUpload(5);"></span>
                </label>&nbsp;&nbsp;<img id="loading_5" src="img/loading_ajax.gif" style="display:none;"> -->
				...
				<label class="no_crop_label">
 													<span>
												<input type="file" name="img" class="no_crop" onchange="UploadImg(this,'logo_vi_up_bc','image_5_name','campaign_img_logo');">
											</span>
										</label>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Video Requirements</h3><img data-toggle="tooltip" title="Your video can be either 15 or 30 seconds long. We only accept videos from the youtube domain." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
...
<option <?php if($sec_wvideo=='https://'){echo 'selected';} ?> value="https://">https://</option>
											...
											<div class="control-group form-group">
												...
												<div class="controls form-group">
													...
													<h3 style="display: inline-block;">Campaign target audience</h3><img data-toggle="tooltip" title=" If using a Facebook or Manual Registration splash page theme you can create multiple campaigns targeting a specific demographic audience based on what data your splash page collect." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
											...
											<?php if ($package_functions->getSectionType("CAMP_CREATE_LOCATION", $system_package, $user_type) == "locations" || $package_features == "all") { ?>
												<div class="control-group form-group" style="display:none">
													...
													<div class="controls form-group">
													<h3 style="display: inline-block;">Campaign target location</h3><img data-toggle="tooltip" title="If you have more then one location you could create multiple campaigns and select which locations receive which campaign. Click the location in the left box to move it to the right box to activate the campaign for that location." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
														<div class="input-prepend input-append multi_sele_parent">
															<select name="group_tag[]" id="group_tag"
																...
																foreach ($query_results['data'] as $row) {
																	...
																	echo '<option value="' . $tag_name . '" ' . $set2 . '> ' . (empty($description)?$tag_name:$description ) . '</option>';
																}
				...
				<div class="control-group form-group">
					...
					<label style="text-align: left;" class="control-label"
							for="radiobtns"><strong>Service Area<sup><font
																	color="#FF0000">*</font></sup> </strong><img data-toggle="tooltip" title='Select the Service Area from the dropdown this campaign would be targeting. Select All if you would like the campaign to target all service areas.' src="layout/<?php echo $camp_layout; ?>/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;"></label>
				</div>
				</div>
				<div class="control-group form-group">
				...
				<div class="control-group form-group">
					...
					<div class="controls form-group">
						<label style="text-align: left;" class="control-label"
							for="radiobtns"><strong>SSID<sup><font
																	color="#FF0000">*</font></sup> </strong> <img data-toggle="tooltip" title='Select the SSID from the dropdown this campaign would be targeting. Select All if you would like the campaign to target all SSIDs.' src="layout/<?php echo $camp_layout; ?>/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;"></label>
				</div>
				</div>
				<div class="control-group form-group">
					...
					<div class="controls form-group">
						...
						<select class="span4" name="ssid">
							<?php if($ssid_sel=='all'){
								echo '<option selected value="all">All SSID</option>';
							}else{
								echo '<option value="all">All SSID</option>';
							} ?>
							<?php
...
<div class="controls">
	...
	<h3 style="display: inline-block;">Active<img data-toggle="tooltip" title="Select the check box if you want this campaign to go live immediately. Alternatively use the manage section to activate this campaign at a later date." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" "=""></h3>
