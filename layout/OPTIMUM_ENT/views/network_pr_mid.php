                    ...
                    <div class="control-group">
                        ...
                        <div>
                            <div class="controls col-lg-5 form-group">
                                ...
                                <input autocomplete="off" title="<?php echo $passcode_min; ?> to <?php echo $passcode_max; ?> characters" class="span4 form-control" id="password" onkeyup="strbar()" name="password" type="password" required minlength="<?php echo $passcode_min; ?>" maxlength="<?php echo $passcode_max; ?>" />
