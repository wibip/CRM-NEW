							...
							<div class="widget-content">
								...
								<div class="tabbable">
									<ul class="nav nav-tabs newTabs">
										...
										<?php }
										if(in_array("CONFIG_QOS",$features_array)|| $package_features=="all" || in_array("OTHER_LOG",$features_array) ){}
										}
										else{
										if(in_array("CONFIG_QOS",$features_array)|| $package_features=="all" || in_array("OTHER_LOG",$features_array) ){ ?>
								...
								<?php } ?>
									...
									<div <?php if(isset($tab3)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="user_activity_logs">
										...
										<div class="logs_head_visible" style="display:none;"><div class="header_hr"></div><div class="header_f1" style="width: 100%">
...
<br class="hide-sm"><br class="hide-sm"><div class="header_f2" style="width: fit-content;"> </div></div>
 ...
 $(document).ready(function() {
									...
									<?php   if(in_array('CONFIG_QOS',$features_array) || $package_features=="all" || in_array('OTHER_LOG',$features_array)){ ?>
											      ...
											      ?>
													...
													<div class="control-group ">
														...
														<div class="controls form-group">
																...
																<select class="span2 form-control" name="realm36" id="realm36" value=<?php echo $realm36 ?>>
																	<option value=""> All Realms </option>
																	<?php  

																		 $user_select_qu = "
																	SELECT DISTINCT a.property_id AS property,parent_id, a.distributor_code AS property_val  FROM `exp_mno_distributor` a WHERE a.mno_id='$user_distributor' ORDER BY parent_id";
																	// $user_select_re = mysql_query($user_select_qu);
																	// while($row_user = mysql_fetch_array($user_select_re)){
													...
													<div class="control-group">
														...
														<div class="controls form-group">
															<?php// echo $mg_start_24."------".$mg_end_24 ?>
																...
																<input class="inline_error inline_error_1 span2 form-control" id="start_date36" name="start_date36"
																	type="text" value="<?php if(isset($mg_start_date36)){echo $mg_start_36;} ?>" placeholder="mm/dd/yyyy">
																	to
																	<input class="inline_error inline_error_1 span2 form-control" id="end_date36" name="end_date36" type="text"
																	 value="<?php if(isset($mg_end_date36)){echo $mg_end_36;} ?>" placeholder="mm/dd/yyyy">
											...
											<div class="widget-content table_response">
												...
												<table class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
													...
													foreach($query_results1_resel as $row){
														...
														if(empty($function)){$function="N/A";}
													...
													<div class="control-group">
														...
														<div class="controls form-group">
															<?php// echo $mg_start_24."------".$mg_end_24 ?>
																...
																<input class="inline_error inline_error_1 span2 form-control" id="start_date24" name="start_date24"
																	type="text" value="<?php if(isset($mg_start_date24)){echo $mg_start_24;} ?>" placeholder="mm/dd/yyyy">
																	to
																	<input class="inline_error inline_error_1 span2 form-control" id="end_date24" name="end_date24" type="text"
																	 value="<?php if(isset($mg_end_date24)){echo $mg_end_24;} ?>" placeholder="mm/dd/yyyy">
