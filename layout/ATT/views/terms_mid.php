								...
								<ul class="nav nav-tabs">
									...
									<?php if($user_type == 'MNO'){
										...
										<?php if(in_array("TENANT_THEME",$features_array) || $package_features=="all"){
											...
											<li <?php if(isset($tab21)){$any_tab='0';$tab21='set';?>class="active" <?php }else if($any_tab=='1'){$any_tab='0';$tab21='set';?> class="active"<?php } ?>><a href="#theme_create" data-toggle="tab"><?php if(isset($_GET['modify_theme']) && $_GET['modify_theme']=='1'){echo "Edit Resident Theme";}else{echo "Resident Theme";} ?></a></li>	
...
<div <?php if(isset($tab21)){?>class="tab-pane active" <?php }else {?> class="tab-pane fade" <?php }?> id="theme_create">
								...
								<h1 class="head">Resident Theme</h1>
									...
									<fieldset>
										...
										<div class="control-group">
											...
											<div class="controls form-group">
												...
												<label class="" for="radiobtns">Theme Name<sup><font color="#FF0000" >*</font></sup></label>
										...
										<div class="control-group">
											...
											<div class="controls form-group">
												<label class="" for="radiobtns">Portal Title<sup><font color="#FF0000" >*</font></sup></label>
										...
										<div class="control-group">
											...
											<div class="controls form-group">
												...
												<label class="" for="radiobtns">Template<sup><font color="#FF0000" >*</font></sup></label>
										...
										<div class="control-group">
											...
											<label class="" for="radiobtns">Realm ID – Property Name<sup><font color="#FF0000" >*</font></sup></label>
												...
												<select class="span4 form-control" name="property_id_cre" class="span4" id="property_id_cre">
													...
													<?php
																	 ...
																	 $key_query1 = "SELECT o.`property_id` ,o.`property_number`,o.org_name FROM `mdu_organizations` o LEFT JOIN `mdu_mno_organizations` m ON m.`property_id` = o.`property_number` WHERE m.`mno` = '$mdu_mno_id' AND o.`property_type` = 'VTENANT'";
...
//echo $edit_pro_id;
															...
															<div class="t_hidden">
																...
																<div class="control-group">
																	...
																	<div class="controls form-group">
																		...
																		<label class="" for="radiobtns">Welcome Text<sup><font color="#FF0000" >*</font></sup></label>
																...
																<div class="control-group">
																	...
																	<div class="controls form-group">
																		<label class="" for="radiobtns">Welcome Description</label>
															...
															<div class="control-group t_hidden">
																...
																<label class="" for="radiobtns">Button Color ( Primary) </label>
															...
															<div class="control-group t_hidden">
																...
																<label class="" for="radiobtns">Button Color (Secondary) </label>
															...
															<div class="control-group t_hidden">
																...
																<label class="" for="radiobtns">Background Color </label>
															...
															<div class="control-group t_hidden">
																...
																<label class="" for="radiobtns">Footer Background Color </label>
															...
															<div class="control-group t_hidden">
																...
																<div class="controls form-group">
																<label class="" for="radiobtns">Selfcare Portal Login Screen Logo</label>
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input type="hidden" name="theme_id" id="theme_id" value="<?php echo $edit_theme_code; ?>">
...
function setHref(action) {
            ...
            $('#appLink').attr("href", "plugins/theme_create/mduThemeView.php?reg_type=" + $('#reg_type').val() + "&page=<?php echo $script; ?>&property=" + $('#property_id_cre').val() + "&template_name=" + $('#template_code').val() + "&dist=<?php echo $user_distributor; ?>&theme_id_ori=<?php echo $edit_theme_id; ?>&theme_id=" + $('#theme_id').val() + "&enc=" + $('#enc').val()+"&chatbot="+chatBot);
        }

														 $('#appLink').click(function(e) {
            e.preventDefault();
			var p = $('#property_id_cre').val();
if(p.length == 0){
...
return false;
			...
			window.location = $(this).attr("href");
															...
															<div class="control-group">
																...
																<div class="controls form-group contact" style="padding-right: 0px;text-align: center;">

																	<label id="isactive" class="" for="radiobtns">Active</label>

																	<input id="is_active" name="is_active"  type="checkbox" <?php if ($re_is_enable == 1) { ?> checked <?php } ?>
													 ...
													 -->
															...
															<?php if(strlen($theme_edit)>0){?>
																...
																<div class="form-actions" style="padding-right: 0px;text-align: center;">
															...
															<?php }else{?>
																...
																<div class="form-actions" style="text-align: center;padding-right: 0px;">
																	<input type="submit"  name="submit_theme" id="submit_theme" style="margin-bottom: 21px;" class="btn btn-primary" value="Save">
...
<br><br>
	...
	<div <?php if(isset($tab23)){?>class="tab-pane active" <?php }else {?> class="tab-pane fade" <?php }?> id="theme_preview">
		...
		<h1 class="head">Resident Theme Preview<img data-toggle="tooltip" title='Residents will automatically be redirected to your customizable captive portal upon connection to your Resident network. Create multiple portal themes for your location and easily enable/disable stored portal themes from the “Manage” tab.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h1>
...
<script type="text/javascript">
	...
	<?php }?>
												...
												//$query_get_default_ad = $q_generic=$db->selectDB("SELECT default_campaign_id FROM exp_mno WHERE mno_id = '$user_distributor'");
																								...
																								<div>
																									<center><img style="max-height:250px;margin-top:-22px" src="img/<?php echo $default_ad_preview_img.'?'.$db->setVal('footer_copy','ADMIN'); ?>" alt=""></center>
																								</div>
