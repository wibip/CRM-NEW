							...
							<div class="widget-content">
								<div class="tabbable">
									<ul class="nav nav-tabs">
										...
										<?php
											if($user_type == 'MNO' || $user_type == 'MVNE' || $user_type == 'MVNO' || $user_type == 'SUPPORT'){
										?>
										...
										<?php
											...
											if($user_type == 'MNO' || $user_type == 'MVNA' || $user_type == 'MVNE' || $user_type == 'SUPPORT'){
                            ...
                            if(isset($tab11)){
                                        ...
                                        <?php if(isset($_GET['assign_loc_admin'])){ ?>
                                            <div class="tab-pane fade in active" id="assign_loc_admin">
                                                <div class="header2_part1"><h1 class="head">Assign Property Admin <img data-toggle="tooltip" title="Change the name and email to the person you want to assign as property admin and click the Assign button. The person will get an activation email with instructions how to activate the account. The assigned admin will log in directly to the property Admin from the general login using its own unique credentials." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h1></div>
                                                ...
                                                <form autocomplete="off" id="edit_profile_form" action="?token7=<?php echo $secret;?>&t=12&edit_parent_id=<?php echo $assign_edit_parent_id  ;?>" method="post" class="form-horizontal" >
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <label class="" for="full_name_1">Property ID</label>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls col-lg-5 form-group">
                                                            <label class="" for="full_name_1">Account Name</label>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls col-lg-5 form-group">
                                                            <label class="" for="full_name_1">Admin First Name </label>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls col-lg-5 form-group">
                                                            <label class="" for="full_name_1">Admin Last Name </label>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <label class="" for="email_1">Admin Email</label>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls form-group col-lg-5">
                                                            <label class="" for="mobile_1">Phone Number</label>
                                                                ...
                                                                <script type="text/javascript">
                                                                    ...
                                                                    $(document).ready(function() {
                                                                        ...
                                                                        $('#mobile_1').focus(function(){
                                                                            ...
                                                                            $('#edit_profile_form').data('bootstrapValidator').updateStatus('mobile_1', 'NOT_VALIDATED').validateField('mobile_1');
                                                                        });
                                        ...
                                        <div <?php if(isset($tab12)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="edit_parent">
                                            ...
                                            <form action="?t=5<?php if(isset($get_edit_parent_id)) echo '&location_parent_id='.$get_edit_parent_id.'&token7='.$secret.'&t=12&edit_parent_id='.$get_edit_parent_id; ?>" id="parent_form" name="parent_form" class="form-horizontal" method="POST"   >
                                                ...
                                                <fieldset>
                                                        ...
                                                        <div class="control-group">
                                                            <div class="controls col-lg-5 form-group">
                                                            <label for="mno_full_name">Business ID</label>
                                                    ...
                                                    <div class="control-group">
                                                            <div class="controls col-lg-5 form-group">
                                                            <label for="mno_full_name">Business Account Name</label>
                                                    ...
                                                    <div class="control-group">
                                                            <div class="controls col-lg-5 form-group">
                                                            <label for="mno_full_name">First Name</label>
                                                    ...
                                                    <div class="control-group">
                                                            <div class="controls col-lg-5 form-group">
                                                            <label for="mno_full_name">Last Name</label>
                                                    ...
                                                    $(".pname").keyup(function() {
                                                     $(this).val($(this).val().replace(/\s/g, ""));
                                                        ...
                                                        <!--<div style="display: inline-block;width: 68%;">-->
                                                            <div class="controls col-lg-5 form-group">
                                                            <label for="mno_email">Email</label>
                                                     ...
                                                     $mno_feature=json_decode($fearuresjson);
                                                        ...
                                                        if(array_key_exists('new_features',$field_array) || $package_features=="all"){
                                                                         ...
                                                                         <div class="control-group" >
                                                                            <div class="controls col-lg-5 form-group">
                                                                            <label for="mno_email">Features<?php if($field_array['new_features']=="mandatory" || $package_features=="all"){ ?><sup><font color="#FF0000"></font></sup><?php } ?></label>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo ' <div class="control-group"> <div class="controls col-lg-5 form-group"><input   id="parent_package_type" name="parent_package_type" type="hidden" value="'.$edit_parent_system_package.'"></div></div>';
                                                    ?>
                                ...
                                <i class="btn-icon-only icon-remove-circle"></i>&nbsp;Remove</a><img id="distributor_loader_'.$distributor_id_number.'" src="img/loading_ajax.gif" style="display:none;"><script type="text/javascript">
                                    ...
                                    $(\'#DISTRI_'.$distributor_id_number.'\').easyconfirm({locale: {
                                            ...
                                            text: "Are you sure you want to remove ['.$distributor_name.'] account?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",
                                            button: [\'Cancel\',\' Confirm\'],
                                            closeText: \'close\'
                                             }});
                                                                        ...
                                                                        echo "<option  selected value='" . $value[0] . "'>" . $value[0] . "(".$value[1].")</option>";
                                                                           ...
                                                                           ?>
                                                                            ...
                                                                            <div class="control-group" style="display: none" id="vt-groups">
                                                                                <label class="control-label" for="vt-group">Vtenat Group <sup><font color="#FF0000"></font></sup></label>
                                                                                <div class="controls col-lg-5 form-group">
                                                                           ...
                                                                           <?php if($package_functions->getSectionType('OPERATOR_CODE',$system_package)=='YES'){ ?> <div class="control-group">
                                                                                <label class="control-label" for="mno_api_prifix">Operator Code<sup><font color="#FF0000"></font></sup></label>
                                                                                <div class="controls col-lg-5 form-group">
 ...
 s_a_val[2] = "N/A";
                                    ...
                                    function populateCountries(countryElementId, stateElementId) {
                                        ...
                                        <div <?php if(isset($tab9)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="assign_ap">
                                            ...
                                            <h1 class="head">View and Manage Properties<img data-toggle="tooltip" title="To send an automatic email invitation to the property admin, click on email link text in the table.
This email contains the account activation information and instructions." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h1>
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                echo'<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="7">Remove</th>
                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Edit</th>
                                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Send</th>';
                                        ...
                                        <div <?php if(isset($tab5)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="create_location">
                                                        ...
                                                        <form onkeyup="location_formfn();" onchange="location_formfn();"   autocomplete="off"   id="location_form" name="location_form" method="post" class="form-horizontal"	action="<?php if($_POST['p_update_button_action']=='add_location' || isset($_GET['location_parent_id'])){echo '?token7='.$secret.'&t=12&edit_parent_id='.$edit_parent_id;}else{echo'?t=5';} ?>" >
                                                                ...
                                                                <fieldset>
                                                                            ...
                                                                            <h1 class="head">Create Property</h1>
             ...
             document.getElementById("sync_loader").innerHTML = " &nbsp;&nbsp;&nbsp; <font color='red'>Network Error</font>";
                        ...
                        <?php } ?>
                                ...
                                if (isset($_GET['view_loc_code'])) {
                                    echo '<h1 class="head">View Property and AP information</h1>';
                                } else {


                                    echo '<h1 class="head">View and Manage Properties</h1>';
                                }
                            }?>
                                        ...
                                        <div id="response_d1">
											...
											<div class="widget-header">
												...
												<div class="widget-content table_response" id="ex-btn-div">

                                                    <a href='ajax/export_customer.php?key=<?php echo $customer_down_key?>' class="btn btn-primary export-customer-a" style="text-decoration:none">
												...
												if($count_records_exi == 0){
                                                 ...
                                                 <i class="btn-icon-only icon-remove-circle"></i>&nbsp;Remove</a><script type="text/javascript">
                                                                        ...
                                                                        $(\'#REMMNOACC_'.$mno_id.'\').easyconfirm({locale: {
                                                                                title: \'Account Remove\',
                                                                                text: \'Are you sure you want to remove ['.$mno_description.'] account?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\',
                                                                                button: [\'Cancel\',\' Confirm\'],
                                                                                closeText: \'close\'
                                                                                 }});
