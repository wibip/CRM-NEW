  ...
  <div class="tab-content">
      ...
      <?php if (in_array("NET_PRI_SSID", $features_array) || $package_features == "all") { ?>
          <div <?php if (isset($subtab10)) { ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="guestnet_tab_4">
              ...
              <h1 class="head">
                  Your backoffice and
                  employees deserve privacy. <img data-toggle="tooltip" title='In a few simple steps, you will be up and running with your Private Wi-Fi Service. Your Private Wi-Fi Service is encrypted and password protected. This is separate from your Guest Wi-Fi Service. As an added security feature, you have the option to show or hide your SSID name. If hidden you can still connect to the SSID if you know the SSID name.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
              </h1>
                                  ...
                                  <tbody>
                                      <?php
                                        ...
                                        foreach ($get_private_ssid_res['data'] as $get_private_ssid) {
                                            ...
                                            echo "</td><td>" . $get_private_ssid['bussiness_address1'] . "&nbsp;,&nbsp;" . $get_private_ssid['bussiness_address2'] . "&nbsp;" . $get_private_ssid['state_region'] . "<input type='hidden' name='ap[" . $i . "]' value='" . $get_private_ssid['ap_code'] . "'></td>";
                      ...
                      <div class="control-group">
                          ...
                          <div>
                              <div class="controls col-lg-5 form-group">
                                  ...
                                  <label class="" for="radiobtns">Current SSID Name<img data-toggle="tooltip" title="Name your SSID so your employees can easily identify and connect." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
      ...
      <?php if (in_array("NET_PRI_PASS", $features_array) || $package_features == "all") { ?>
          <div <?php if (isset($subtab9)) { ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="guestnet_tab_5">
              ...
              <h1 class="head">
                  ...
                  with a great password.<img data-toggle="tooltip" title=" If you would like to restrict access to your Private Wi-Fi network, you can set a password. Choose a password that is easy to remember but hard to guess." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
              </h1>
                      ...
                      <div class="control-group">
                          ...
                          <div>
                              <div class="controls col-lg-5 form-group">
                                  ...
                                  <label class="" for="radiobtns">Password <img data-toggle="tooltip" title='Your password must be at least 8 characters long and a maximum of 12 characters long. You should use a combination of numbers, upper and lower case letters and special characters: $ ! # @
Ex. Pa$$w0rd' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>

                                  <input autocomplete="off" required title="<?php echo $passcode_min; ?> to <?php echo $passcode_max; ?> characters" class="span4 form-control" id="password" onkeyup="strbar()" name="password" type="password" required minlength="<?php echo $passcode_min; ?>" maxlength="<?php echo $passcode_max; ?>" value="" />
