...
$venue_inner = 'layout/'.$camp_layout.'/views/venue_inner.php';
 ...
 ?>
								...
								<div <?php if(isset($tab1)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="manually_add">
									...
									<div class="header_f1" style="margin-bottom: 20px;width: 100%;margin-top: -20px">Tier 1 Support</div>
								...
								<form action="?t=1" id="mac_search" class="form-horizontal" method="post">
									<fieldset>
										...
										<div class="controls form-group">
                                            ...
                                            <img id="tooltip1" data-toggle="tooltip" title="Use the List All Devices button to see how many devices are registered and online right now. Or use the field and Search button to find a specific device using its MAC address." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 0px;cursor: pointer;display:  inline-block;margin-left: 4px;">
									...
									<p><b>DETERMINE IF A SESSION IS AVAILABLE: </b>If no device or session is available you can add the device manually in the field below. If a session is available, but the customer still cannot access the Internet, click Delete Device followed by deleting any sessions remaining for the device in the session search table above. Then add the device manually in the field below.</p>
								...
								<div <?php if(isset($tab2)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="support_log">
									...
									<div class="header_hr"></div>
									<div class="header_f1" style="margin-bottom: 20px;width: 100%;margin-top: -20px;">Access Logs</div>
									<br>
	...
	<!-- AP LOGS start -->
				<div <?php if(isset($tab3)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="support_log_api">
									<div id="response_d3">
										...
										<div class="header_hr"></div>
										<div class="header_f1" style="margin-bottom: 20px;width: 100%;    margin-top: -20px;">AP Controller Logs</div>
									<br>
...
<!-- AP LOGS END --><?php }
                                if(in_array('VEN_SUP_ERRORLOG',$features_array) || $package_features=="all"){ ?>
									...
									<div <?php if(isset($tab4)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="error_logs">
										...
										<div class="header_hr"></div>
										<div class="header_f1" style="margin-bottom: 20px;width: 100%;margin-top: -20px;">Error Logs</div>
									<br>
