...
$(document).ready(function() {
	$(".newTabs").append("<li class='active'><a href='#preview_theme_new' id='tab-preview_theme_new' data-toggle='tab'>Create-preview</a></li>");
	$('#tab-create_theme').css("display","none");
	$('#create_theme').css("display","none");
});
	 ...
	 <?php
                                            ...
                                            if(isset($_SESSION['create_theme'])){
                                            	...
                                            	<div class="header_hr"></div>
                                                 <div class="header_f1" >
    First impressions last</div><img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest WiFi network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
<br class="hide-sm"><br class="hide-sm"><div class="header_f2" style="width: fit-content;">make yours a splash page. </div>
...
<?php } ?>
													...
													<!-- /control-group -->
				                       				...
				                       				<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select  Location/Property<img data-toggle="tooltip" title='You can create a unique splash page for each of your locations.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select Language<img data-toggle="tooltip" title='[Coming soon] You can create multiple language versions of your splash page.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Browser Heading<img data-toggle="tooltip" title='Set the text you want your user to see in the splash page browser window.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
												...
												<!-- *************************** Text ************************** -->
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Progression<img data-toggle="tooltip" title='Set the progression text your visitors will see while the registration page is loading. Special characters allowed are _.-' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
...
?>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Redirection<img data-toggle="tooltip" title='Set the redirection URL  where the visitor will land after finalizing the registration. The Custom URL is the URL of your choice. The Default Website is the URL of your service provider. The Thank You Page is a static local system page.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Template<img data-toggle="tooltip" title='[Coming soon] Select from a list of predefined templates to modify to fit your location.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
    ...
    function choice2(select) {
        ...
        if(x=="default_theme" || x=="red_template" || x=="altice_business_default" || x=="wow_business_default"){
        ...
        if(x=="red_template" || x=="altice_business_default" || x=="wow_business_default"){
		...
		if((x=='res_cox_standard_template')){
			...
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\')" maxlength="16" name="welcome" class="span5 banner_txt_val" required="required" placeholder="Enter customer name text" value="'+ welcome_old +'">');
			$('#welcome_validate').hide();
		}
	...
	$(document).ready(function() {
       ...
       // console.log(y);
		...
		if((x=='res_cox_standard_template')){
			...
			$('#welcome').replaceWith('<textarea id="welcome" class="span5 banner_txt_val" onkeyup="valid_check(this.value,\'welcome_validate\')" maxlength="350" name="welcome"style="padding: 10px;border: 1px solid #979798;padding-left: 20px !important;padding-right: 20px !important;height: 72px;" ><?php echo $txt_new; ?></textarea>');
			$('#welcome_validate').hide();
			...
			$('#banner-def-txt').show();
			$('#banner-under-txt').html('<b>Note: You can add in your business name to the end of the default Banner Text. It can have up to 30 characters with spaces.</b>');
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\')" maxlength="16" name="welcome" class="span5 banner_txt_val" required="required" placeholder="Enter customer name text" value="<?php echo $txt_new; ?>">');
			$('#welcome_validate').hide();
		}
...
////
	...
	$(document).ready(function() {
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Registration Type<img data-toggle="tooltip" title=' Select the type of registration you would require your visitors to complete to gain access to the Internet.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>
    ...
    function choice1(select) {
        ...
        else if(x=="SMS_PAYPAL" || x=="VERIZON_GUEST"){
...
$(document).ready(function() {
	  ...
	  if(conceptName=="FB_MANUAL" ){
	   ...
	   try {$("#manual").show();}catch(err) {}
	     ...
	     else if(conceptName=="SMS_PAYPAL" || conceptName=="VERIZON_GUEST"){
...
<img data-toggle="tooltip" title='Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum size 1000KB. Recommended aspect ratio is 2 by 1.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;">
...
<input type="hidden" id="back_color1">
                                                ...
                                                <div class="control-group" id="duotone" style="display:none">

                                                        <!-- <label class="control-label" for="radiobtns">Duotone Overlay of background image</label> -->

                                                        <div class="controls">
                                                        	<h3 style="display:  inline-block;">Duotone Overlay of background <span> image<img data-toggle="tooltip" title='Select the overlay color and use the slider to set the transparency.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></span></h3>
...
<h4 id="logo_2_title" style="display: none;">Logo 2 or Logo 2 Alternative Text</h4>
															...
															<div class="controls uprel">
																...
																<h3 style="display: inline-block;">Upload logo image<img data-toggle="tooltip" title="Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum Size 200KB. Recommended aspect ratio is 8 by 3." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display: inline-block;margin-left: 4px;"></h3>
...
?>
													<div id="alttxt2" class="control-group">
														...
														<div class="controls">
																...
																<h3 style="display: inline-block;">Logo Alternative Text  <img data-toggle="tooltip" title="Check the box and add in your message instead of a logo. You can use up to 20 characters including space." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display: inline-block;margin-left: 4px;"></h3>
...
<label class="control-label" for="radiobtns" id="banner-label" style="display: none;">Banner Text</label>
													<div id="wtxt" class="controls">
															...
															<h3 style="display: inline-block;">Banner text<img data-toggle="tooltip" title="You can use up to 16 characters including spaces" src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display: inline-block;margin-left: 4px;"></h3>
...
<?php if(!in_array("welcome_text", $hide_divs_gene_arr)){ ?>
														<div id="txt_hide">
															...
															<div class="">
															<p id="banner-def-txt"></p>
															<input type="text" id="welcome" onkeyup="valid_check(this.value,'welcome_validate')" maxlength="16" name="welcome" class="span5 banner_txt_val" placeholder="Enter customer name text" required onkeyup="valid_check(this.value,'theme_name1_validate')" value="<?php echo $welcome_txt; ?>" autocomplete="off" >
...
<div id="wback" style="display:none">
...
<?php } ?>
												...
												<div id="fontcolor" class="control-group" style="display:none">
												...
												<div id="hrcolor" class="control-group" style="display:none">
                                                ...
                                                <div id="sms_input" style="display:none">
                                                	<br>
<hr>
<br>
													...
													<div class="control-group" id="recieved_number">
														...
														<div class="controls">
															...
															<label for="radiobtns">Mobile Number</label>
                                                            	...
                                                            	<input onclick="" data-role="mobilefiel" data-role1="mobile_number" name="m_mobile" id="m_mobiles" type="checkbox" disabled checked>
                                                            		<script type="text/javascript">
															...
															<input class="span5" id="mobile_numbers" name="mobile_number" type="text" value="<?php echo $edit_mobile_number_fields; ?>" >
													</div>
													...
													<!--<div class="control-group" id="sms_first_names">
														...
														<?php
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="sms_first()" data-role="fnamefields" data-role1="first_name" name="m_first_name" id="m_first_names" type="checkbox" checked>';
															...
															<input type="text" id="first_names" name="first_name" class="span5" value="<?php echo $first_name_text; ?>">
														</div>
																	...
																	echo '<input onclick="sms_first()" name="m_first_name" data-role="fnamefields" data-role1="first_name" id="m_first_names" type="checkbox">';
													...
													<!--<div class="control-group" id="sms_last_names">
														...
														<?php
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="sms_last()" data-role="lnamefields" data-role1="last_name" name="m_last_name" id="m_last_names" type="checkbox" checked>';
															...
															<input type="text" id="last_names" name="last_name" class="span5" value="<?php echo $last_name_text; ?>">
														</div>
																	...
																	echo '<input onclick="sms_last()" name="m_last_name" data-role="lnamefields" data-role1="last_name" id="m_last_names" type="checkbox">';
													...
													<!--<div class="control-group" id="sms_email">
														...
														$r = $manual_login_fields['email'];
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="sms_email()" data-role="emailfields" data-role1="email" name="m_email" id="m_emails" type="checkbox" checked>';
																	...
																	<script type="text/javascript">
																		...
																		<div id="emailfields">
																			<input class="span5" id="emails" name="email" type="text" value="<?php echo $email_field; ?>" required>
																		</div>
																	<?php
																} else {

																	echo '<input onclick="sms_email()" data-role1="email" data-role="emailfields" name="m_email" id="m_emails" type="checkbox">';
    ...
    if($(a).is(":checked")) {
		...
		$("#m_male").removeAttr('required');
													...
													<div class="control-group">
														...
														<div class="controls">
															<h3 style="display: inline-block;">Select manual registration <span> fields<img data-toggle="tooltip" title='Collecting demographic data from your visitors will give you additional insights and will allow you to create targeted campaigns based on those demographics.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;" ><span></h3>
														</div>
													</div>
															...
															<?php
																...
																if ($r == 1) {
																	...
																	<script type="text/javascript">
																		...
																		<div id="fnamefield" style="display:inline-block" >
																...
																if ($r == 1) {
																	...
																	$(document).ready(function() {
																	  ...
																	  $("#lnamefield").css('display', 'inline-block');
																		...
																		<div id="lnamefield" style="display:inline-block">
														...
														<label for="radiobtns">Email</label>
                                                            ...
                                                            $r = $manual_login_fields['email'];
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="emailfield" data-role1="email" name="m_email" id="" type="checkbox" checked>';
																	...
																	<script type="text/javascript">
																		...
																		<div id="emailfield" style="display:inline-block">
                                                            ...
                                                            if ($sms_auth=='Yes2') {
                                                            	echo '<input onclick="manual_toggle(this)" data-role="mobilefield" data-role1="mobile_number" name="m_mobile" id="m_mobile" type="checkbox" checked disabled>';
																	...
																	<script type="text/javascript">
																		...
																		<div id="mobilefield" style="display:inline-block">
...
<?php if(!in_array("manual_text", $hide_divs_gene_arr)){ ?>
											<div id="cmnlogintxt" class="control-group" style="display:none">
...
<div id="field_color" class="control-group feild" style="display:none">

														<div class="controls">

															<h3 style="display: inline-block;">Field Color<img data-toggle="tooltip" title="You can set the color of the fields depending on the background used." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display: inline-block;margin-left: 4px;"></h3>
													...
													<div id="field_txt_color" class="control-group feild" style="display:none">

														<div class="controls">

															<h3 style="display: inline-block;">Field Text Color<img data-toggle="tooltip" title="You can set the color of the field text based on the field color used." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display: inline-block;margin-left: 4px;"></h3>
													...
													<div id="field_preview" class="control-group" style="display:none">
...
<div id="manualbutton">
												...
												<div id="mregbtn" class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Button text<img data-toggle="tooltip" title="You can use up to 20 characters including spaces." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;"></h3>

															<div class="">

															<input type="text" class="span5" maxlength="20" id="sign_up" name="sign_up" value="<?php echo $registration_btn ?>" onkeyup="valid_check(this.value,'buttontext_validate')">
...
<div id="color">
													...
													<div id="btncolor" class="control-group" style="display:none">
...
<div id="ios2" style="display:none;">
...
<div id="greeting_txt_div" class="control-group" style="display:none">
...
<div id="footera" style="display:none;">
...
<?php if(!in_array("welcomepage", $hide_divs_gene_arr)){ ?>
										...
										<div class="tab-pane active" id="preview_theme_new" style="margin-left: 20px;">
...
<input type="hidden" id="using">
									...
									<div class="row">
										<div class="col1">
											<form id="edit-profile1-2" name="editprofile" class="form-horizontal" method="POST" action="theme.php" autocomplete="off">
										...
										if(tname=='' || !horizontal_validate || !vertical_validate || !logo2_up_validate || !logo1_up_validate || locid=='' || redirect_type == '' ||  welcome || sign_up || $('#loading_validate').is(":visible") || $('#splash_url_validate').is(":visible") || $('#title_t_validate').is(":visible") || $('#fontcolor1_validate').is(":visible") || $('#button_text_color_validate').is(":visible") || $('#button_color_validate').is(":visible") || $('#btn_color_disable_validate').is(":visible") || $('#button_ho_color_validate').is(":visible") || $("#shedule_name_dup").is(":visible") ){
                                            ...
                                            $(document).ready(function() {
												...
												<?php if($modify_mode != 1) {	?>
													...
													$('#edit-profile1-2').on('change keyup click paste',function(e){
          ...
          <div class="controls" style="margin-left:0px">
				...
				<div id="logo1_up_bc" style="width: 400px; height: 500px" class="input-prepend input-append"> 
					...
					<?php if($modify_mode!=1){?>
						...
						<img id="logo_hi_2" src="layout/<?php echo $camp_layout; ?>/img/logo2.png" style='width:125px !important;height:100px !important; display:inline;' class=""/>	
						<!-- <div id="load_grad" style="width: 400px; height: 500px;position: absolute;margin-top: -500px;" class="input-prepend input-append"></div> -->
						<?php } ?>
										...
										<div class="tab-pane <?php if($active_tab == 'assing') echo 'active'; ?>" id="assing">
                                            ...
                                            if(isset($_SESSION['msg_ass'])){
                                                ...
                                                unset($_SESSION['msg_ass']);
                                                                                              ...
                                                                                              <h1 class="head">
 Theme Assignment. <img data-toggle="tooltip" title='Select the theme you would like to assign to multiple locations. Then select the locations and save.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
</h1>
