...
<ul class="nav nav-tabs newTabs">
								...
								<div class="tab-content">
									...
									<div class="support_head_visible" style="display:none;"><div class="header_hr"></div><div class="header_f1 h1_pro" style="width: 100%;margin-bottom: 40px;">
...
<br class="hide-sm"><br class="hide-sm"><div class="header_f2" style="width: 100%;"> </div></div>
									...
									<div class="tab-pane <?php if($tab == '2'){ echo 'active'; } ?> " id="live_camp2">
										...
										<div class="support_head_visible" style="display:none;"><div class="header_hr"></div><div class="header_f1" style="width: 100%;margin-bottom: 40px;">
