    ...
    <form action="?t=create_property<?php if(isset($get_edit_parent_id)) echo '&location_parent_id='.$get_edit_parent_id.'&token7='.$secret.'&t=edit_parent&edit_parent_id='.$get_edit_parent_id; ?>" id="parent_form" name="parent_form" class="form-horizontal" method="POST"   >
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls col-lg-5 form-group">
                    <input class="span4 form-control pname" id="parent_first_name" placeholder="Full Name" name="parent_first_name" type="text" maxlength="30" value="<?php echo $edit_parent_first_name;?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls col-lg-5 form-group">
                    <input class="span4 form-control pname" id="parent_last_name" placeholder="Full Name" name="parent_last_name" type="text" maxlength="30" value="<?php echo$edit_parent_last_name;?>">
                </div>
            </div>
            <script>
