                ...
                <div class="widget-content">
                  ...
                  ?>
                    ...
                    <?php if ($device_count >= $max_count) {
                      echo '<font color="red">You have reached your device limit. To add more devices, you need to first remove your unused devices by clicking the REMOVE button. </font><br><br>';
                    }   ?>
                    </br>
                    <script>
                      ...
                      <div class="widget-content device_table">
                        <div style="overflow-x:auto">
                          ...
                          <table class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
                            <thead>
                              <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">MAC ID
                                </th>
                         ...
                         WHERE t2.user_name='$cust_user_name' AND d.description IS NULL";
                                ...
                                $key_query_d = "SELECT  id,`nick_name`,`email_address`,`description`,`mac_address`,`dpsk_key`,`cloutpath_id`,`is_wireless`,d.`other_parameters`
    ...
    window.location = "?t=tenant_account&token=' . $secret . '&customer_id=' . $mg_customer_id . '&search_id=' . $search_id . '&rm_device_id=' . $id . '&mac_id=' . $description . '"
                              ...
                              for ($di = 1; $di <= ($max_allowed_devices - $device_count_d); $di++) {
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $no; ?><form id="device_form<?php echo $di; ?>" name="device_form<?php echo $di; ?>" action="manage_tenant.php?t=tenant_account" method="post" class="form-horizontal" enctype="multipart/form-data" autocomplete="off" onsubmit="return validateForm<?php echo $di; ?>()">
                                  </td>
                                  <td>
                            ...
                            <div class="controls form-group">
                              <div class="columns" style="margin-bottom: 5px">
                                ...
                                if ($device_count >= $max_count) {
                                  echo '<font color="red">You have reached your device limit. To add more devices, you need to first remove your unused devices by clicking the REMOVE button. </font><br>';
                                }
                                ?>
                              </div>
            ...
            <div class="table_response_half">
              ...
              $(\'#DR_' . $id . '\').easyconfirm({locale: {
                ...
                $(\'#DR_' . $id . '\').click(function() {
                  ...
                  <br>
                  <strong>
                    <font style=" float: right;" size="-2"><?php echo $count_device; ?> of maximum <?php echo $max_count; ?> devices registered</font>
                  </strong>
                <?php } ?>
