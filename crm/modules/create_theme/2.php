...
make yours a splash page. <img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest <?php echo __WIFI_TEXT__; ?> network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
												...
												<div id="val_1">
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Name & type of splash page <span> theme<img data-toggle="tooltip" title='Customize your Guest <?php echo __WIFI_TEXT__; ?> splash page by giving it a name, selecting your location where the theme should show, setting the redirect URL where the visitors will land after registration, choosing a template and selecting a registration type.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ></span></h3>
...
<?php } ?>
													...
													<!-- /control-group -->
				                       				...
				                       				<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select  Location/Property<img data-toggle="tooltip" title='You can create a unique splash page for each of your locations.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select Language<img data-toggle="tooltip" title='[Coming soon] You can create multiple language versions of your splash page.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Browser Heading<img data-toggle="tooltip" title='Set the text you want your user to see in the splash page browser window.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
												...
												<!-- *************************** Text ************************** -->
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Progression<img data-toggle="tooltip" title='Set the progression text your visitors will see while the registration page is loading. Special characters allowed are _.-' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
?>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Redirection<img data-toggle="tooltip" title='Set the redirection URL  where the visitor will land after finalizing the registration. The Custom URL is the URL of your choice. The Default Website is the URL of your service provider. The Thank You Page is a static local system page.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Template<img data-toggle="tooltip" title='[Coming soon] Select from a list of predefined templates to modify to fit your location.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
    ...
    function choice2(select) {
        ...
        if(x=="default_theme" || x=="red_template" || x=="att_business_default"){
        ...
        if(x=="red_template" || x=="att_business_default"){
...
temp_image();
	...
	$(document).ready(function() {
        ...
        var y = '<img id="preview_img" src="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=20" data-zoom-image="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=20" style="max-height:200px;width:60%;max-width: 100%"><p><a id="pre_id" class="fancybox fancybox.iframe" href="<?php echo $base_portal_folder; ?>/checkpoint.php?client_mac=DEMO_MAC&theme='+template_name1+'&realm=<?php echo $db->getValueAsf("SELECT `verification_number` AS f FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor' LIMIT 1");?>">Preview Template Layout</a>';
	...
	$(document).ready(function() {
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Registration Type<img data-toggle="tooltip" title=' Select the type of registration you would require your visitors to complete to gain access to the Internet.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
<?php
//echo "SELECT `features` AS f FROM `exp_mno` m JOIN exp_mno_distributor d ON m.`mno_id`=d.`mno_id` WHERE d.`distributor_code`='$user_distributor' LIMIT 1";
$featurearr=array();
$featuresjson=$db->getValueAsf("SELECT `features` AS f FROM `mno_distributor_parent` p JOIN exp_mno_distributor d ON p.`parent_id`=d.`parent_id` WHERE `distributor_code`='$user_distributor' LIMIT 1");
$features=json_decode($featuresjson,true);

$optfeatures=$db->getValueAsf("SELECT m.`features` AS f FROM `exp_mno` m JOIN exp_mno_distributor d ON m.`mno_id`=d.`mno_id` WHERE d.`distributor_code`='$user_distributor' LIMIT 1");
$featuresopt=json_decode($optfeatures,true);
foreach ($features as $key => $value) {
	$parent_features_enable=$db->getValueAsf("SELECT mno_feature as f FROM exp_service_activation_features WHERE service_id='$key'");
	if (in_array($parent_features_enable, $featuresopt)) {
		array_push($featurearr, $key);
	}
}
//print_r($features);
//print_r($featuresopt);
...
?>
																<select id="reg_type" class="span5" name="reg_type" required="required" onchange="choice1(this); ck_topval();">
																	...
																	<?php
																		...
																		if ($system_package!='N/A') {
																			...
																			$key_query = "SELECT theme_code, theme_name,feature_name FROM exp_theme_manager WHERE theme_type = 'NEW' AND is_enable='1'
                                     ...
                                     // echo registration_type;
                                      ...
                                      if(($registration_type!=$theme_id || $modify_mode != 1) && (strlen($feature_name)<1)){
												echo '<option id="'.$theme_name.'" value="'.$theme_id.'">'.$theme_name.'</option>';
                                      }elseif(in_array($feature_name, $featurearr) && ($registration_type!=$theme_id || $modify_mode != 1)){
                                      			echo '<option id="'.$theme_name.'" value="'.$theme_id.'">'.$theme_name.'</option>';
                                      }
...
<div id="template_image" style="margin-top: 10px">
...
<div id="divlogo1" class="control-group">
	...
	<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
		...
		var cropContaineroutput = new Croppic('logo1_up1', croppicContaineroutputMinimallogo1);
...
<img data-toggle="tooltip" title='Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum size 1000KB. Recommended aspect ratio is 2 by 1.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;">
...
<small id="logo1_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="password" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
	...
	<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
		...
		var cropContaineroutput = new Croppic('logo1_up_bc1', croppicContaineroutputMinimallogo1);
...
<input type="hidden" id="back_color1">
                                                ...
                                                <div class="control-group" id="duotone">
                                                        ...
                                                        <div class="controls">
                                                        	<!-- <h3 style="display:  inline-block;">Overlay of background <span> image<img data-toggle="tooltip" title='Select the overlay color and use the slider to set the transparency.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></span></h3>
 -->                                                        	
...
<div id="logoimg" class="control-group" style="margin-top: -30px;">
...
<br>
															...
															<div class="controls uprel">
																...
																<h3 style="display: inline-block;">Upload logo image<img data-toggle="tooltip" title="Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum Size 200KB. Recommended aspect ratio is 8 by 3." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
					...
					<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION) && $upload_img->is_exists($th_logo_image,'logo') == 1){?>
	...
	<style type="text/css">
		...
		var cropContaineroutput = new Croppic('logo2_up1', croppicContaineroutputMinimallogo2);
...
?>
													<div id="alttxt2" class="control-group">
														...
														<div class="controls">
																...
																<h3 style="display: inline-block;">Logo Alternative Text  <img data-toggle="tooltip" title="Check the box and add in your message instead of a logo. You can use up to 20 characters including space." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
															 ...
															 <small id="logo_2_text_validate" data-bv-validator="notEmpty" data-bv-validator-for="password" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none; margin-left: 40px; */"><p>This is a required field</p></small>
																...
																<script type="text/javascript">
																	...
																	$('#logo_2_text').bind("cut copy paste",function(e) {
																		   ...
																		   $("#logo_2_text").keyup(function(event){

																				<?php if($modify_mode == 1 ){ ?>
																					if(document.getElementById('logo_2_text').value != ""){
...
<!-- <label class="control-label" for="radiobtns" id="banner-label" style="display: none;">Banner Text</label> -->
													<div id="wtxt" class="controls">
															...
															<!-- <h3 style="display: inline-block;">Banner text<img data-toggle="tooltip" title="You can use up to 30 characters including spaces" src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3> -->
    ...
    if($(a).is(":checked")) {
		...
		$("#m_male").removeAttr('required');
													...
													<div class="control-group">
														...
														<div class="controls">
															<h3 style="display: inline-block;">Select manual registration <span> fields<img data-toggle="tooltip" title='Collecting demographic data from your visitors will give you additional insights and will allow you to create targeted campaigns based on those demographics.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ><span></h3>
														</div>
													</div>
													...
													<div class="control-group" id="m_first_named">
														...
														<div class="controls">
															...
															<input type="text" id="first_name" name="first_name" class="span5 checkbox_txt_val" value="<?php echo $first_name_text; ?>">
														</div>
																	...
																	$(document).ready(function() {
																	  ...
																	  $("#lnamefield").css('display', 'inline-block');
																		...
																		<div id="lnamefield">
																			...
																			<input type="text" id="last_name" name="last_name" class="span5 checkbox_txt_val" value="<?php echo $last_name_text; ?>">
                                                            ...
                                                            $r = $manual_login_fields['email'];
																...
																if ($r == 1) {
																	...
																	<script type="text/javascript">
																		...
																		<div id="emailfield">
																			<input class="span5 checkbox_txt_val" id="email" name="email" type="text" value="<?php echo $email_field; ?>" required>
																		</div>
																	<?php
																} else {
                                                            ...
                                                            $r = $manual_login_fields['mobile_number'];
																if ($r == 1) {
																	...
																	<script type="text/javascript">
																		...
																		<div id="mobilefield">
															<input class="span5 checkbox_txt_val" id="mobile_number" name="mobile_number" type="text" value="<?php echo $edit_mobile_number_fields; ?>">
													</div>
																	<?php
																} else {
                                                            ...
                                                            $r = $manual_login_fields['gender'];
																if ($r == 1) {
																	...
																	<script type="text/javascript">
																		...
																		<div id="genderfld">
															<input class="span2a" id="gender" name="gender" type="text" value="<?php echo $gender_field; ?>" required readonly>

													</div>
													<div id="m_male">
														<input class="span2a checkbox_txt_val" id="male" name="male" type="text" value="<?php echo $male_field; ?>" required>
													</div>
													<div id="m_female">
															<input class="span2a checkbox_txt_val" id="female" name="female" type="text" value="<?php echo $female_field; ?>" required>
													</div>
...
<?php } ?>
													...
													<div class="control-group" id="m_age_groupd">
														...
														<label for="radiobtns">Age Group</label>
															...
															<input class="span5 checkbox_txt_val" id="age_group" name="age_group" type="text" value="<?php echo $age_group_field; ?>" required>
...
<!-- <div id="field_color" class="control-group feild">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Field Color<img data-toggle="tooltip" title="You can set the color of the fields depending on the background used." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
													...
													<div id="field_txt_color" class="control-group feild">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Field Text Color<img data-toggle="tooltip" title="You can set the color of the field text based on the field color used." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
...
<!-- <div id="manualbutton">
												...
												<div id="mregbtn" class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Button text<img data-toggle="tooltip" title="You can use up to 15 characters including spaces." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
<input type="hidden" maxlength="15" id="sign_up" name="sign_up" value="Connect" >
<!-- <div id="color">
...
<?php if(!in_array("welcomepage", $hide_divs_gene_arr)){ ?>
													...
													<div id="isactive" class="control-group">
														...
														<div class="controls">
															...
															<input id="is_active" name="is_active" onclick="ck_topval()" type="checkbox" <?php if ($is_active1 == 1) { ?> checked <?php } ?>
...
<script type="text/javascript">
    /* $(function () {
        var theme_val= document.getElementById("template_name").value;
        choice2(theme_val);
    }); */
