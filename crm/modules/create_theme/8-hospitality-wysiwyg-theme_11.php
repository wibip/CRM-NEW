...
<div <?php if (isset($tab_createTheme)){ ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="createTheme">
                                            ...
                                            <div class="widget widget-table action-table">
                                                <form enctype="multipart/form-data" id="theme_create_form" class="form-horizontal" method="POST">
                                                   ...
                                                   <!--  <div class="control-group">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select onchange="setHref(1);" class="span5" id="template_name" name="template_name" required="required" <?php echo $template_edit_disabled; ?>>
                                                            ...
                                                            <?php echo '<input type="hidden" name="edit_template_name" value="'.$edit_template_name.'">' ?>
                                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select id="reg_type" onchange="setHref(1);" class="span5" name="reg_type" required="required">
                                                                <?php
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <a id="appLink" href="">Change Appearance</a>
                                                        </div>
                                                    </div>
                                                    <div class="control-group" style="display: none">
                                                        <label class="control-label" for="radiobtns">Active</label>
                                                        <div class="controls">
                                                            <!-- <input id="is_active" name="is_active" type="checkbox" <?php //if ($edit_is_active == 1) { ?> checked <?php //} ?> data-toggle="tooltip" title="CHECKING THE BOX will activate this <?php //echo __THEME_TEXT__; ?> and make it visible to all your guests immediately. Or you can leave the box unchecked and enable the <?php //echo __THEME_TEXT__; ?> later from within the Manage section."> -->
        ...
        function setHref(action) {
            ...
            $('#appLink').attr("href", "plugins/theme_create/themeView.php?page=theme&reg_type=" + $('#reg_type').val() + "&template_name=" + $('#template_name').val() + "&dist=<?php echo $user_distributor; ?>&theme_id=" + $('#theme_id').val() + "&enc=" + $('#enc').val());
        }
