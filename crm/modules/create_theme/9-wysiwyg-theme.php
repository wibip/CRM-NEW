    ...
    <div class="widget widget-table action-table">
        <form enctype="multipart/form-data" id="theme_create_form" class="form-horizontal" method="POST"  action="<?php echo $script; ?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                                                            <label for="radiobtns">Registration Type
                                                            </label>
                                                            <select id="reg_type" class="span5" name="reg_type" required="required">
                                                                <?php
                                                        $parent_feature=json_decode($db->getValueAsf("SELECT features as f FROM `mno_distributor_parent` WHERE parent_id='$parent_id'"),true);
                                                        $featurearr=array();
                                                        ...
                                                        if (array_key_exists('PREPAID_MODULE', $parent_feature)) {
                                                            array_push($pieces, 'SNAPFORCE');
                                                            array_push($pieces, 'SNAPFORCE_PREMIUM');
                                                            array_push($pieces, 'SNAPFORCE_FREE');
                                                        }
                                                                $len = count($pieces);
                                                                $outstr = "";
