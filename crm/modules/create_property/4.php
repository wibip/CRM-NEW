...
SELECT * FROM (SELECT `country_code`,`country_name` FROM `exp_mno_country` WHERE `default_select`=0 ORDER BY `country_name` ASC) AS b");
                          ...
                          <?php }
                            ...
                            ?>
                              ...
                              <div class="control-group">
                                  <div class="controls col-lg-5 form-group">
                                      <label for="mno_mobile">Phone Number 2<?php if ($field_array['phone2'] == "mandatory") { ?><sup>
                                              <font color="#FF0000"></font>
                                          </sup><?php } ?></label>
                          ...
                          <?php }
                            ...
                            ?>
                              <div class="control-group">
                                  <div class="controls col-lg-5 form-group">
                                      <label for="mno_mobile">Phone Number 3<?php if ($field_array['phone3'] == "mandatory") { ?><sup>
                                              <font color="#FF0000"></font>
                                          </sup><?php } ?></label>
                                ...
                                ?>
                                  ...
                                  <div class="control-group" id="g_prof2">
                                      ...
                                      <div class="controls col-lg-5 form-group">
                                          ...
                                          <select <?php if ($field_array['g_QOS'] == "mandatory") { ?>required<?php } ?> name="AP_contrl_guest" id="AP_contrl_guest" class="span4 form-control" style="margin-right: 16px !important; margin-bottom: 15px !important;">
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls col-lg-5 form-group">
                                      ...
                                      <input id="DNS_profile_control" name="DNS_profile_control" value="on" onchange="dns_control()" type="checkbox" data-size="mini" <?php if ($edit_distributor_dns_profile_enable == 1) {
                                                                                                                                                                            echo 'checked';
                                                                                                                                                                        } ?> data-toggle="toggle" data-onstyle="success" data-offstyle="warning">
                                      <script>
                              ...
                              <div class="controls col-lg-5 form-group">
                                  ...
                                  <select class="form-control span4" multiple="multiple" id="network_type" name="network_type[]">
                                      ...
                                      <?php
                                        ...
                                        ?>
                                          <option <?php if (($edit_distributor_network_type == 'VT') || ($edit_distributor_network_type == 'VT-BOTH') || ($edit_distributor_network_type == 'VT-PRIVATE') || ($edit_distributor_network_type == 'VT-GUEST')) {
                                                        echo 'selected';
                                                    } else {
                                                        echo '';
                          ...
                          <div class="control-group" id="vt_voucher_div">
                              <?php
                                if ($edit_account == '1' && $edit_dpsk_enable) {
                                  ...
                                  <div class="controls col-lg-5 form-group"><label for="dpsk_voucher">Resident Account Creation Voucher <i title="All tenants will need a voucher to enable them to create an account. depending on level of security you can select from two options: <br>
                                ...
                                ?>
                                  ...
                                  <div class="control-group">
                                      <div class="controls col-lg-5 form-group">
                                          ...
                                          <label for="conroller">AP Controller<sup>
                                                  <font color="#FF0000"></font>
                                              </sup></label>
                                  ...
                                  <div id="zone_div" class="control-group" style="display: none; margin-bottom: 3px !important;">
                                      <div class="controls col-lg-5 form-group">
                                  ...
                                  <div class="control-group">
                                      <div class="controls col-lg-5 form-group">
                                          <label for="conrollernew">SW Controller<sup>
                                                  <font color="#FF0000"></font>
                                              </sup></label>
                                  ...
                                  <div id="group_div" class="control-group" style="display: none;margin-bottom: 3px !important;">
                                      <div class="controls col-lg-5 form-group">
                                          <label for="groups">Groups<sup>
                                                  <font color="#FF0000"></font>
                                              </sup></label>
...
WHERE t1.bzname='1' AND t1.ok";
                                ...
                                $q1.=" ='1'";
                                          ...
                                          <a style="display: inline-block; padding: 6px 20px !important;margin-bottom: 10px !important;" onclick="updateSWvariable();gotoSWNode($('#conrollernew').val());" class="btn btn-primary" style="align: left;"><i class="btn-icon-only icon-refresh"></i> Refresh</a>
                                  ...
                                  <div class="control-group" id="gateway" <?php if ($edit_distributor_gateway_type == 'ac' || $field_array['ne_WAG'] == 'display_none') {
                                                                                echo 'style="display: none; margin-bottom: 3px !important;"';
                                                                            } else {
                                                                                echo 'style="margin-bottom: 3px !important;"';
                                                                            } ?>>
                                      <div class="controls col-lg-5 form-group">
                                          <label for="zone_name">WAG<sup>
                                          ...
                                          <select class="span4 form-control" id="wag_name" name="wag_name" style="display: inline-block">
                                              <?php echo '<option value="">Select Option</option>';
                                                ...
                                                ?>
                                          </select><input type="checkbox" <?php if ($edit_distributor_wag_profile_enable == '1' || $edit_distributor_wag_profile_enable == 'on') {
                                                                                echo 'checked';
                                                                            } ?> name="content_filter" class="hide_checkbox" style="display: inline-block;" data-toggle="toggle">
                                      </div>
                                  ...
                                  <div class="control-group" <?php if ($edit_distributor_gateway_type == 'ac' || $field_array['ne_WAG'] == 'display_none') {
                                      ...
                                      <div class="controls col-lg-5 form-group">
                                          <label for="zone_name">WAG<sup>
                                                  <font color="#FF0000"></font></label>
                                          <input readonly type="text" value="<?php echo $db->getValueAsf("SELECT `wag_name` AS f FROM `exp_wag_profile` WHERE `wag_code`='$edit_distributor_wag_profile'"); ?>" required class="span4 form-control" style="display: inline-block; margin-bottom: 15px !important;">
                                          ...
                                          <input type="checkbox" <?php if ($edit_distributor_wag_profile_enable == '1') {
                                                                        echo 'checked';
                                                                    } ?> name="content_filter" class="hide_checkbox" style="display: inline-block" data-toggle="toggle">
                                      </div>
                                      <small>Note: Turn switch to ON to enable content filtering</small>
                          ...
                          <div id="ap_switch_div">
                              <h3>AP/Switch Controllers </h3>



                              <table class="tablesaw" style="border: 1px solid black;border-collapse: collapse;width: 82%">
                                  <tbody id="ap_details" class="detail-table">
                                      <tr>
                                          <td>AP: <?php echo $edit_distributor_ap_controller; ?></td>
                                          <td>SW: <?php echo $edit_distributor_sw_controller; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Zone Template: <?php echo $template_zone; ?></td>
                                          <td>Group Template: <?php echo $template_group; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Name: <?php echo $zone_description; ?></td>
                                          <td>Name: <?php echo $group_description; ?></td>
                                      </tr>
                                  </tbody>
                          ...
                          <div id="vTenant_div">
                              <h3>vTenant Network </h3>
                              <div class="controls form-group">
                                  <label for="vt_nu_of_network">Select Number Of Network</label>
                                  <?php if ($edit_account == 1) {
                                        echo '<div class="sele-disable-new span4" ></div>';
                                    } ?>
                                  <select required="" class="span4 form-control" id="vt_nu_of_network" name="vt_nu_of_network">
                                      ...
                                      <?php
                                        for ($i = 1; $i < 2; $i++) {
                                            if ($edit_wlan_count_arr['vtenant'] == $i) {
                              ...
                              <?php
                                ...
                                ?>
                              <table class="tablesaw" style="border: 1px solid black;border-collapse: collapse;width: 82%">
                                  <tbody id="vt_details" class="detail-table">
                                      <tr>
                                          <td>Property Type: <?php echo $property_type; ?></td>
                                          <td>Device Limit: <?php echo $deviceLimit; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Account Creation: <?php echo $signup_status; ?></td>
                                          <td>Tiny Url: <?php echo $compact_link; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Account Expiration: <?php echo 'Scheduled'; ?></td>
                                          <td>Onboarding WIFI VLAN: <?php echo $onboardingVLANID; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Account Purge: <?php echo $masterAccPurgeTime; ?></td>
                                          <td>VLAN Start: <?php echo $vt_vlan; ?></td>
                                      </tr>
                                  </tbody>
                          ...
                          <div id="guest_div">
                              ...
                              <table class="tablesaw" style="border: 1px solid black;border-collapse: collapse;width: 82%">
                                  <tbody id="guest_details" class="detail-table">
                                      <tr>
                                          <td>DHCP Pool VLAN: <?php echo $dhcp_pool; ?> </td>
                                          <td>Primary DNS: <?php echo $primary_dns; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Subnet: <?php echo $subnet; ?></td>
                                          <td>Secondary DNS: <?php echo $secondary_dns; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Subnet Mask: <?php echo $subnetMask; ?></td>
                                          <td>Primary Filter DNS: <?php echo $primary_dns_filter; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Subnet Strat: <?php echo $guest_subnet_start; ?></td>
                                          <td>Secondary Filter DNS: <?php echo $secondary_dns_filter; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Subnet End: <?php echo $guest_subnet_end; ?></td>
                                          <td>DHCP Lease Time: <?php echo $dhcp_lease_time; ?></td>
                                      </tr>
                                      <tr>
                                          <td>Encryption: <?php echo $g_encryption; ?></td>
                                          <td>VLAN Start: <?php echo $g_vlan; ?></td>
                                      </tr>
                                  </tbody>
                          ...
                          <div id="private_div">
                              ...
                              <table class="tablesaw" style="border: 1px solid black;border-collapse: collapse;width: 82%">
                                  <tbody id="pvt_details" class="detail-table">
                                      <tr>
                                          <td>Encryption: <?php echo $private_encryption; ?></td>
                                          <td>VLAN Start: <?php echo $pvt_vlan; ?></td>
                                      </tr>
                                  </tbody>
                                              ...
                                              <div id="guestwlancreate">
                                                  <div class="control-group">
                                                      <div class="controls form-group">
                                                          ...
                                                          <input type="text" name="lookup_key_g" id="lookup_key_g" value="" placeholder="" class="span4 form-control">
                                                      </div>
                                                      <!-- /controls -->
                                                  </div>
                                                  <div class="control-group">
                                              ...
                                              <div id="privatewlancreate" style="display: none;">
                                                  <div class="control-group">
                                                      <div class="controls form-group">
                                                          ...
                                                          <input type="text" name="lookup_key_pt" id="lookup_key_pt" value="" placeholder="" class="span4 form-control">
                                                      </div>
                                                      <!-- /controls -->
                                                  </div>
                                                  <div class="control-group">
                                                  ...
                                                  <div class="control-group">
                                                      <div class="controls form-group">
                                                          <label for="product_pt">Free-Access:</label>
                  ...
                  <div class="control-group">
                      <div style="text-align: center;">
                          ...
                          <div id="wlan_sync">
                              <label>Wlan to Property Zone Mapping <font color="#FF0000"></font></sup> <a onclick="gotorelm_matchtabel();" class="btn btn-primary qos-sync-button" style="align: left;"><i class="btn-icon-only icon-refresh"></i>
                                      Sync WLANs</a>
                                  <div style="display: inline-block" id="re_mapp_loader"></div>
                              </label>
                          </div>
                          <div <?php if ($edit_account != 1) { ?> style="display: none;" <?php } ?>>
                              <button class="btn btn-info inline-btn" type="button" data-toggle="modal" data-target="#wlanframe_create">Create Wlan</button>
                          </div>
                  ...
                  <div class="modal-body">
                      <div class="control-group">
                          <div class="controls form-group">
                              ...
                              <input type="text" name="lookup_key_guest" id="lookup_key_guest" value="" placeholder="" class="span4 form-control">
                          </div>
                          <!-- /controls -->
                      </div>
                      <div class="control-group">
                  ...
                  <div class="modal-body">
                      <div class="control-group">
                          <div class="controls form-group">
                              ...
                              <input type="text" name="lookup_key_pvt" id="lookup_key_pvt" value="" placeholder="" class="span4 form-control">
                          </div>
                          <!-- /controls -->
                      </div>
                      <div class="control-group">
                      ...
                      <div class="control-group">
                          <div class="controls form-group">
                              <label for="product_pvt">Free-Access:</label>
      ...
      function wlanAutomation(val) {
          ...
          switch (val) {
              ...
              case 'GUEST': {
                  ...
                  bootstrapValidator.enableFieldValidators('vt_nu_of_network', false);
              ...
              case 'VT': {
                  ...
                  $('#private_div').hide();
                  bootstrapValidator.enableFieldValidators('g_nu_of_network', false);
                  bootstrapValidator.enableFieldValidators('vt_nu_of_network', true);
                  bootstrapValidator.enableFieldValidators('pr_nu_of_network', false);
                  break;
              }
              case 'VT-GUEST': {
