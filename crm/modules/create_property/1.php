...
if($suspend_location_view=='ENABLE' && $edit_account=='1'){
                    ?>
<!-- <div class="control-group">
                            <label class="control-label" for="acc_status">Active<sup><font color="#FF0000"></font></sup></label>
                            <div class="controls col-lg-5 form-group">
                               
                           
                            
                            <input  name="acc_status" id="acc_status" type="checkbox">

                        </div>
                        </div>

<div class="control-group">
                            <label class="control-label" for="suspended_reason">Suspended Reason<sup><font color="#FF0000"></font></sup></label>
                            <div class="controls col-lg-5 form-group">
                               
                            <textarea style="resize: vertical;" class="span4 form-control" rows="5" id="suspended_reason" name="suspended_reason" ></textarea>
