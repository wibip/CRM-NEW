								...
								<div class="widget-content">
									<div class="tabbable">
										<ul class="nav nav-tabs newTabs">
											...
											<li <?php if (isset($tab1)) { ?>class="active" <?php } ?>><a href="#show_clients" data-toggle="tab">Property</a></li>
										...
										<div class="tab-content">
											...
											<div <?php if (isset($tab1)) { ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="show_clients">
												<h1 class="head">Show Properties</h1>	
													...
													<div class="widget-content table_response">
														<div style="overflow-x:auto;">
															<table class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
																<thead>
																	<tr>
                                                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0">Unique Property ID</th>
                                                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Operator Name</th>
                                                                        ...
                                                                        <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Remove</th>  
																	</tr>
																</thead>
																<tbody>
																	<?php
																	$query_results = $CommonFunctions->getPropertyForSM($access_role);
																	if(isset($query_results['rowCount']) && $query_results['rowCount'] > 0) {
																		foreach ($query_results['data'] as $row) {
																			...
																			echo '<td><a href="javascript:void();" id="VIEWACC_' . $id . '"  class="btn btn-small btn-primary">
																					<i class="btn-icon-only icon-wrench"></i>&nbsp;View</a>
                                                                                    <script type="text/javascript">
                                                                                        $(document).ready(function() {
                                                                                            $(\'#VIEWACC_' . $id . '\').easyconfirm({locale: {
                                                                                                title: \'Property View\',
                                                                                    ...
                                                                                    <td><a href="javascript:void();" id="REMOVEACC_' . $id . '"  class="btn btn-small btn-danger">
																					<i class="btn-icon-only icon-trash"></i>&nbsp;Remove</a>
                                                                                    <script type="text/javascript">
                                                                                        $(document).ready(function() {
                                                                                            $(\'#REMOVEACC_' . $id . '\').easyconfirm({locale: {
                                                                                                title: \'Remove Property\',
                                                                                                text: \'Are you sure you want to remove [' . $business_name . '] property?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\',
                                                                                                button: [\'Cancel\',\' Confirm\'],
                                                                                                closeText: \'close\'
                                                                                                }});
												...
												<form onkeyup="footer_submitfn1();" onchange="footer_submitfn1();" autocomplete="off" id="edit-user-password" action="?t=1" method="post" class="form-horizontal">
													...
													<fieldset>
														...
														<div class="form-actions">
															...
															<button type="button" onclick="goto('/sales_crm')" class="btn btn-danger">Cancel</button>&nbsp;
														</div>
														<!-- /form-actions -->
													</fieldset>
												</form>
