						...
						<div class="widget ">
							...
							<div class="widget-content">
								<div class="tabbable">
                                    ...
                                    ?>
                                            <li <?php if (isset($tab5)){ ?>class="active" <?php } ?>><a href="#create_location" data-toggle="tab"><?php if ($edit_account == '1') echo 'Edit SMB Account'; else echo 'Create'; ?></a></li>
                                    <?php
                                            }
									...
									<div class="tab-content">
                                        ...
                                        <!-- ***************Propery Accounts********************** -->
                                        <div <?php if(isset($tab5)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?> id="create_property">
