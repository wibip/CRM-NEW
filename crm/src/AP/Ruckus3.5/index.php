...
{
    protected $url_postfix = '/api/public/v5_0';
    protected $ap;
	...
	public function rkszones(){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones?listSize=100000';
		$ch2 = curl_init($url2);
...
//$this->log(__FUNCTION__,'Check Zones', $url2 ,'GET', $status , $message , '');
	...
	public function createzone($name,$setuname,$setpassword){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones';
		$ch2 = curl_init($url2);
	...
	'tunnelProfile'   => array('id' => $id,
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid;
	...
	public function moveAPToZone($zoneId,$apMac,$apName,$apDescription){
		...
		$url2=$input[baseurl].'/api/public/v5_0/aps/'.$apMac;
	...
	///////////////creat network///////////////
	 public function createnetwork($zoneid,$name,$ssid){
		...
		$input=$this->session();
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans';
		$ch2 = curl_init($url2);
...
///////////////////////////////////delete netword/////////////////////
	function deleteSSID($zone,$id){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zone.'/wlans/'.$id;
	...
	public function modifynetwork($zoneid,$id,$name,$ssid,$description,$tunnel){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans/'.$id;
...
/////////////////retrieve 1 ssid details///////////////////
    ...
    public function retrieveAPOperationalSummary($apmac){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/aps/'.$apmac.'/operational/summary';
        $ch2 = curl_init($url2);
...
/////////////////retrieve 1 ssid details///////////////////
    ...
    public function retrieveAPMacList($apmac){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/aps/'.$apmac.'/operational/client';
        $ch2 = curl_init($url2);
	...
	public function retrieveZoneMeshData($zoneid){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/mesh';
		$ch2 = curl_init($url2);
	...
	public function modifyZoneTimeZone($zoneid,$abbreviation,$gmtOffset,$gmtOffsetMinute,$timeZone=null){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/timezone';
...
/////////////////////////////////////////////////////////////////////////	
	...
	public function modifynetworkEncryption($zoneid,$id,$method,$algorithm,$passphrase){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans/'.$id.'/encryption';
	...
	public function createap($zoneid,$mac,$name,$administrativeState,$description=null){
		...
		$input=$this->session();
		$url2=$input[baseurl].'/api/public/v5_0/aps';
		$ch2 = curl_init($url2);
	...
	public function retrieveaplistzone($zoneid,$icom=NULL){
		...
		$url2=$input[baseurl].'/api/public/v5_0/aps?zoneId='.$zoneid;
		$ch2 = curl_init($url2);
...
////////////////////////////////////////////////////////////////////
	...
	/////////////////zone delete////////////////////v5_0/profiles/utp/{id}

	function deletezone($id){

		$input=$this->session();

		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$id;
	...
	public function createUTP($name,$defaultAction){
		...
		$url2=$input[baseurl].'/api/public/v5_0/profiles/utp';
		$ch2 = curl_init($url2);
	...
	//
		...
		$url2=$input[baseurl].'/api/public/v5_0/profiles/utp/'.$id;
	...
	public function deleteeutp($id){
		...
		$curl = curl_init($input[baseurl].'/api/public/v5_0/profiles/utp/'.$id.'');
	...
	public function modifyPowerSchedule($zoneid,$scheduleID,array $data_ar, $id, $type, $name=NULL){

		$data_ar['name']= uniqid('name_');
        $data_ar['description'] = uniqid('description_');
		$data = $data_ar;

		parse_str($this->createScheduler($zoneid,$data), $createSchedulerResult);

		if ($createSchedulerResult['status_code'] == '200') {

			$new_schedule_id = json_decode($createSchedulerResult['Description'], true)['id'];

			parse_str($this->modifySchedule($zoneid, $id, $type, $new_schedule_id, $data_ar['name']), $modifyScheduleResult);

				if ($modifyScheduleResult['status_code'] == '200') {

					parse_str($this->deleteeScheduler($zoneid,$scheduleID), $deleteeSchedulerResult);

					if ($deleteeSchedulerResult['status_code'] == '200') {

						return 'status=success&status_code=200&Description='.$createSchedulerResult['Description'];
				
					}
					else{
						return 'status=failed&status_code='.$deleteeSchedulerResult['status_code'].'&Description='.$deleteeSchedulerResult['Description'];
					}	

				}
				else{
					return 'status=failed&status_code='.$modifyScheduleResult['status_code'].'&Description='.$modifyScheduleResult['Description'];
				}
			...
			return 'status=failed&status_code='.$createSchedulerResult['status_code'].'&Description='.$createSchedulerResult['Description'];
		}
	}
	...
	public function createScheduler($zoneid,$data){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlanSchedulers';
		$ch2 = curl_init($url2);
...
/*
	...
	public function deleteeScheduler($zoneid,$id){
		...
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlanSchedulers/'.$id;
	
		$curl = curl_init($input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlanSchedulers/'.$id.'');
...
///////////////////retrieve scheduler///////////////////
    public function retrieveSchedule($zoneID,$scheduleID){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneID.'/wlanSchedulers/'.$scheduleID;
	$ch2 = curl_init($url2);
...
function modifySchedule($zoneid,$id,$type,$SU_id=NULL,$name=NULL){
	...
	//print_r($data);
		 $url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans/'.$id.'/schedule';
...
public function ACLupdate($zoneid,$id,$name,$ACLid){
	...
	$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans/'.$id.'/l2ACL';
...
/////////////////////////////Retrieve Client List apmac//////////////////////////
	public function retrieveTunnelGREProfile($tunnelType){
		...
		$url2=$input[baseurl].'/api/public/v5_0/profiles/tunnel/'.$tunnelType;
		$ch2 = curl_init($url2);
...
//////////modify tunnel profile/////
	...
	function modifyTunnelProfile($zoneid,$tunnelProfileID,$tunnelProfileName){
		...
		//print_r($data);
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/tunnelProfile';
	 ...
	 $url2=$input[baseurl].'/api/public/v5_0/aps/'.$mac;
		$ch2 = curl_init($url2);
...
function hideSSID($zoneid,$id,$enable){
	...
	$url2=$input[baseurl]."/api/public/v5_0/rkszones/".$zoneid."/wlans/".$id."/advancedOptions";
    ...
    public function retrieveDNSServerProfile(){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/profiles/dnsserver';
        $ch2 = curl_init($url2);
    ...
    public function modifyWLanDNSServerProfile($zone,$id,$dnsProfileId,$dnsProfileName){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zone.'/wlans/'.$id.'/dnsServerProfile';
        $ch2 = curl_init($url2);
        ...
        //$this->log(__FUNCTION__,'Create CPE', $api_path,'POST', $status, $message, json_encode($jsonData));
        $url2 = $url2.$data;
        $this->log(__FUNCTION__,'Modify WLan DNS Server Profile', $url2,'PATCH', $status, $message, '',$this->realm);
    ...
    public function modifyAPmeshOption($ap_mac,$meshMode,$upLinkSelection=null,array $meshUpLinkEntryList=null){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/aps/'.$ap_mac.'/meshOptions';
...
/////////////////get DHCP Pool List///////////////////
    ...
    public function getZoneDHCPProfile($zoneID){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneID.'/dhcpSite/dhcpProfile';
        $ch2 = curl_init($url2);
...
/////////////////////////////////////////////////////////////////////////
    ...
    public function modifyZoneDHCPSiteConfig($zoneId,$siteEnabled,$manualSelect,$siteMode,array $siteAps , array $siteProfileIds ){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneId.'/dhcpSiteConfig';
...
//echo $response;
    ...
    public function rebootAP($APMac){
        ...
        $url2=$input[baseurl].'/api/public/v5_0/aps/'.$APMac.'/reboot';
        $ch2 = curl_init($url2);
...
function queryClient(array $filters ){
	...
	$url2=$input[baseurl]."/api/public/v5_0/query/client";
...
function queryAP(array $data ){
	...
	$url2=$input[baseurl]."/api/public/v5_0/query/ap";
	...
	$this->log(__FUNCTION__,'Query AP', $url2,'POST', $status, $message, $url2,$this->realm);
...
public function createZoneAAA($zoneid,$name,$port,$primary_ip,$sharedSecret,$second=NULL,$seprimary_ip,$sesharedSecret){
	...
	//$input=$this->session();
	$input=$this->session();
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/aaa/radius';
	$ch2 = curl_init($url2);
...
public function retrieveZoneAAAID($zoneid,$id){
	...
	$input=$this->session();
		$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/aaa/radius/'.$id;
	$ch2 = curl_init($url2);
...
//$input=$this->session();
$input=$this->session();
$url2=$input[baseurl].'/api/public/v5_0/rkszones/'.$zoneid.'/wlans/standard80211';
$ch2 = curl_init($url2);
