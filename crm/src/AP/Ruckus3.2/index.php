...
class ap_wag
{
	...
	public function getAPGroups($zone)
    {
        ...
        $url2 = $input[baseurl].'/api/public/v3_1/rkszones/' . $zone . '/apgroups';
...
//echo $response;
    ...
    public function disconnectClient($apMac, $clientMac)
    {
        ...
        $url2 = $input[baseurl] . '/clients/disconnect';
        $ch2=curl_init();
        ...
        $this->log(__FUNCTION__,'Disconnect Client', $url2,'POST', $status, $message, $payload,$this->realm);
    ...
    public function disconnectClients(array $clients)
    {
        ...
        $payload = json_encode($data);
        $url2 = $input[baseurl] . '/clients/bulkDisconnect';
        ...
        $this->log(__FUNCTION__,'Disconnect Clients', $url2,'POST', $status, $message, $payload,$this->realm);
	...
	public function log($function,$function_name,$description,$method,$api_status,$api_details,$api_data,$rlm){
		...
		$query_results=$db_class->execDB($query);
	...
	public function session($c=NULL,$d=NULL){
		...
		//API Url
		$url = $login[baseurl].'/api/public/v3_1/session';
    ...
    public function retrieveAPOperationalSummary($apmac){
        ...
        $url2=$input[baseurl].'/api/public/v3_1/aps/'.$apmac.'/operational/summary';
        $ch2 = curl_init($url2);
    ...
    public function retrieveAPMacList($apmac){
        ...
        $url2=$input[baseurl].'/api/public/v3_1/aps/'.$apmac.'/operational/client';
        $ch2 = curl_init($url2);
	...
	public function rkszones(){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones';
		$ch2 = curl_init($url2);
...
//$this->log(__FUNCTION__,'Check Zones', $url2 ,'GET', $status , $message , '');
	...
	'tunnelProfile'   => array('id' => $id,
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid;
	...
	///////////////creat network///////////////
	 public function createnetwork($zoneid,$name,$ssid){
		...
		$input=$this->session();
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans';
		$ch2 = curl_init($url2);
...
///////////////////////////////////delete netword/////////////////////
	function deleteSSID($zone,$id){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zone.'/wlans/'.$id;
	...
	public function modifynetwork($zoneid,$id,$name,$ssid,$description,$tunnel){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans/'.$id;
...
/////////////////retrieve 1 ssid details///////////////////
	...
	public function modifyZoneTimeZone($zoneid,$abbreviation,$gmtOffset,$gmtOffsetMinute){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/timezone';
...
/////////////////////////////////////////////////////////////////////////	
	...
	public function modifynetworkEncryption($zoneid,$id,$method,$algorithm,$passphrase){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans/'.$id.'/encryption';
	...
	public function createap($zoneid,$mac){
		...
		$input=$this->session();
		$url2=$input[baseurl].'/api/public/v3_1/aps';
		$ch2 = curl_init($url2);
	...
	public function retrieveaplistzone($zoneid,$icom=NULL){
		...
		$url2=$input[baseurl].'/api/public/v3_1/aps?zoneId='.$zoneid;
		$ch2 = curl_init($url2);
...
////////////////////////////////////////////////////////////////////
	...
	function deletezone($id){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$id;
	...
	public function createUTP($name,$defaultAction){
		...
		$url2=$input[baseurl].'/api/public/v3_1/profiles/utp';
		$ch2 = curl_init($url2);
	...
	//
		...
		$url2=$input[baseurl].'/api/public/v3_1/profiles/utp/'.$id;
	...
	public function deleteeutp($id){
		...
		$curl = curl_init($input[baseurl].'/api/public/v3_1/profiles/utp/'.$id.'');
	...
	public function createScheduler($zoneid,$data){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlanSchedulers';
		$ch2 = curl_init($url2);
	...
	public function deleteeScheduler($zoneid,$id){
		...
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlanSchedulers/'.$id;
	
		$curl = curl_init($input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlanSchedulers/'.$id.'');
...
function modifySchedule($zoneid,$id,$type,$SU_id=NULL,$name=NULL){
	...
	//print_r($data);
		 $url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans/'.$id.'/schedule';
...
public function ACLupdate($zoneid,$id,$name,$ACLid){
	...
	$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans/'.$id.'/l2ACL';
...
public function ACLdelete($zoneid,$id){
	...
	$curl = curl_init($input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/wlans/'.$id.'/l2ACL');
...
public function retrieveopapmaclist($apmac){
	...
	echo $url2=$input[baseurl].'/api/public/v3_1/aps/'.$apmac.'/operational/client';
	$ch2 = curl_init($url2);
...
/////////////////////////////Retrieve Client List apmac//////////////////////////
	public function retrieveTunnelGREProfile($tunnelType){
		...
		$url2=$input[baseurl].'/api/public/v3_1/profiles/tunnel/'.$tunnelType;
		$ch2 = curl_init($url2);
...
//////////modify tunnel profile/////
	...
	function modifyTunnelProfile($zoneid,$tunnelProfileID,$tunnelProfileName){
		...
		//print_r($data);
		$url2=$input[baseurl].'/api/public/v3_1/rkszones/'.$zoneid.'/tunnelProfile';
	 ...
	 $url2=$input[baseurl].'/api/public/v3_1/aps/'.$mac;
		$ch2 = curl_init($url2);
...
function hideSSID($zoneid,$id,$enable){
	...
	$url2=$input[baseurl]."/api/public/v3_1/rkszones/$zoneid/wlans/$id/advancedOptions";
