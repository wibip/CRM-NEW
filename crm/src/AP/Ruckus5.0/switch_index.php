...
class switch_wag
{
	private $url1_postfix = '/wsg/api/public/v7_0';
	private $switch_url1_postfix = '/switchm/api/v7_0';
	private $baseurl = '';
	private $cookie = '';
...
//echo $response;
    ...
    public function delete_switch($switch_id){

        //$input=$this->session();

        $url2=$this->baseurl.'/switch/'.$switch_id;
        $ch2 = curl_init($url2);
    ...
    public function Functionlist(){
    	...
    	$jsonData_funtionlist = array(
    		'createSwitchGroup'=>'Create Switch Group',
           	...
           	'getGroupsByDomain'=>'Get Switch Groups By Domain'
		);
