...
{
    protected $url_postfix = '/wsg/api/public/v7_0';
    protected $switch_url_postfix = '/switchm/api/v7_0';
    protected $ap;
...
//$this->log(__FUNCTION__,'Check Zones', $url2 ,'GET', $status , $message , '');
    ...
    ///////modify zone///////////////
    public function modifyzone($zoneid, $type, $id, $name, $domainId = NULL)
    {
    ...
    public function ACLdelete($zoneid, $id)
    {
        ...
        $curl = curl_init($this->baseurl . '/rkszones/' . $zoneid . '/wlans/' . $id . '/l2ACL');
        ...
        $this->log(__FUNCTION__, 'Delete ACL', $curl, 'DELETE', $status, $message, '', $this->realm);
    ...
    function modifyTunnelProfile($zoneid, $tunnelProfileID, $tunnelProfileName)
    {
        ...
        //print_r($data);
        $url2=$this->baseurl.'/rkszones/'.$zoneid.'/tunnelProfile';
...
*/
    ...
    public function modifyAp($mac, $location = NULL, $model = NULL, $latitude = NULL, $longitude = NULL)
    {
        ...
        $this->log(__FUNCTION__, 'Modify AP', $url2, 'PATCH', $status, $message, $url2, $this->realm);
    ...
    public function createDNSServerProfile($data)
    {
        ...
        $this->log(__FUNCTION__, 'Create DNS Server Profile', $url2, 'POST', $status, $message, $data, $this->realm);
    ...
    public function getSwitchesbyZone(array $filters)
    {
        ...
        $url2 = $this->baseurl . '/switch?serviceTicket=' . $this->serviceTicket;
        ...
        $this->log(__FUNCTION__, 'Get Switches', $url2, 'POST', $status, $message, $data, $this->realm);
    ...
    public function moveToSwitchGroup(array $switch, $switch_group)
    {
        ...
        $this->log(__FUNCTION__, 'Move To Switch Group', $url2, 'PUT', $status, $message, '', $this->realm);
    ...
    public function addDPSKClient($zoneId, $wlanId, $mac, $passPhrase)
    {
        ...
        $list = array(
            ...
            array($user_name, null, $wlan, $passPhrase, "UserRole-15x5", $w_vlan, $Created_Date, "Unlimited", "Yes")
        );
    ...
    public function getDPSKClient($zoneId, $wlanId, $user_name, $passPhrase)
    {
...
//$this->log(__FUNCTION__,'Get 802.1X', $url2,'Get', $status, $message, $url2,$this->realm);
    ...
    public function deleteDPSKClient($zoneId, $wlanId, $mac, $passPhrase)
    {
        ...
        $this->log(__FUNCTION__, 'Delete DPSK', $url2, 'POST', $status, $message, $jsonDataEncoded2, $realm);
