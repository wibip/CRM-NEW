...
class nusoap_fault extends nusoap_base {
	...
	*/
	public function __construct($faultcode=null,$faultactor='',$faultstring='',$faultdetail=''){
		parent::__construct();
...
class soap_transport_http extends nusoap_base {
	...
	* @access public
	*/
	public function __construct($url=null, $curl_options = NULL, $use_curl = false){
		parent::__construct();
...
class nusoap_parser extends nusoap_base {
	...
	* @access   public
	*/
	public function __construct($xml=null,$encoding='UTF-8',$method='',$decode_utf8=true){
		parent::__construct();
		$this->xml = $xml;
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	public function __construct($endpoint=null,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::__construct();
			...
			if ($use == 'literal') {
				...
				if ($namespace) {
					...
					$payload = "<prov:$operation accountType=\"$namespace\">" .
					            "<prov:account reference=\"$this->para_name\">".
					            "<prov:parameters>".
								$payload .
								"</prov:parameters>".
								"</prov:account>".
