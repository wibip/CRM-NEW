...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$para_name,$para_value,$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
			...
			if ($use == 'literal') {
				...
				if ($namespace) {
					...
					$payload = "<prov:$operation accountType=\"$namespace\">" .
					            "<prov:account reference=\"Update 1\">".
								"<prov:id>".
