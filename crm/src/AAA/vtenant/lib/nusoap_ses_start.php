...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$key_val,$key_datails,$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		if ($style == 'rpc') {
			if ($use == 'literal') {
				...
				if ($namespace) {
					// http://www.ws-i.org/Profiles/BasicProfile-1.1-2004-08-24.html R2735 says rpc/literal accessor elements should not be in a namespace
					$payload = "<prov:$operation>" .
					            "<prov:query reference=\"SOAP-login-test\">".
					            "<prov:id>".
					            "<prov:parameter name=\"$key_val\" value=\"$key_datails\"/>".
					            "</prov:id>".
					            "<prov:parameters>".
								$payload .
								"</prov:parameters>".
