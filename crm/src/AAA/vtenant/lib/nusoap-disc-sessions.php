...
class nusoap_base {
	...
	*/
	var $namespaces = array(
		...
		'prov' => 'http://schemas.aptilo.com/session/provisioning'
		);
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$params2=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
			...
			if ($use == 'literal') {
				...
				if ($namespace) {
					...
					$payload = "<prov:$operation>" .
								//"<prov:queries>".
					            "<prov:query reference=\"Disconnect Session\">".
					            "<prov:id>".
								$payload .
								"</prov:id>".
							"<prov:parameters>".
