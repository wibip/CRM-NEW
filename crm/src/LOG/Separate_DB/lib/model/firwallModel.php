...
class firwallModel extends baseModel implements ModelInterface{
    ...
    {
        $q = "INSERT INTO exp_firwall_profile_logs(`function`,function_name,description,api_method,api_status,realm,
