...
class aaaModel extends baseModel implements ModelInterface{
    ...
    {
        $q = "INSERT INTO exp_aaa_logs(group_id,mac_id,`function`, function_name,description,username,api_method, api_status, api_description, api_data, create_date, create_user,unixtimestamp) VALUES (";
