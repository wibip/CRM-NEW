...
if(isset($_POST['device_pass_submit'])){ 
  ...
  $response=$nf->getSessionsRuckus($cust_uname,'AAA-User-Name');
  $datasession=json_decode($response,true)['Description'];
  foreach ($datasession as $value) {
      $ses_token=$value['Session-Token'];
      $device_response=$nf->disconnectDeviceSessions($ses_token,$cust_uname);
  }
              ...
              <table class="table table-striped table-bordered">
                ...
                //  print_r($table_array);
                   ...
                   ?>         
                      ...
                      <?php } ?>
                     <strong><font style="margin-top: -18px; float: right;" size="-2"><?php echo $count_device; ?> of maximum <?php echo $max_count; ?> devices registered</font></strong> 
                     </div>
         </div>
 ...
 <?php
         ...
         */
         ...
         $(\'#CM_'.$customer_id.'\').easyconfirm({locale: {
             title: \'Edit Resident ['.mysql_real_escape_string($first_name).' '.mysql_real_escape_string($last_name).']\',
