									...
									<div class="tab-pane <?php if($tab == '1'){ echo 'active'; } ?>" id="live_camp">
										...
										<div id="response_d3">
												<?php
											  	...
											  	<h1 class="head">Update My Profile</h1>
     ...
     return false;
									...
									<div class="tab-pane <?php if($tab == '2'){ echo 'active'; } ?> " id="live_camp2">
										...
										<div id="response_d3">
											  	...
											  	<h1 class="head">Change My Password</h1>
	...
	if(opw==''||npw==''||cnpw==''){
		document.getElementById("pwsubmit").disabled = true;
			...
			document.getElementById("pwsubmit").disabled = false;
													...
													<input type="submit"  id="submit_hi" name="submit_hi"  class="btn btn-primary" value="Change"  style="display: none;">
												
											</fieldset>

										</form>

										<form class="form-horizontal bv-form"  id="d-edit-profile">
