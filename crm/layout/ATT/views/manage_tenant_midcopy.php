...
function syncCustomerNew($Response2,$property_id){
...
VALUES('$search_id','$user_name',NOW())");
  ...
  if(mysql_num_rows($find_customers)>0){
    ...
    while($row=mysql_fetch_array($find_customers)){
      ...
      $record_found=0;
      $msg="<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>X</button><strong>".$message_functions->showMessage('tenant_acc_sync_no_recod','2004')."</strong></div>";
...
else if(isset($_POST['mac_search_btn'])){ //1   
...
if(strlen($search_word)>0){
  ...
  if ($string_type=='mac') {
    ...
    $newjsonvalue=syncCustomerNew($Response,$property_id);
    # code...
  }
  elseif ($string_type=='email') {
    
    $Response = $nf->getSessions($search_word,'Email');
    $newjsonvalue=syncCustomerNew($Response,$property_id);
    # code...
  }
  elseif ($string_type=='name') {
    $mac = getMac($search_word);
    $Response = $nf->getSessions($search_word,'PAS-First-Name');
    $newjsonvalue=syncCustomerNew($Response,$property_id);

    $Response = $nf->getSessions($search_word,'PAS-Last-Name');
    $newjsonvalue=syncCustomerNew($Response,$property_id);
    # code...
  }
  else{
                             ...
                             <div id="response_d1"></div>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">First Name<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="first_name" placeholder="Kim" name="first_name" type="text" style="width:170px;" value="<?php echo $mg_first_name; ?>">
         ...
         //                                     return true;
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Last Name<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="last_name" placeholder="John" name="last_name" type="text" style="width:170px;" value="<?php echo $mg_last_name; ?>">
                                         <script type="text/javascript">
         ...
         //                                     return true;
                                 ...
                                 <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Email<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="email" name="email" type="email" style="width:170px;"  value="<?php echo $mg_email; ?>" readonly >
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">New Password<sup><font color="#FF0000" ></font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="password" placeholder="******" name="password" type="password" style="width:170px;"  value="" >
                                         <!-- <script type="text/javascript">
                            ...
                            <div class="control-group">
                               ...
                               <label class="" for="radiobtns">Re-enter Password<sup><font color="#FF0000" ></font></sup></label>
                                       ...
                                       <input class="span4 form-control" id="confirm_password" placeholder="******" name="confirm_password" type="password" onfocus="validatePass(document.getElementById('password'), this);" oninput="validatePass(document.getElementById('password'), this);"  value="" style="width:170px;">
                                         <!-- <script type="text/javascript">
                                 ...
                                 <div class="control-group">
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Street Address<sup><font color="#FF0000" >*</font></sup></label>
                                       ...
                                       <textarea name="street_address" id="street_address" cols="250" class="span4 form-control" style="width:170px;"><?php echo $mg_address; ?></textarea>
                                         <script type="text/javascript">
                              ...
                              <div class="control-group">
                                     ...
                                     <select class="span4 form-control" name="country" id="country" style="width:180px;">
...
// populateCountries("country");
        ...
        <div class="control-group">
            ...
            <label class="" for="radiobtns">State/Province<sup><font color="#FF0000" >*</font></sup></label>
                ...
                <select class="span4 form-control" id="state" name="state" style="width:180px;">
                <?php
          ...
          */
                                 ...
                                 <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Postal Code<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="postal_code" placeholder="xxxxx" name="postal_code" type="text" value="<?php echo $mg_postal_code; ?>"  maxlength="5" oninvalid="setCustomValidity('Invalid Postal Code')" oninput="setCustomValidity('')" onfocus="setCustomValidity('')"  style="width:170px;">
         ...
         <script type="text/javascript">
                                    ...
                                    <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">City<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="city" placeholder="" name="city" type="text" maxlength="64"  value="<?php echo $mg_city; ?>" style="width:170px;">
                                         <script type="text/javascript">
         ...
         $('#city').bind("cut copy paste",function(e) {
                                ...
                                <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Mobile Number</label>
                                         ...
                                         <input class="span4 form-control" id="phone" placeholder="xxx-xxx-xxxx" name="phone" type="text" maxlength="12" value="<?php echo $mg_phone; ?>" oninvalid="setCustomValidity('Invalid mobile number format')" oninput="setCustomValidity('')" onfocus="setCustomValidity('')" style="width:170px;">
                              ...
                              $('#phone').focus(function(){
                               ...
                               <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Secret Question<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <select name="question" id="question" class="span4 form-control" style="width:180px;">
                               ...
                               <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Answer<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="answer" placeholder="Answer" name="answer" type="text" style="width:170px;" value="<?php echo $mg_answer; ?>">
                             ...
                             <div class="control-group">
                                     ...
                                     <div class="controls form-group">
                                       <div class="columns" style="margin-bottom: 5px">
                                          <h3><strong>Tenant Device Details</strong></h3>
                                       </div>
                                     </div>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">MAC Address<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control"  id="mac_address" name="mac_address" maxlength="17" type="text" style="width:150px;"  oninvalid="setCustomValidity('Invalid MAC format')" oninput="setCustomValidity('')" onfocus="setCustomValidity('')"  title="Format - xx:xx:xx:xx:xx:xx" pattern="^[0-9A-Fa-f]{2}:[0-9A-Fa-f]{2}:[0-9A-Fa-f]{2}:[0-9A-Fa-f]{2}:[0-9A-Fa-f]{2}:[0-9A-Fa-f]{2}$" >
               ...
               //i++;
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Nickname<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="nick_name"  name="nick_name" type="text" style="width:150px;">
           ...
           <!-- /row -->
             ...
             <div class="">
               <div class="widget">
                 ...
                 <div class="columns" style="margin-bottom: 5px">
               <h3><strong>Tenant Bandwidth Details</strong></h3>
               </div>
                           ...
                           <fieldset>
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="controls">
                                         ...
                                         <a  id="sync_all" name="sync_all" class="btn btn-default" style="text-decoration:none"><i class="btn-icon-only icon-refresh"></i> Sync Records</a>&nbsp;<img data-toggle="tooltip" title="Sync replaces the local DB records with records held in the cloud. Use sync in case the local DB is corrupt or if you know master accounts has been added or deleted outside of this platform." src="layout/ATT/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                   ...
                                   <div  class="">
                                         <button class="btn" style="margin-bottom: 10px" type="submit" name="search_btn" id="search_btn">Search</button>
                                         <br />
                                       </div>
                                       </div>
                                   <!-- /control-group -->   
      ...
      <form id="edit-profile" action="?tab=session" method="post" class="form-horizontal" >
        ...
        <fieldset>
          ...
          <div class="control-group" style="display: none;">
            ...
            <div class="controls">
              ...
              <div class="">
                <select name="property_id" id="property_id_session" required>
                  <option value="ALL">ALL Properties</option>
        ...
        if (2 == 2) {
          ...
          <tr>
            ...
            <!--    <th>Realm</th>  -->
            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1">Master Account</th>
            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">Session Start
              Time
            </th>
            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">IP Address
            </th>
            ...
            if (strlen($newjsonvalue)>0) {
                                           ...
                                           $session_row_count=0;
                                            foreach ($newjsonvalue as $value2){
                                                ...
                                                $User_Name=($value2['AAA_User_Name']);
                                                $state=($value2['State']);
                                                $start_time=($value2['Session-Start-Time']);
                                                $Session_IP=($value2['Session-IP']);
                                                $session_id=$value1['Ses_token'];
                        ...
                        echo "<td>".$mac."</td>";
                        echo "<td>".$Session_State."</td>";
                        echo "<td>".$User_Name."</td>";
                        echo "<td>".$start_time."</td>";
                        echo "<td>".$Session_IP."</td>";
                                ...
                                echo '<a href="javascript:void();"  id="DL_' . $session_id . '"  class="btn  btn-small td_btn_last">
                                      <i class="btn-icon-only icon-trash"></i>Delete</a>
                                      </td><script type="text/javascript">
                                      $(document).ready(function() {
                                      $(\'#DL_' . $session_id . '\').easyconfirm({locale: {
                                          title: \'Delete Session \',
                                          text: \'Are you sure you want to delete session?&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\',
                                          button: [\'Cancel\',\' Confirm\'],
                                          closeText: \'close\'
                                           }});
                                        $(\'#DL_' . $session_id . '\').click(function() {
                                          window.location = "?tab=session&dl_id=' . $session_id . '&search_id=' . $search_id . '&s3=' . $_SESSION['FORM_SECRET_SES'] . '&realm=' . $sh_realm . '&query_type=' . $session_id . '&uni_mac='.$mac.'"
                                        });
                                        });
                                      </script>';
              //
