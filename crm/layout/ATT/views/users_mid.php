										...
										<form autocomplete="off" id="edit_profile" action="users.php" method="post" class="form-horizontal" >
											...
											<fieldset>
												<div class="control-group">
													...
													<label class="" for="access_role_1">Access Role</label>
												...
												<div class="control-group">
													...
													<div class="controls col-lg-5 form-group">
													<label class="" for="full_name_1">Full Name</label>
												...
												<div class="control-group">
													...
													<label class="" for="email_1">Email</label>
                                            ...
                                            $("#mobile_2").keydown(function (e) {
                                               ...
                                               /* if ($.inArray(e.keyCode, [8, 9, 27, 13, 110, 190]) !== -1 ||
												...
												<div class="form-actions">
													<button type="submit"  name="submit_1" id="submit_1" class="btn btn-primary" style="margin-bottom: 22px;">Save & Send Email Invitation</button>&nbsp; <strong><font color="#FF0000"></font><small></small></strong>
												</div>
												<!-- /form-actions -->
											</fieldset>
										</form>
					...
					<div id="response_d3">
									...
									<div class="widget tablesaw-widget widget-table action-table">
										...
										<?php
											...
											if($user_type == 'ADMIN'){
												$key_query = "SELECT id,user_name,full_name, access_role, user_type, user_distributor, email,is_enable,create_user
												...
												$key_query ="SELECT a.id,a.user_name,a.full_name, a.access_role, a.user_type, a.user_distributor, a.email,a.is_enable ,a.create_user
													FROM admin_users a, `admin_access_roles_modules` b
											...
											foreach($query_results['data'] AS $row){
												...
												if($user_type1=='TECH'){
													...
													$access_role_desc='Master Tech Admin';

												}
												else if($user_type1=='SUPPORT'){


													$access_role_desc='Master Support Admin';

												}
												else if($access_role_desc=='Admin'){


													$access_role_desc='Master Admin Peer';
...
?>
											...
											<form autocomplete="off" id="assign_roles_submit" name="assign_roles_submit" method="post" class="form-horizontal" action="?t=3">
												...
												<div id="response_d3">
															...
															<label class="" for="my_select">Modules</label >
																...
																if($user_type=='SUPPORT'){
																	if($system_package=='N/A'){
																		$q1 = "SELECT DISTINCT `name_group` ,`module_name` FROM `admin_access_modules` WHERE `user_type` ='$user_type' AND `module_name`<>'profile' AND `module_name` <>'users' AND is_enable=1 ORDER BY `name_group` ASC";
																		...
																		*/
																		$q11 = "SELECT DISTINCT a.`name_group` ,a.`module_name` FROM `admin_access_modules` a WHERE a.`user_type` ='$user_type' AND a.`module_name`<>'profile' AND a.`module_name` <>'users' AND a.is_enable=1 ORDER BY a.`name_group` ASC";
													...
													<div class="form-actions">
														<button type="submit" name="assign_roles_submita" id="assign_roles_submita" class="btn btn-primary" style="margin-bottom: 22px;">Save</button>
...
<form autocomplete="off" id="assign_roles_form" name="assign_roles_form" method="post" class="form-horizontal" action="?t=3">
												...
												<div id="response_d3">
													...
													<div class="control-group">
														<div class="controls col-lg-5 form-group">
														<label class="" for="access_role_field">Roles</label>
													...
													<div class="control-group">
														...
														<div class="controls col-lg-5 form-group">
															<label class="" for="my_select_roles">Modules</label >
...
<?php } ?>
										...
										<div class="widget-content table_response">
											...
											$(\'#AP_'.$id_access_role.'\').easyconfirm({locale: {
												...
												$(\'#AP_'.$id_access_role.'\').click(function() {
													window.location = "?token2='.$secret.'&t=3&remove_access_role='.$access_role.'&remove_id='.$id_access_role.'"
												});
												});
											</script>';
											}else{
									...
									?>
											...
											<fieldset>
												...
												<div class="control-group">
													...
													<label class="" for="access_role_2">Access Role</label>
												...
												<div class="control-group">
													...
													<div class="controls form-group col-lg-5">
													<label class="" for="full_name_2"_1>Full Name</label>
												...
												<div class="control-group">
													...
													<div class="controls form-group col-lg-5">
													<label class="" for="email_2">Email</label>
															<input class="form-control span4" id="email_2" name="email_2" placeholder="name@mycompany.com" type="text" value="<?php echo $email ?>" >
                                                    </div>
													<!-- /controls -->
												</div>
												<!-- /control-group -->
												...
												<div class="control-group">
													...
													<div class="controls form-group col-lg-5">
													<label class="" for="language_2">Language</label>
												...
												<div class="control-group">
													...
													<label class="" for="mobile_2">Phone Number</label>
															<input class="form-control span4" id="mobile_2" name="mobile_2" placeholder="xxx-xxx-xxxx" type="text" maxlength="12" value="<?php echo $mobile ?>">
													</div>
													<!-- /controls -->
												</div>
												<!-- /control-group -->
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5">
                                                	...
                                                	<label class="" for="full_name_2"_1>Password</label>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5">
                                                <label class="" for="email_2">Confirm Password</label>
                            ...
                            <div <?php if(isset($tab6)){?>class="tab-pane active" <?php }else {?> class="tab-pane" <?php }?> id="peer_admin">
                                ...
                                <h1 class="head">Create Master Admin</h1>
                                    ...
                                    <form autocomplete="off" id="peer_profile" action="users.php?t=6" method="post" class="form-horizontal" >
										...
										<fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5 form-group">
                                                <label class="" for="access_role_peer">Access Role</label>
											...
											<?php }elseif ($user_type=='SUPPORT'){?>
											  ...
											  <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5 form-group">
                                                <label class="control-label" for="access_role_peer">Access Role</label>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5 form-group">
                                                <label class="" for="full_name_peer">Full Name</label>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls col-lg-5 form-group">
                                                <label class="" for="email_peer">Email</label>
