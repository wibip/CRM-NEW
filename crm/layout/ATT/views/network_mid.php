...
add a passcode to your splash page.<img data-toggle="tooltip" title="If you would like to restrict access to your Guest Wi-Fi Network, you can select the passcode splash page theme. You have two options for setting passcodes:
...
2. Automated Passcode: Select this option to allow the system to generate and deliver a unique passcode to emails of your choice on a predefined schedule." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
                                             </h1>
<br>

                                         <!--    <h2>Setting Passcodes</h2>
                                            <p>
                                               If you would like to restrict access to your Guest Wi-Fi Network, you can set a passcode. You have two options for setting passcodes:<br/><br/>
                                            ...
                                            <form id="tab5_form1" onkeyup="footer_submitfn();" onchange="footer_submitfn();" name="tab5_form1" method="post" action="?t=9" class="form-horizontal" autocomplete="off">
                                                ...
                                                you may enter a combination of numbers, letters, and the characters: $ ! # @. Your Manual Passcode remains valid until you replace it with a new passcode." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
...
<!-- ////////// -->                                                  
                                                    ...
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <label class="" for="prefix">Prefix<img data-toggle="tooltip" title='[Optional] You may choose to create an optional passcode "prefix" that will be added to the beginning of your generated passcode. This prefix will be added to the beginning of your automatically generated passcodes and helps make the passcode more readable. The prefix can be a maximum of 16 characters consisting of numbers, letters, and the characters: $ ! # @.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
                                                ...
                                                for (i = les; i <= le; i++) {
                                                    ...
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <label class="" for="prefix">Password length<img data-toggle="tooltip" title="Select how long you’d like your auto-generated passcode to be. The total length of your passcode (prefix + auto-generated) may not exceed 32 characters." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
                                                    ...
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        <div class="controls col-lg-5 form-group">
                                                             ...
                                                             <label class="" for="prefix">Passcode delivery time<img data-toggle="tooltip" title="Select the time of day you would like your passcode to be renewed. An email with the new passcode will be sent out at the time selected to the emails defined below." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
                                                    ...
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        <div class="controls col-lg-5 form-group">
                                                            ...
                                                            <label class="" for="prefix">Change Frequency  <img data-toggle="tooltip" title="Select how often you would like for your passcode to be renewed. Choose from the preset options below or choose a customized frequency in days." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"> </label>
                                                 ...
                                                 <!--   <p><strong> </strong>or set a customized frequency</p>
                                                    ...
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        ...
                                                        <div class="controls col-lg-5 form-group">
                                                             ...
                                                             <label class="" for="gt_mvnx">Passcode Expiration Buffer <img data-toggle="tooltip" title="[Optional] Your Automated Passcode will expire at the same time of day that the generation was enabled. You may choose to add an additional Passcode Expiration Buffer that will increase the amount of time that the expiring passcode remains valid past the time the generation was enabled. For example, if your passcode is generated at 10:30 AM with a generation frequency of weekly, that passcode will expire at 10:30 AM on the 7th day. If you added a Passcode Expiration Buffer of 8 hours, the old passcode would still be valid for 8 hours after the new passcode is generated." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"> </label> 
                                                ...
                                                <fieldset>
                                                    <div class="control-group" id="feild_gp_taddg_divt1">
                                                        ...
                                                        <div class="controls col-lg-5 form-group" id="update_mail_parent">
                                                            ...
                                                            <label class="" for="gt_mvnx">New Email <img data-toggle="tooltip" title='If you would like to update the email address used for Automated Passcode delivery, enter the new email address below. If you would like to add another email address to receive your Automated Passcodes, select "Add Secondary Email" below.' src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>  
                                                    ...
                                                    <div style="overflow-x:auto;" >
                                                        <table id="tblAutomaticPasscodes" class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist">Expiry Date</th>
                                                      ...
                                                      <fieldset>
                                                          <div class="control-group">
                                                              ...
                                                              <div class="controls col-lg-5 form-group">
                                                                ...
                                                                <label class="" for="ssid_name">Current SSID Name : <img data-toggle="tooltip" title="Select the SSID name you wish to change from the drop-down below. Then, enter the new name of your Guest Wi-Fi Network." src="layout/ATT/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
