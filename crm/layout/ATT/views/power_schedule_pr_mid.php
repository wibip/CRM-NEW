<style type="text/css">
    ...
    .ui-slider .ui-slider-range {
        ...
        box-shadow: 0 1px 0 #1693ed inset;
        -moz-border-radius: 6px;
        -webkit-border-radius: 6px;
                ...
                <form id="tab5_form<?php echo$sID; ?>" name="tab5_form1" method="post" action="?t=2" class="form-horizontal">
                    ...
                    <fieldset class="fieset">
                        ...
                        <div>
                            ...
                            <div class="power_box2" style="    height: 518px;width: 33%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;padding: 20px">
                                <h2>SSID :  <br>
