...
<?php if(in_array("CONTENT_FILTER_MAIN",$features_array) || $package_features=="all"){?>
                                        <div <?php if(isset($tab2)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?>  id="tab_2">
                                            ...
                                            <h2>Content Filtering <img data-toggle="tooltip" title="<?php echo $tooltip_arr['Content_Filter']; ?>" src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ></h2>
                                        <?php } else{?>
