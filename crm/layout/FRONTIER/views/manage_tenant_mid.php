            ...
            <div class="widget ">
              ...
              <div class="widget-content" id="now">
                ...
                <div class="tabbable">
                 ...
                 $manage_tenant_inner = 'layout/'.$camp_layout.'/views/manage_tenant_inner.php';

                  if (($new_design=='yes') && file_exists($manage_tenant_inner)) {
                        include_once $manage_tenant_inner;
                  }
...
//alert('aa');
        ...
        $.ajax({
         ...
         $max_count = $db->getValueAsf("SELECT  `device_limit` as f FROM `mdu_organizations` WHERE `property_id`='$mg_property_id'");
          ...
          <div class="" align="center" style="vertical-align:top;">
         <h2 style="text-align: center; font-weight: bold !important;">Manage Tenants</h2>
         </div>
         </div>
         <br>
         <br>
                             ...
                             <div id="response_d1"></div>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">VLAN ID</label>
                                         ...
                                         <input class="span4 form-control" id="vlan_id_details" name="vlan_id_details" type="text" style="width:170px;"  value="<?php echo $vlan_id_details; ?>" readonly>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">First Name<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="first_name" placeholder="Kim" name="first_name" type="text" style="display: block; width:170px;" value="<?php echo $mg_first_name; ?>">
                                         <script type="text/javascript">
         ...
         //                                     return true;
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Last Name<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="last_name" placeholder="John" name="last_name" type="text" style="display: block;width:170px;" value="<?php echo $mg_last_name; ?>">
                                         <script type="text/javascript">
         ...
         //                                     return true;
                                 ...
                                 <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Email<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="email" name="email" type="email" style="display: block;width:170px;"  value="<?php echo $mg_email; ?>" readonly >
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">New Password<sup><font color="#FF0000" ></font></sup></label>
                                         ...
                                         <input class="span4 form-control pass_msg" id="password" placeholder="******" name="password" type="password" style="display: inline;width:170px;" onfocus="validatePass(document.getElementById('confirm_password'), this);" oninput="validatePass(document.getElementById('confirm_password'), this);"  value="" >
  ...
  input.attr("type", "password");
                            ...
                            <div class="control-group">
                               ...
                               <label class="" for="radiobtns">Re-enter Password<sup><font color="#FF0000" ></font></sup></label>
                                       ...
                                       <input class="span4 form-control pass_msg" id="confirm_password" placeholder="******" name="confirm_password" type="password" onfocus="validatePass(document.getElementById('password'), this);" oninput="validatePass(document.getElementById('password'), this);"  value="" style="display: inline; width:170px;">
  ...
  input.attr("type", "password");
                                 ...
                                 <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Property<sup><font color="#FF0000" >*</font></sup></label>
                                       ...
                                       <input class="span4 form-control" id="property_id" name="property_id" type="text" style="width:170px;"  value="<?php echo $mg_property_id; ?>" readonly >
                                   ...
                                   <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Street Address<sup><font color="#FF0000" >*</font></sup></label>
                                       ...
                                       <textarea name="street_address" id="street_address" cols="250" class="span4 form-control" style="display: block;width:170px;"><?php echo $mg_address; ?></textarea>
                                         <script type="text/javascript">
                              ...
                              <div class="control-group">
                                     ...
                                     <select class="span4 form-control" name="country" id="country" style="display: block; width:180px;">
...
// populateCountries("country");
        ...
        <div class="control-group">
            ...
            <label class="" for="radiobtns">State/Province<sup><font color="#FF0000" >*</font></sup></label>
                ...
                <select class="span4 form-control" id="state" name="state" style="display: block; width:180px;">
                <?php
          ...
          */
                                 ...
                                 <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Postal Code<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="postal_code" placeholder="xxxxx" name="postal_code" type="text" value="<?php echo $mg_postal_code; ?>"  maxlength="5" oninvalid="setCustomValidity('Invalid Postal Code')" oninput="setCustomValidity('')" onfocus="setCustomValidity('')"  style="display: block; width:170px;">
         ...
         <script type="text/javascript">
                                    ...
                                    <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">City<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="city" placeholder="" name="city" type="text" maxlength="64"  value="<?php echo $mg_city; ?>" style="display: block; width:170px;">
                                         <script type="text/javascript">
         ...
         $('#city').bind("cut copy paste",function(e) {
                                ...
                                <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Mobile Number</label>
                                         ...
                                         <input class="span4 form-control mobile1_vali" id="phone" placeholder="xxx-xxx-xxxx" name="phone" type="text" maxlength="12" value="<?php echo $mg_phone; ?>" oninvalid="setCustomValidity('Invalid mobile number format')" oninput="setCustomValidity('')" onfocus="setCustomValidity('')" style="display: block; width:170px;">
                              ...
                              $('#phone').focus(function(){
                               ...
                               <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Secret Question<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <select name="question" id="question" class="span4 form-control" style="display: block; width:180px;">
                               ...
                               <div class="control-group">
                                     ...
                                     <label class="" for="radiobtns">Answer<sup><font color="#FF0000" >*</font></sup></label>
                                         ...
                                         <input class="span4 form-control" id="answer" placeholder="Answer" name="answer" type="text" style="display: block; width:170px;" value="<?php echo $mg_answer; ?>">
...
*/                         echo " <div class='txt_qos_new'>Default Product [".$service_profile_productn."]</div>";
         ...
         <?php            
                    $get_dist_profile = "SELECT d.`id`,d.`qos_code`,q.`qos_name`,q.`network_type`,d.`qos_id` as qos FROM exp_qos_distributor d LEFT JOIN exp_qos q ON d.`qos_id`=q.`qos_id`
                      ...
                      // if($row_count != 0){
                      //   echo '<div style="margin-bottom: 5px;"><b>Override QOS Profile</b><img data-toggle="tooltip" title="Use the Search Tenant field to search for existing tenants that have contacted you for assistance with their account. This could include updating personal information, adding or removing devices, upgrading account to a premium service, resetting their account password and also permanently deleting an account." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></div>'; 
                      // }
             ...
             <div class="widget">
               ...
               <form id="device_form" name="device_form" action="manage_tenant.php?tab=account" method="post"  class="form-horizontal1" style="margin: 0 0 -60px;" enctype="multipart/form-data">
                         ...
                         ?>
                           ...
                           <div class="se_field">
                             ...
                             <div class="control-group">
                                     ...
                                     <div class="controls form-group">
                                       <div class="columns" style="margin-bottom: 5px">
                                          <h3><strong style="">Manually Add Tenant Devices</strong></h3>
                                       </div>
                                     </div>
           ...
           if(len%3 == 0 && len != 0 && len < 18){
             $('#mac_address').val(function() {
               ...
               //i++;
                                   ...
                                   <div style="solid #ddd;width:85%; margin-left: 10px; ">
                                   </div>
                                   <div class="form-actions button-action" style="border-top: 0px !important; margin-left: 10px;" >
...
<div class="control-group">
         ...
         <?php } else{ ?>      
          ...
          <div class="" align="center" style="vertical-align:top;">
         <h2 style="text-align: left;">Manage Tenants</h2>
         </div>
              <br>            
                           ...
                           <fieldset>
                                    ...
                                    <!-- <div class="control-group">
                                     ...
                                     <div class="controls">
                                         ...
                                         <a  id="sync_all" name="sync_all" class="btn btn-default" style="text-decoration:none"><i class="btn-icon-only icon-refresh"></i> Sync Records</a>&nbsp;<img data-toggle="tooltip" title="If a tenant record appears to be missing from the search results, then click [Sync Records] to download missing records that you may have added manually." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                   ...
                                   <label class="control-label" for="radiobtns">Limit Search to <img data-toggle="tooltip" title="You can search a tenant across all your properties or limit the search to a specific property." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                   ...
                                   <label class="control-label" for="radiobtns">Search Tenants <img data-toggle="tooltip" title="You can search for a tenant using full or partial First Name, Last Name, or Email or use the Search MAC field." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <!-- /controls -->
                                     <div class="control-group middle-large">
                                     <label class="control-label" style="margin-top: 10px" for="radiobtns">Search MAC <img data-toggle="tooltip" title="You can search for a tenant using full or partial MAC address of a device or use the Search Tenant field." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <div class="">
                                         <button class="btn" style="margin-bottom: 10px" type="submit" name="search_btn" id="search_btn">Search</button> <img data-toggle="tooltip" title="Click [SEARCH] to show a full list of tenants" src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                         <br />
 ...
 <?php
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" for="radiobtns">Search MAC <img data-toggle="tooltip" title="" src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
         ...
         ?>                     
                                 ...
                                 <!-- /widget-header -->
                                 <div style="margin-bottom: 20px;    margin-top: 10px;" id="se_download">
                                 <div class="control-group">
...
<div class="tab-pane <?php if($active_tab=="session"){echo"active";}?>" id="session">
      ...
      ?>
      <div class="" align="center" style="vertical-align:top;">
         <h2 style="text-align: left;"> Session Search <img data-toggle="tooltip" title="You can search for a tenant's online sessions using Email, First Name, Last Name or device MAC Address. To get a list of all sessions, click the Search Button." src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h2>
         </div>
      <br>
      <form id="edit-profile" action="?tab=session" method="post" class="form-horizontal middle" >
        ...
        <fieldset>
          ...
          <div class="control-group ">
          <label class="control-label" for="radiobtns">Search Tenants <img data-toggle="tooltip" title="You can search for a tenant sessions using full or partial First Name, Last Name, or Email or use the Search MAC field." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <!-- /controls -->
                                     <div class="control-group ">
                                     <label class="control-label" style="margin-top: 10px" for="radiobtns">Search MAC <img data-toggle="tooltip" title="You can search for a tenant sessions using MAC address of a device or use the Search Tenant field." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
       ...
       <div class="">
         <div  class="">
          ...
          <div class="control-group">
            ...
            <!-- <div class="controls">
              <label class="" for="radiobtns">Search Tenant <img data-toggle="tooltip" title="You can search using the First Name, Last Name, Email Address or a device MAC Address." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label> -->
