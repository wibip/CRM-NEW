...
<div class="main">
		<div class="main-inner">
					...
					<div class="span12">
						<div class="widget ">
							<div class="widget-header">
								...
								<h3>Communicate With Resident Account</h3>
							</div>
							<!-- /widget-header -->
         ...
         <h2>Individual Message Editor<img data-toggle="tooltip" title="Please verify that the name in the greeting line is correct and add the description before posting." src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h2>
         </div>
...
<div class="" style="vertical-align:top;">
         <h2>Individual Message<img data-toggle="tooltip" title="You can use this feature to communicate via email directly with an individual tenant. The message will be sent to the tenant's email on record." src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h2>
         </div>
					  ...
					  $_SESSION['FORM_SECRET4'] = $secret4;
								  ...
								  ?>
									  ...
									  <fieldset>
													  ...
													  <label class="control-label" for="radiobtns">Search Tenants <img data-toggle="tooltip" title=" Note: You can search using First Name, Last Name or Email Address." src="layout/FRONTIER/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"> </label>
...
<div class="" style="vertical-align:top;">
         <h2>Group Messaging Editor<img data-toggle="tooltip" title="You can use this feature to communicate via email directly with all tenants at a property. The message goes to the tenant's email on record." src="layout/FRONTIER/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></h2>
         </div>
<br>
