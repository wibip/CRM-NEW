...
function makeCanvas(data, a, b, c, camp_layout, propName) {
    ...
    var help_img = 'layout/' + camp_layout + '/img/help.png';
    ...
    for (key in switchObj) {
        ...
        if (switchObj[x].mac != 'noSwitch') {
            ...
            for (key1 in jObjAP) {
                ...
                var apUniq = (jObjAP[y].ap_code.replace(/:/g, "") + jObjAP[y].apName.split(' ').join(""));
                ApStr = ApStr + '<li><label data-ref="' + x + y + '" data-type="AP" data-mac="' + jObjAP[y].ap_code + '" data-uniq="' + apUniq + '"  class="tree_label apChild ' + apstatus + '" data-toggle="tooltip1" title="' + jObjAP[y].cpename + '">' + ap_name_last[ap_name_last.length-1] + '</label></li>';
                y++;
                allAp++;
                details = details + a;
            }
    ...
    $('#innerCanvasContainer').html('<h1 class="headName">Overview<img data-toggle="tooltip1" title="Click on an element to see a detailed view of its status and performance." src="'+help_img+'" style="width: 30px;margin-right: 6px;cursor: pointer;display:  inline-block;"></h1><div class="overviewDiv"><div class="treeDiv"><div class="treeDivInner"><label class="internet"><img src="layout/' + camp_layout + '/img/internet.png"><span>' + propName + '</span></label><ul class="tree treeUl">' + ul + '</ul></div></div><div class="detailsTree"><span class="arrow left"> BACK</span><div class="treeDivDetails"><h2><b>Asset Inventory</b></h2><table><tbody><tr><th style="text-align: left">TYPE</th><th style="text-align: left">QTY</th><th style="text-align: left">STATUS</th></tr>'+txtStr+'</tbody></table></div>' + details + '</div></div>');
