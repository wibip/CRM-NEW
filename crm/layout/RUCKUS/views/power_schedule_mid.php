<style type="text/css">
    ...
    .ui-slider .ui-slider-range {
        ...
        font-size: .7em;
        display: block;
        border: 1px solid #2760F0 !important;
        box-shadow: 0 1px 0 #2760F0 inset;
        -moz-border-radius: 6px;
        -webkit-border-radius: 6px;
        -khtml-border-radius: 6px;
        border-radius: 6px;
        background: #2760F0 !important;
    ...
    .ui-slider .ui-slider-handle:after {
        ...
        margin-left: -4px;
        background: #2760F0 !important;
        -webkit-box-shadow: 0 1px 1px 1px #2760F0 inset, 0 1px 0 0 #FFF;
        -moz-box-shadow: 0 1px 1px 1px #2760F0 inset, 0 1px 0 0 white;
        box-shadow: 0 1px 1px 1px #2760F0 inset, 0 1px 0 0 #FFF !important;
    }
                        ...
                        <?php } else{ ?>
                            <div class="power_box1" style="    padding: 30px;    border: 1px solid #dec8c8;    width: 60%;;float: left;">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_mon" <?php echo 'style="display:'; echo $mon_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-mon"><?php echo$mon_from.' '.$mon_from2 ?></span> - <span class="slider-time2-mon"><?php echo$mon_to.' '.$mon_to2 ?></span>
                                    </p>
                                    <p class="txt_mon" <?php echo 'style="display:'; echo $mon_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $mon_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                    <input type="hidden" name="mon_from1" value="<?php echo $mon_from1; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_tue" <?php echo 'style="display:'; echo $tue_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-tue"><?php echo$tue_from.' '.$tue_from2 ?></span> - <span class="slider-time2-tue"><?php echo$tue_to.' '.$tue_to2 ?></span>
                                    </p>
                                    <p class="txt_tue" <?php echo 'style="display:'; echo $tue_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $tue_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_wed" <?php echo 'style="display:'; echo $wed_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-wed"><?php echo$wed_from.' '.$wed_from2 ?></span> - <span class="slider-time2-wed"><?php echo$wed_to.' '.$wed_to2 ?></span>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_thu" <?php echo 'style="display:'; echo $thu_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-thu"><?php echo$thu_from.' '.$thu_from2 ?></span> - <span class="slider-time2-thu"><?php echo$thu_to.' '.$thu_to2 ?></span>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_fri" <?php echo 'style="display:'; echo $fri_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-fri"><?php echo$fri_from.' '.$fri_from2 ?></span> - <span class="slider-time2-fri"><?php echo$fri_to.' '.$fri_to2 ?></span>
                                    </p>
                                    <p class="txt_fri" <?php echo 'style="display:'; echo $fri_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $fri_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sat" <?php echo 'style="display:'; echo $sat_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sat"><?php echo$sat_from.' '.$sat_from2 ?></span> - <span class="slider-time2-sat"><?php echo$sat_to.' '.$sat_to2 ?></span>
                                    </p>
                                    <p class="txt_sat" <?php echo 'style="display:'; echo $sat_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sat_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sun" <?php echo 'style="display:'; echo $sun_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sun"><?php echo$sun_from.' '.$sun_from2 ?></span> - <span class="slider-time2-sun"><?php echo$sun_to.' '.$sun_to2 ?></span>
                                    </p>
                                    <p class="txt_sun" <?php echo 'style="display:'; echo $sun_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sun_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
