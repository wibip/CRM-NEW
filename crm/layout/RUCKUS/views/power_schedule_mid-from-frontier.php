                                                ...
                                                <br>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="power_box2" style="    height: 518px;width: 30%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;padding: 20px">
                                                            ...
                                                            <input type="radio" class="radio-black" name="all" onclick="All(this.value)" value="on" <?php if($WLan_schedule_type=='AlwaysOn'){ ?> checked="checked" <?php } ?>> Always On <br><br>
                                                            <input type="radio" class="radio-black" name="all" onclick="All(this.value)" value="off" <?php if($WLan_schedule_type=='AlwaysOff'){ ?> checked="checked" <?php } ?>> Always Off <br><br>
                                                            <input type="radio" class="radio-black" name="all" onclick="All(this.value)" value="custom" <?php if($WLan_schedule_type=='Customized'){ ?> checked="checked" <?php } ?>> Schedule <br><br>
