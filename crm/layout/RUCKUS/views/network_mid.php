...
2. Automated Passcode: Select this option to allow the system to generate and deliver a unique passcode to emails of your choice on a predefined schedule." src="layout/OPTIMUM/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
        ...
        <p style="margin-bottom: 40px; margin-top: -60px; cursor: pointer;">
            ...
            In case there is no active theme you must create or activate a passcode theme.
        </p>
        <br>
            ...
            <fieldset>
                ...
                <div class="control-group" id="feild_gp_taddg_divt1">
                    ...
                    <div class="controls col-lg-5 form-group">
                        ...
                        <small id="prefix_er_msg" data-bv-validator="notEmpty" data-bv-validator-for="prefix" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                ...
                <div class="control-group" id="feild_gp_taddg_divt1">
                    <div class="controls col-lg-5 form-group">
                        ...
                        <small id="passcode_length_er_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                            <p>This is a required field</p>
                        </small>
                ...
                <div class="control-group" id="feild_gp_taddg_divt1">
                    <div class="controls col-lg-5 form-group">
                        ...
                        <small id="passcode_renewal_er_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                            <p>This is a required field</p>
                        </small>
                    ...
                    <div class="controls col-lg-5 form-group">
                        ...
                        <div class="net_div">
                            ...
                            <div class="net_div_child">
                                ...
                                <small id="frequency_er_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                                    <p>This is a required field</p>
                                </small>
                                <small id="frequency_er1_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                                    <p>Values starting with 0 are not valid. Valid values are 1-999</p>
                                </small>
                ...
                <div class="control-group" id="feild_gp_taddg_divt1">
                    ...
                    <div class="controls col-lg-5 form-group">
                        ...
                        <small id="buffer_time_er_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                            <p>Values starting with 0 are not valid. Valid values are 1-24</p>
                        </small>
                        <script>
                ...
                <div class="control-group" id="feild_gp_taddg_divt1">
                    ...
                    <div class="controls col-lg-5 form-group">
                        ...
                        <small id="validate_mail_er1_msg" data-bv-validator="notEmpty" data-bv-validator-for="passcode_number" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;">
                            <p>This is a required field</p>
                        </small>
            ...
            <fieldset>
                ...
                ?>
                    <div class="control-group">
                        ...
                        <div class="controls col-lg-5 form-group">
                            <div>
                                <select class="span4 form-control" id="old_location_name" name="old_location_name" onchange="setNewSSID1(this.value)">
                                    <option value="">SELECT LOCATION
                                    </option>
                                    <?php
                                    $get_group_tag_q = "SELECT `tag_name` FROM `exp_mno_distributor_group_tag` WHERE `distributor`='$user_distributor' GROUP BY `tag_name`";
                    ...
                    <div class="control-group">
                        <label class="control-label" for="radiobtns" id="loc_label1">Create a New Location
                            : </label>

                        <div>
                            <div class="controls col-lg-5 form-group">
                                <input class="span4 form-control" id="location_name1" name="location_name" type="text" value="<?php echo ''; ?>" required>
                            </div>
                        </div>
                    </div>
