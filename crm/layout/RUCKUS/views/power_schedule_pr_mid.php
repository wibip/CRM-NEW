...
<script type="text/javascript">
    ...
    function updateSlider(e, ui,id) {
            var aaa = $(e.target).attr("class").split(/\s+/);
            const idnew = aaa[1].split("-")[2];
            ...
            $('input[name='+ timeEle +'_from1'+  idnew +']').val(("0" + hours1).slice(-2));

            var ampm1 = minutes1.split(" ")[1];

            $('input[name='+ timeEle +'_from2'+  idnew +']').val(ampm1);
            ...
            if(difference == 0){
                allVal = 'off';
                allTxt = 'Always Off';
                $('.slide_'+ timeEle + idnew ).hide();
                $('.txt_'+ timeEle + idnew).css('display', 'inline-block');
                ...
                allVal = 'custom';
                allTxt = '';
                $('.slide_'+ timeEle + idnew).show();
                $('.txt_'+ timeEle + idnew).hide();
            }
            

            $('.txt_'+ timeEle +idnew ).html(allTxt);
            $('input[name='+ timeEle +'_all'+  idnew +']').val(allVal);

            $('input[name='+ timeEle +'_to1'+  idnew +']').val(("0" + hours3).slice(-2));

            var ampm2 = minutes3.split(" ")[1];

            $('input[name='+ timeEle +'_to2'+  idnew +']').val(ampm2);
...
function getSliderPluginVal($from1, $from2, $to1, $to2)
    {
        $return_ar = array('from' => 0, 'to' => 0);
        if ($from1 == '12' && $from2 == 'AM') {
            $return_ar['from'] = 0;
        } elseif ($from1 != '12' && $from2 == 'PM') {
            $from1=$from1+12;
            $return_ar['from']=$from1 * 60;
        } else{
...
if(!function_exists('get_minutes')) {
    ...
    if(method_exists($wag_obj,'retrieveSchedule')){
       ...
       $ssid_q="SELECT s.network_id , s.ssid ,s.id FROM `exp_locations_ssid_private` s ,  `exp_mno_distributor` d
        ...
        if($ssid_res['rowCount']>0){
            ...
            foreach ($ssid_res['data'] as $row){
                ...
                if(strlen($WLan_schedule_name)<1){
                    ...
                    if ($ssid_name_mode=='PowerSchedule') {
                        $WLan_schedule_type='Customized';
                    }
                    else{
                      $WLan_schedule_type=$ssid_name_mode;  
                    }
                    if (strlen($WLan_schedule_type)==0) {
                        if ($_POST['all']=='on') {
                            $WLan_schedule_type='AlwaysOn';
                        }
                        elseif ($_POST['all']=='custom') {
                            $WLan_schedule_type='Customized';
                        }
                        else{
                            $WLan_schedule_type='AlwaysOff';
                ...
                switch($WLan_schedule_type){
                    case 'Customized' : {
                        ...
                        if($schedule['status_code']=='200'){
                            $sys_log->save(SysLog::FAC_PROPERTYACTION,SysLog::SAV_INFOMATION,'3009','get zone Schedules',$zone_id.json_encode($schedule));
                        ...
                        $mon_from1 = $_POST['mon_from1'];
                        $mon_from2 = $_POST['mon_from2'];
                        $mon_to1 = $_POST['mon_to1'];
                        $mon_to2 = $_POST['mon_to2'];
                        $mon_all = $_POST['mon_all'];
                        $mon_slider_val =getSliderPluginVal($mon_from1,$mon_from2,$mon_to1,$mon_to2);
                        $mon_from = $_POST['mon_from1'].':00';
                        $mon_to = $_POST['mon_to1'].':00';
                        $mon_slider_val_from=$mon_slider_val['from'];
                        $mon_slider_val_to=$mon_slider_val['to'];

                        $tue_from1 = $_POST['tue_from1'];
                        $tue_from2 = $_POST['tue_from2'];
                        $tue_to1 = $_POST['tue_to1'];
                        $tue_to2 = $_POST['tue_to2'];
                        $tue_all = $_POST['tue_all'];
                        $tue_slider_val =getSliderPluginVal($tue_from1,$tue_from2,$tue_to1,$tue_to2);
                        ...
                        $wed_from1 = $_POST['wed_from1'];
                        $wed_from2 = $_POST['wed_from2'];
                        $wed_to1 = $_POST['wed_to1'];
                        $wed_to2 = $_POST['wed_to2'];
                        $wed_all = $_POST['wed_all'];
                        $wed_slider_val =getSliderPluginVal($wed_from1,$wed_from2,$wed_to1,$wed_to2);
                        ...
                        $thu_from1 = $_POST['thu_from1'];
                        $thu_from2 = $_POST['thu_from2'];
                        $thu_to1 = $_POST['thu_to1'];
                        $thu_to2 = $_POST['thu_to2'];
                        $thu_all = $_POST['thu_all'];
                        $thu_slider_val =getSliderPluginVal($thu_from1,$thu_from2,$thu_to1,$thu_to2);
                        ...
                        $fri_from1 = $_POST['fri_from1'];
                        $fri_from2 = $_POST['fri_from2'];
                        $fri_to1 = $_POST['fri_to1'];
                        $fri_to2 = $_POST['fri_to2'];
                        $fri_all = $_POST['fri_all'];
                        $fri_slider_val =getSliderPluginVal($fri_from1,$fri_from2,$fri_to1,$fri_to2);
                        ...
                        $sat_from1 = $_POST['sat_from1'];
                        $sat_from2 = $_POST['sat_from2'];
                        $sat_to1 = $_POST['sat_to1'];
                        $sat_to2 = $_POST['sat_to2'];
                        $sat_all = $_POST['sat_all'];
                        $sat_slider_val =getSliderPluginVal($sat_from1,$sat_from2,$sat_to1,$sat_to2);
                        ...
                        $sun_from1 = $_POST['sun_from1'];
                        $sun_from2 = $_POST['sun_from2'];
                        $sun_to1 = $_POST['sun_to1'];
                        $sun_to2 = $_POST['sun_to2'];
                        $sun_all = $_POST['sun_all'];
                        $sun_slider_val =getSliderPluginVal($sun_from1,$sun_from2,$sun_to1,$sun_to2);
                ...
                ?>
                <form id="tab5_form<?php echo$sID; ?>" name="tab5_form1" method="post" action="?t=2" class="form-horizontal">
                    
                    <fieldset class="fieset">
                        
                        <div class="control-group" id="feild_gp_taddg_divt<?php echo$sID; ?>" style="display: none;">
                        ...
                        <div class="power_box_main">
                            <?php if ($ori_user_type!='SALES') {?>
                            <div class="power_box1" style="padding: 30px;border: 1px solid #dec8c8;width: 65%;;float: left;border-top-left-radius: 10px;border-bottom-left-radius: 10px;">

                                <div class="days">
                                    <p>
                                        Monday
                                    </p>
                                    <p class="slide_mon<?php echo$sID; ?>" <?php echo 'style="display:'; echo $mon_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-mon"><?php echo$mon_from1.' '.$mon_from2 ?></span> - <span class="slider-time2-mon"><?php echo$mon_to1.' '.$mon_to2 ?></span>
                                    </p>
                                    <p class="txt_mon<?php echo$sID; ?>" <?php echo 'style="display:'; echo $mon_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $mon_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                    <input type="hidden" name="mon_from1<?php echo$sID; ?>" value="<?php echo $mon_from1; ?>">
                                    <input type="hidden" name="mon_from2<?php echo$sID; ?>" value="<?php echo $mon_from2; ?>">
                                    <input type="hidden" name="mon_to1<?php echo$sID; ?>" value="<?php echo $mon_to1; ?>">
                                    <input type="hidden" name="mon_to2<?php echo$sID; ?>" value="<?php echo $mon_to2; ?>">
                                    <input type="hidden" name="mon_all<?php echo$sID; ?>" value="<?php echo $mon_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_tue<?php echo$sID; ?>" <?php echo 'style="display:'; echo $tue_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-tue"><?php echo$tue_from1.' '.$tue_from2 ?></span> - <span class="slider-time2-tue"><?php echo$tue_to1.' '.$tue_to2 ?></span>
                                    </p>
                                    <p class="txt_tue<?php echo$sID; ?>" <?php echo 'style="display:'; echo $tue_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $tue_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="tue_from1<?php echo$sID; ?>" value="<?php echo $tue_from1; ?>">
                                    <input type="hidden" name="tue_from2<?php echo$sID; ?>" value="<?php echo $tue_from2; ?>">
                                    <input type="hidden" name="tue_to1<?php echo$sID; ?>" value="<?php echo $tue_to1; ?>">
                                    <input type="hidden" name="tue_to2<?php echo$sID; ?>" value="<?php echo $tue_to2; ?>">
                                    <input type="hidden" name="tue_all<?php echo$sID; ?>" value="<?php echo $tue_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_wed<?php echo$sID; ?>" <?php echo 'style="display:'; echo $wed_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-wed"><?php echo$wed_from1.' '.$wed_from2 ?></span> - <span class="slider-time2-wed"><?php echo$wed_to1.' '.$wed_to2 ?></span>
                                    </p>

                                    <p class="txt_wed<?php echo$sID; ?>" <?php echo 'style="display:'; echo $wed_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $wed_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="wed_from1<?php echo$sID; ?>" value="<?php echo $wed_from1; ?>">
                                    <input type="hidden" name="wed_from2<?php echo$sID; ?>" value="<?php echo $wed_from2; ?>">
                                    <input type="hidden" name="wed_to1<?php echo$sID; ?>" value="<?php echo $wed_to1; ?>">
                                    <input type="hidden" name="wed_to2<?php echo$sID; ?>" value="<?php echo $wed_to2; ?>">
                                    <input type="hidden" name="wed_all<?php echo$sID; ?>" value="<?php echo $wed_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_thu<?php echo$sID; ?>" <?php echo 'style="display:'; echo $thu_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-thu"><?php echo$thu_from1.' '.$thu_from2 ?></span> - <span class="slider-time2-thu"><?php echo$thu_to1.' '.$thu_to2 ?></span>
                                    </p>

                                    <p class="txt_thu<?php echo$sID; ?>" <?php echo 'style="display:'; echo $thu_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $thu_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="thu_from1<?php echo$sID; ?>" value="<?php echo $thu_from1; ?>">
                                    <input type="hidden" name="thu_from2<?php echo$sID; ?>" value="<?php echo $thu_from2; ?>">
                                    <input type="hidden" name="thu_to1<?php echo$sID; ?>" value="<?php echo $thu_to1; ?>">
                                    <input type="hidden" name="thu_to2<?php echo$sID; ?>" value="<?php echo $thu_to2; ?>">
                                    <input type="hidden" name="thu_all<?php echo$sID; ?>" value="<?php echo $thu_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_fri<?php echo$sID; ?>" <?php echo 'style="display:'; echo $fri_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-fri"><?php echo$fri_from1.' '.$fri_from2 ?></span> - <span class="slider-time2-fri"><?php echo$fri_to1.' '.$fri_to2 ?></span>
                                    </p>
                                    <p class="txt_fri<?php echo$sID; ?>" <?php echo 'style="display:'; echo $fri_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $fri_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="fri_from1<?php echo$sID; ?>" value="<?php echo $fri_from1; ?>">
                                    <input type="hidden" name="fri_from2<?php echo$sID; ?>" value="<?php echo $fri_from2; ?>">
                                    <input type="hidden" name="fri_to1<?php echo$sID; ?>" value="<?php echo $fri_to1; ?>">
                                    <input type="hidden" name="fri_to2<?php echo$sID; ?>" value="<?php echo $fri_to2; ?>">
                                    <input type="hidden" name="fri_all<?php echo$sID; ?>" value="<?php echo $fri_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sat<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sat_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sat"><?php echo$sat_from1.' '.$sat_from2 ?></span> - <span class="slider-time2-sat"><?php echo$sat_to1.' '.$sat_to2 ?></span>
                                    </p>
                                    <p class="txt_sat<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sat_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sat_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="sat_from1<?php echo$sID; ?>" value="<?php echo $sat_from1; ?>">
                                    <input type="hidden" name="sat_from2<?php echo$sID; ?>" value="<?php echo $sat_from2; ?>">
                                    <input type="hidden" name="sat_to1<?php echo$sID; ?>" value="<?php echo $sat_to1; ?>">
                                    <input type="hidden" name="sat_to2<?php echo$sID; ?>" value="<?php echo $sat_to2; ?>">
                                    <input type="hidden" name="sat_all<?php echo$sID; ?>" value="<?php echo $sat_all; ?>" class="all<?php echo$sID; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sun<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sun_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sun"><?php echo$sun_from1.' '.$sun_from2 ?></span> - <span class="slider-time2-sun"><?php echo$sun_to1.' '.$sun_to2 ?></span>
                                    </p>
                                    <p class="txt_sun<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sun_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sun_all=='on'?'Always On':'Always Off'; ?>
                                    </p>

                                    <input type="hidden" name="sun_from1<?php echo$sID; ?>" value="<?php echo $sun_from1; ?>">
                                    <input type="hidden" name="sun_from2<?php echo$sID; ?>" value="<?php echo $sun_from2; ?>">
                                    <input type="hidden" name="sun_to1<?php echo$sID; ?>" value="<?php echo $sun_to1; ?>">
                                    <input type="hidden" name="sun_to2<?php echo$sID; ?>" value="<?php echo $sun_to2; ?>">
                                    <input type="hidden" name="sun_all<?php echo$sID; ?>" value="<?php echo $sun_all; ?>" class="all<?php echo$sID; ?>">
                            ...
                            <?php } else{ ?>
                            <div class="power_box1" style="    padding: 30px;    border: 1px solid #dec8c8;    width: 65%;;float: left;">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_mon<?php echo$sID; ?>" <?php echo 'style="display:'; echo $mon_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-mon"><?php echo$mon_from.' '.$mon_from2 ?></span> - <span class="slider-time2-mon"><?php echo$mon_to.' '.$mon_to2 ?></span>
                                    </p>
                                    <p class="txt_mon<?php echo$sID; ?>" <?php echo 'style="display:'; echo $mon_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $mon_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                    <input type="hidden" name="mon_from1<?php echo$sID; ?>" value="<?php echo $mon_from1; ?>">
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_tue<?php echo$sID; ?>" <?php echo 'style="display:'; echo $tue_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-tue"><?php echo$tue_from.' '.$tue_from2 ?></span> - <span class="slider-time2-tue"><?php echo$tue_to.' '.$tue_to2 ?></span>
                                    </p>
                                    <p class="txt_tue<?php echo$sID; ?>" <?php echo 'style="display:'; echo $tue_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $tue_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_wed<?php echo$sID; ?>" <?php echo 'style="display:'; echo $wed_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-wed"><?php echo$wed_from.' '.$wed_from2 ?></span> - <span class="slider-time2-wed"><?php echo$wed_to.' '.$wed_to2 ?></span>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_thu<?php echo$sID; ?>" <?php echo 'style="display:'; echo $thu_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-thu"><?php echo$thu_from.' '.$thu_from2 ?></span> - <span class="slider-time2-thu"><?php echo$thu_to.' '.$thu_to2 ?></span>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_fri<?php echo$sID; ?>" <?php echo 'style="display:'; echo $fri_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-fri"><?php echo$fri_from.' '.$fri_from2 ?></span> - <span class="slider-time2-fri"><?php echo$fri_to.' '.$fri_to2 ?></span>
                                    </p>
                                    <p class="txt_fri<?php echo$sID; ?>" <?php echo 'style="display:'; echo $fri_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $fri_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sat<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sat_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sat"><?php echo$sat_from.' '.$sat_from2 ?></span> - <span class="slider-time2-sat"><?php echo$sat_to.' '.$sat_to2 ?></span>
                                    </p>
                                    <p class="txt_sat<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sat_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sat_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                                ...
                                <div class="days">
                                    ...
                                    <p class="slide_sun<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sun_all!='custom'?' none;"':'inline-block;"' ?> ><span class="slider-time-sun"><?php echo$sun_from.' '.$sun_from2 ?></span> - <span class="slider-time2-sun"><?php echo$sun_to.' '.$sun_to2 ?></span>
                                    </p>
                                    <p class="txt_sun<?php echo$sID; ?>" <?php echo 'style="display:'; echo $sun_all=='custom'?' none;"':'inline-block;"' ?>><?php echo $sun_all=='on'?'Always On':'Always Off'; ?>
                                    </p>
                        ...
                        <?php } ?>
                        <div class="power_box2" style="width: 35%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;">
                                <h2>SSID :  <br>
