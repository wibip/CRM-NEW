		...
		<div class="container">
			<div class="row">
				<div class="span12">
					...
					<h1 class="head">
Property Search <img data-toggle="tooltip" title="If a customer needs support, please follow the steps below to login to the property and provide support.<br><b>Step 1.</b>IDENTIFY ACCOUNT NUMBER OR PROPERTY ID OR BUSINESS ID OR BUSINESS ACCOUNT NAME: Ask the customer for their Account Number or Property ID or Business ID or Business Account Name. The Business ID is 12 alphanumeric characters assigned to each Administrator.<br><b>Step 2.</b> FIND ACCOUNT NUMBER OR PROPERTY ID OR BUSINESS ID OR BUSINESS ACCOUNT NAME: Enter Account Number or Property ID or Business ID or Business Account Name in the text box below and click on 'Search' button.<br><b>Step 3.</b>SIGN INTO THE BUSINESS ID ADMIN: Click on the 'Sign In' link to login to the Business ID admin portal as an administrator.<br><b>Step 4.</b> IDENTIFY THE PROPERTY: If the customer has more than one property, ask them for the Account Number or Property ID for the property they need assistance with. Click on the 'Sign In' link to login to the Property admin portal as an administrator to provide support." src="layout/RUCKUS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>

					<form method="post" class="sm-mb-0 flex center">

					<input class="span4" type="text" id="icom" name="icom" style="margin-bottom: 0;" >
					<style>
    ...
    box-sizing: border-box;
					...
					<button type="submit" name="search_user" id="search_user" class="btn btn-primary ml-10" style="display: inline-block">Search</button>
											...
											<div class="widget widget-table action-table" style="margin-bottom: 40px">
												...
												<div class="widget-content table_response" id="product_tbl">
													...
													<table id="supportSearchTable" class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap>
														<thead>
															<tr>
																<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" colspan="2">Business ID</th>
																<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" >Business Account Name</th>
																<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1"  colspan="2">Property ID</th>
