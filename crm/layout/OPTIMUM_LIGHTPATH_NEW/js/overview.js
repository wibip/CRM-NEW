var distributor, switchDetailsArr = {},camp_layout1;

function makeCanvas(data, a, b, c, camp_layout, propName) {

    camp_layout1 = camp_layout;
    var src = '';
    ...
    var jsonOBJ = JSON.parse(data),
        ...
        firewall_from = jsonOBJ.firewall_from,
        /****/
        ...
        firewallStr = '<li><h3 style="text-align: left;">Firewalls</h3><input type="checkbox" checked="checked" id="firewallImg" /><label for="firewallImg" class="firewall '+firewall_from+'"></label><ul>';
    ...
    for (key12 in vEdgeObj) {
        ...
        vEdgeStr = vEdgeStr + '<li><label data-ref="' + allved + '" data-type="vEdge" data-desc="' + vEdgeObj[allved].AP_Description + '" data-uniq="' + vdUniq + '"  class="tree_label vedgeChild ' + vdstatus + '">' + vEdgeObj[allved].AP_Description + '</label></li>';
        details = details + '<div class="treeDesc details_vd' + allved + '" style="display: none;"><h2><b>ASSET DETAILS</b></h2><label class="node_txt">MAC: <b>' + vEdgeObj[allved].mac + '</b></label><label>STATUS : <b>' + vdstatus + '</b></label><label>UP TIME : <b>' + vEdgeObj[allved].Up_Time + '</b></label><div class="' + vdUniq + 'Loader Treeloader" style="display: none"><img src="' + loader + '"></div><div class="' + vdUniq + 'Table" style="display: none;padding-top: 30px"><table class="table" cellpadding="10"><tbody><tr><td>MAC:</td><td>' + vEdgeObj[allved].mac + '</td></tr><tr><td>Serial Number:</td><td>' + vEdgeObj[allved].Serial_Number + '</td></tr><tr><td>Firmware:</td><td>' + vEdgeObj[allved].Firmware + '</td></tr></tbody></table></div></div>';
    ...
    for (key12 in serverObj) {
        ...
        serverStr = serverStr + '<li><label data-ref="' + allserver + '" data-type="server" data-desc="' + serverObj[allserver].AP_Description + '" data-uniq="' + serverUniq + '"  class="tree_label vedgeChild ' + serverstatus + '">' + serverObj[allserver].AP_Description + '</label></li>';
        details = details + '<div class="treeDesc details_server' + allserver + '" style="display: none;"><h2><b>ASSET DETAILS</b></h2><label class="node_txt">MAC: <b>' + serverObj[allserver].mac + '</b></label><label>STATUS : <b>' + serverstatus + '</b></label><label>UP TIME : <b>' + serverObj[allserver].Up_Time + '</b></label><div class="' + serverUniq + 'Loader Treeloader" style="display: none"><img src="' + loader + '"></div><div class="' + serverUniq + 'Table" style="display: none;padding-top: 30px"><table class="table" cellpadding="10"><tbody><tr><td>MAC:</td><td>' + serverObj[allserver].mac + '</td></tr><tr><td>Serial Number:</td><td>' + serverObj[allserver].Serial_Number + '</td></tr><tr><td>Firmware:</td><td>' + serverObj[allserver].Firmware + '</td></tr></tbody></table></div></div>';
    ...
    for (key12 in firewallObj) {
        ...
        if(firewall_from=='meraki'){
            var firewallUniq = firewallObj[allfirewall].id;

            if (firewallObj[allfirewall].disableMyMerakiCom) {
            ...
            firewallStr = firewallStr + '<li><label data-ref="' + allfirewall + '" data-status="'+firewallstatus+'" data-type="firewall_'+firewall_from+'" data-desc="' + firewallObj[allfirewall].id + '" data-uniq="' + firewallUniq + '"  class="tree_label firewallChild ' + firewallstatus + '">' + firewallObj[allfirewall].name + '</label></li>';
            details = details + '<div class="treeDesc details_firewall' + allfirewall + '" style="display: none;"><h2><b>ASSET DETAILS</b></h2><div class="' + firewallUniq + 'Loader Treeloader" style="display: none"><img src="' + loader + '"></div><div class="' + firewallUniq + 'Table" style="display: none;padding-top: 10px"><table class="table" cellpadding="10"><tbody><tr style=" border-top: none; "><th style=" border-top: none; "><b>General Information</b></th><th style=" border-top: none; "></th></tr><tr><td>Network:</td><td>' + firewallObj[allfirewall].name + '</td></tr></tbody></table></div></div>';
            ...
            details = details + '<div class="treeDesc details_firewall' + allfirewall + '" style="display: none;"><h2><b>ASSET DETAILS</b></h2><label class="node_txt">MAC: <b>' + firewallObj[allfirewall].mac + '</b></label><label>STATUS : <b>'+firewallstatus+'</b></label><label>UP TIME : <b>' + firewallObj[allfirewall].Up_Time + '</b></label><div class="' + firewallUniq + 'Loader Treeloader" style="display: none"><img src="' + loader + '"></div><div class="' + firewallUniq + 'Table" style="display: none;padding-top: 30px"><table class="table" cellpadding="10"><tbody><tr><td>MAC:</td><td>' + firewallObj[allfirewall].mac + '</td></tr><tr><td>Serial Number:</td><td>' + firewallObj[allfirewall].Serial_Number + '</td></tr><tr><td>Firmware:</td><td>' + firewallObj[allfirewall].Firmware + '</td></tr><tr><td>Model:</td><td>' + firewallObj[allfirewall].model + '</td></tr></tbody></table></div></div>';
    ...
    for (key in switchObj) {
        ...
        if (switchObj[x].mac != 'noSwitch') {
            ...
            details = details + '<div class="treeDesc details_sw' + x + '" style="display: none;"><h2><b>ASSET DETAILS</b></h2><label class="node_txt">MAC: <b>' + switchObj[x].mac + '</b></label><label>STATUS: <b>' + swStatus + '</b></label><label>UP TIME : <b>' + switchObj[x].Up_Time + '</b></label><div class="' + swUniq + 'Loader Treeloader" style="display: none"><img src="' + loader + '"></div><div class="' + swUniq + 'Table" style="display: none;padding-top: 30px"><table class="table" cellpadding="10"><tbody><tr><td>MAC:</td><td>' + switchObj[x].mac + '</td></tr><tr><td>Serial Number:</td><td>' + switchObj[x].Serial_Number + '</td></tr><tr><td>Firmware:</td><td>' + switchObj[x].Firmware + '</td></tr><tr><td>IP Address:</td><td>' + switchObj[x].ipAddress + '</td></tr></tbody></table></div></div>';
    ...
    //ul = ul + ApStr + '</ul></li>';
    if(jsonOBJ.is_wired!='1'){
        ul = ul + ApStr + '</ul></li>';
        txtStr = txtStr +'<tr><td>Access Points</td><td>' + allAp + '</td><td>' + onAp + ' of ' + allAp + ' UP</td></tr>';
    }

    $('#innerCanvasContainer').css({'background': '#fff','padding-top': '40px'}).html('<h1 class="headName">Your Network at a Glance</h1><label class="headlabel">Click on an element to see a detailed view of its status and performance.</label><div class="overviewDiv"><div class="treeDiv"><div class="treeDivInner"><label class="internet"><img src="layout/' + camp_layout + '/img/internet.png"><span>' + propName + '</span></label><ul class="tree treeUl">' + ul + '</ul></div></div><div class="detailsTree"><span class="arrow left"> BACK</span><div class="treeDivDetails"><h2><b>ASSET INVENTORY</b></h2><table><tbody><tr><th style="text-align: left">TYPE</th><th style="text-align: left">QTY</th><th style="text-align: left">STATUS</th></tr>'+txtStr+'</tbody></table></div>' + details + '</div></div>');
...
$(document).ready(function() {
    ...
    $(document.body).on('click', 'label.tree_label' ,function(event){
        ...
        if ($(this).data("type") == 'AP') {
        ...
        }else if ($(this).data("type") == 'firewall_meraki') {
            ...
            $('.ports-div').remove();
            $(cl).show();
            var status_topbar = '<div class="ports-topbar"> <span><b >Status:</b></span> <span><div class="mer-green"></div>Active</span> <span><div class="mer-black"></div>Inactive</span> </div>';
            $.post('ajax/arris_graphs.php', { type: 'overview', id: $(this).data("desc"), method: 'firewall', distributor: distributor, status: $(this).data("status") }, function(data, textStatus, xhr) {
                ethernet1 = '';
                var jsonOBJ = JSON.parse(data);
                for (keye in jsonOBJ.ethernet) {
                ...
                var portsDiv='<div class="ports-div">';
                for (key1 in jsonOBJ.ports) {
                    if(jsonOBJ.ports[key1].status=='on'){
                        var port_img = '<img src="layout/' + camp_layout1 + '/img/ports-on.png?v=1">';
                    }else if(jsonOBJ.ports[key1].status=='off-red'){
                        var port_img = '<img src="layout/' + camp_layout1 + '/img/ports-red.png?v=1">';
                    }
                    else{
                        var port_img = '<img src="layout/' + camp_layout1 + '/img/ports-off.png?v=1">';
                    }
                    portsDiv = portsDiv + '<span>'+port_img+jsonOBJ.ports[key1].name+'</span>';
                }
                portsDiv = portsDiv + '</div>';
                status_topbar = status_topbar + portsDiv;
                $(cl).hide();
                $(cl2).after(ethernet1);
                $(cl3).before(status_topbar).show();
            });
