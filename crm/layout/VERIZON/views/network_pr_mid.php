...
employees deserve privacy. <img data-toggle="tooltip" title='In a few simple steps, you will be up and running with your Private WiFi Service. Your Private WiFi Service is encrypted and password protected. This is separate from your Guest WiFi Service. As an added security feature, you have the option to show or hide your SSID name. If hidden you can still connect to the SSID if you know the SSID name.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
            ...
            <div class="header_hr"></div>
            <div class="header_f1">It is your business</div><img data-toggle="tooltip" title="In a few simple steps, you will be up and running with your Private WiFi Service. Your Private WiFi Service is encrypted and password protected. This is separate from your Guest WiFi Service. As an added security feature, you have the option to show or hide your SSID name. If hidden you can still connect to the SSID if you know the SSID name." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
            <br class="hide-sm"><br>
            <div class="header_f2" style="width: fit-content;">so let the SSID show it.</div>
...
<input class="se_au_type" name="se_au" type="radio" id="802" onclick="au_load_2('sh_aaa','sh_pass')" value="802"> Enterprise -->
    ...
    <?php if (in_array("NET_PRI_SHEDULE", $features_array) || $package_features == "all") { ?>
        <div <?php if (isset($subtab3)) { ?>class="tab-pane fade in active" <?php } else { ?> class="tab-pane fade" <?php } ?> id="guestnet_tab_3">
            ...
            <div class="header_hr"></div>
            <div class="header_f1">Private Network Schedule</div>
            <br class="hide-sm">
            <?php
 ...
 -->
            <div class="header_hr"></div>
            <div class="header_f1">Welcome to your Hotspot Set-up Guide</div>
...
but on your terms. <img data-toggle="tooltip" title='You can set a broadcast schedule for each of your SSIDs. This means your SSIDs will only be visible to your visitors during the hours you have specified for each day. Ex. your hours of operations. If you select “Always ON” the SSID is visible 24/7, while “Always Off” means the SSID is turned off.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
            ...
            <div class="header_hr"></div>
            <div class="header_f1">Broadcast your SSID</div><img data-toggle="tooltip" title="You can set a broadcast schedule for each of your SSIDs. This means your SSIDs will only be visible to your visitors during the hours you have specified for each day. Ex. your hours of operations. If you select “Always ON” the SSID is visible 24/7, while “Always Off” means the SSID is turned off." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
            <br class="hide-sm"><br>
            <div class="header_f2" style="width: fit-content;">but on your terms.</div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            foreach ($get_private_ssid_res_assign['data'] as $row) {
                                ...
                                parse_str($network_sche_data, $network_sche_res);

                                array_push($retrieveOneNetworkCache, array("wlan" => $netid, "data" => $network_sche_res));


                                $obj = (array)json_decode(urldecode($network_sche_res['Description']));
                                $she_ar = $obj['schedule'];
                                $api_ssid = $obj['ssid'];
...
with a great password.<img data-toggle="tooltip" title=" If you would like to restrict access to your Private WiFi network, you can set a password. Choose a password that is easy to remember but hard to guess." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
            ...
            <div class="header_hr"></div>
            <div class="header_f1">A secure network</div><img data-toggle="tooltip" title=" If you would like to restrict access to your Private WiFi network, you can set a password. Choose a password that is easy to remember but hard to guess." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
            <br class="hide-sm"><br>
            <div class="header_f2" style="width: fit-content;">starts
                with a great password.</div>
