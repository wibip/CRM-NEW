...
<script type="text/javascript">
	...
	<div class="header_hr"></div><br class="show_sm" style="display: none;">
                                                 <div class="header_f1" >
    Engage your visitors</div><img data-toggle="tooltip" title='You can create campaigns to communicate with all or a subset of all your visitors. They will see the campaign once they have registered via your splash page theme. Once a campaign is created you can edit, start/stop or delete that campaign.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
<br class="hide-sm"><br class="hide-sm"><div class="header_f2" style="width: fit-content;">let them know who you are. </div>
													...
													switch ($mg_ad_type) {
														...
														case 'slider' :
															...
															<div class="controls">
																...
																<h3 style="display: inline-block;">Illustrative rendering of the template</h3><img data-toggle="tooltip" title="The arrows indicates which elements of the template that can be changed" src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
															...
															<div class="control-group form-group">
																...
																<div class="controls form-group">
																	...
																	<h3 style="display: inline-block;">Welcome Message</h3><img data-toggle="tooltip" title="A maximum of 30 characters allowed including spaces" src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Upload logo image</h3><img data-toggle="tooltip" title="The logo image must be a transparent png, gif, png, jpeg, jpg Maximum size 600 Kb. Use aspect ratio 8 by 3." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
		...
		<h3 style="display: inline-block;">Upload slider images</h3><img data-toggle="tooltip" title="The images must be a .png or jpg. Maximum size 600Kb. Use aspect ratio 1 by 1." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
...
<option <?php if($secslider=='https://'){echo 'selected';} ?> value="https://">https://</option>
														...
														case 'survey' :
															...
															<div class="controls form-group">
																...
																<h3 style="display: inline-block;">Welcome Message</h3><img data-toggle="tooltip" title="A maximum of 30 characters allowed including spaces" src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;">
                                                 ...
                                                 <br>  
                                                 	...
                                                 	<div class="control-group">
															...
															<div class="controls form-group">
																...
																<h3 style="display: inline-block;">Upload logo image</h3><img data-toggle="tooltip" title="The logo image must be a transparent png, gif, png, jpeg, jpg Maximum size 600 Kb. Use aspect ratio 8 by 3." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;">
															...
															<!-- /control-group -->	
																...
																<div class="controls form-group">
																	...
																	<h3 style="display: inline-block;">Survey Question</h3><img data-toggle="tooltip" title="The question must be a simple multiple choice question. A maximum of 30 characters are allowed including spaces. EX. Which of these colors do you prefer?. You have to provide a minimum of two and maximum three possible predetermined answers. Ex. Yellow, Blue, Other. Each answer must be accompanied by an image." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
			...
			<div class="controls form-group">
				...
				<h3 style="display: inline-block;">Possible Answers</h3><img data-toggle="tooltip" title="Each predetermined answer can be a maximum of 20 characters. The image must be a .png or .jpg. Maximum size 200 Kb. Use aspect ratio 1 by 1." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
                                                 ...
                                                 <br> 
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Upload Campaign image</h3><img data-toggle="tooltip" title="The image must be a .png or jpg. Maximum size 600Kb. Use aspect ratio 1 by 1." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
			...
			<?php } ?>
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Countdown</h3><img data-toggle="tooltip" title="Set the amount of time the progression bar will show before the user is redirected to the final redirect URL." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
														...
														case 'video' :
															...
															<div class="control-group form-group">
																...
																<div class="controls">
																	...
																	<h3 style="display: inline-block;">Video Requirements</h3><img data-toggle="tooltip" title="Your video can be either 15 or 30 seconds long. We only accept videos from the youtube domain." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
...
<option <?php if($sec_wvideo=='https://'){echo 'selected';} ?> value="https://">https://</option>
											...
											<div class="control-group form-group">
												...
												<div class="controls form-group">
													...
													<h3 style="display: inline-block;">Campaign target audience</h3><img data-toggle="tooltip" title=" If using a Facebook or Manual Registration splash page theme you can create multiple campaigns targeting a specific demographic audience based on what data your splash page collect." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
											...
											<?php if ($package_functions->getSectionType("CAMP_CREATE_LOCATION", $system_package, $user_type) == "locations" || $package_features == "all") { ?>
												<div class="control-group form-group" style="display:none">
													...
													<div class="controls form-group">
													<h3 style="display: inline-block;">Campaign target location</h3><img data-toggle="tooltip" title="If you have more then one location you could create multiple campaigns and select which locations receive which campaign. Click the location in the left box to move it to the right box to activate the campaign for that location." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
...
<div class="controls">
	...
	<h3 style="display: inline-block;">Active<img data-toggle="tooltip" title="Select the check box if you want this campaign to go live immediately. Alternatively use the manage section to activate this campaign at a later date." src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;display:  inline-block;margin-left: 4px;" "=""></h3>
