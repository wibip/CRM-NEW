...
$(document).ready(function() {
	$(".newTabs").append("<li><a href='#preview_theme_new' id='tab-preview_theme_new' data-toggle='tab'>Create-preview</a></li>");
});
...
<?php if(!in_array("welcomepage", $hide_divs_gene_arr)){ ?>
	...
	<div class="tab-pane" id="preview_theme_new" style="margin: 20px;">
		
		<div class="header_hr"></div>
        <div class="header_f1" >
    		First impressions last</div><img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest WiFi network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/VERIZON/img/help.png" style="width: 25px;margin-bottom: 6px;cursor: pointer;margin-left: 4px;">
		<br class="hide-sm"><br class="hide-sm">
		<div class="header_f2" style="width: fit-content;">make yours a splash page. </div>

		<form id="theme_preview_new" name="theme_preview_new" class="form-horizontal" method="POST" action="theme.php" autocomplete="off">
			<fieldset>
				
				<?php include 'froala-theme.php' ?>
