 ...
 */
		...
		$user_name_n = $nf->getUserName($property_id,$user_email,$append_realm);

		/*if($append_realm=='1'){
			$user_name_n = $nf->getUserName($property_id,$user_email,$append_realm);//strtolower($_POST["email"]).'@'.$property_id;
		}else{
...
VALUES('$customer_email','$first_name','$last_name','$user_name_n','$password','$room', '$question','$property_id','$answer',NOW(),'$email_sent','$sys_user','$comp_name','$street_address','$city','$state','$postal_code','$country','$phone','$service_profile_product','MDU_PORTAL','$vlan_id','$validity_time')";
