	...
	<link href="../layout/OPTIMUM/css/respo.css" rel="stylesheet">
	<style type="text/css">
		html body{
		...
		.middle{
			background-image: url('../layout/OPTIMUM/img/SAML_Error_Image.jpg');
			width: 100%;
			height: 535px;
			background-size: 100%;
			display: table-cell;
...
<div class="main">
	<div class="container">
    	<div class="logo" style="">
        	<img src="../layout/OPTIMUM/img/logo.png">
    	</div>
		<h1 style="padding-bottom: 30px">It is not your fault!</h1>

		<div class="middle">
				<div class="error-msg">[<?php echo $oops_error_message; ?>]</div>
    			<div class="con-dis"><h2>Contact your Optimum support and let them know your login failed</h2>
