...
#myTabContentDASH_TOP20_CLIENT_DETAILS_BOX .resize_charts{
  margin-top: 0;
}
...
/* ul.tree {
 ...
 @media (max-width: 767px){
  ...
  .HEAD_MOST_POP, .MOST_POP_FROM_ALL .para{
    padding-left: 15px;
  }
  h2#ARRIS_API_TOP10_OS{
...
.cf .nav-tabs:not(.zg-ul-select)>.active>a, .cf .nav-tabs:not(.zg-ul-select)>.active>a:hover{
	  color: #000;
...
.zg-ul-select:not(.active) li.active:after{
  content: "\f078";
  font-family: FontAwesome;
  position: relative;
  top: 7px;
 ...
 /*.zg-ul-select.active > li:nth-child(1){
  ...
  .zg-ul-select.active > li:nth-child(1):after{
    content: "\f077";
    font-family: FontAwesome;
    position: absolute;
    top: 7px;
  ...
  @media (max-width: 979px){
    .zg-ul-select:not(.active) li.active:after, .zg-ul-select.active > li:nth-child(1):after{
      top: 8px;
      right: -8px;
    }
  }
