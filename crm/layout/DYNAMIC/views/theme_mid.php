...
make yours a splash page. <img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest WiFi network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
...
<?php } ?>
													...
													<!-- /control-group -->
				                       				...
				                       				<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select  Location/Property<img data-toggle="tooltip" title='You can create a unique splash page for each of your locations.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Select Language<img data-toggle="tooltip" title='[Coming soon] You can create multiple language versions of your splash page.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Browser Heading<img data-toggle="tooltip" title='Set the text you want your user to see in the splash page browser window.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
												...
												<!-- *************************** Text ************************** -->
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Progression<img data-toggle="tooltip" title='Set the progression text your visitors will see while the registration page is loading. Special characters allowed are _.-' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
?>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Redirection<img data-toggle="tooltip" title='Set the redirection URL  where the visitor will land after finalizing the registration. The Custom URL is the URL of your choice. The Default Website is the URL of your service provider. The Thank You Page is a static local system page.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Template<img data-toggle="tooltip" title='[Coming soon] Select from a list of predefined templates to modify to fit your location.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
    ...
    function choice2(select) {
		...
		if((x=='res_cox_standard_template')){
			...
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\')" maxlength="14" name="welcome" class="span5 banner_txt_val" required="required" placeholder="Enter customer name text" value="'+ welcome_old +'">');
			$('#welcome_validate').hide();
		}
...
temp_image();
	...
	$(document).ready(function() {
        ...
        var y = '<img id="preview_img"  src="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=22" style="max-height:320px;width:60%;max-width: 100%"><p><a id="pre_id" class="fancybox fancybox.iframe" href="<?php echo $base_portal_folder; ?>/checkpoint.php?client_mac=DEMO_MAC&theme='+template_name1+'&realm=<?php echo $db->getValueAsf("SELECT `verification_number` AS f FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor' LIMIT 1");?>">Preview Template Layout</a>';
       ...
       // console.log(y);
		...
		if((x=='res_cox_standard_template')){
			...
			$('#banner-def-txt').show();
			$('#banner-under-txt').html('<b>Note: You can add in your business name to the end of the default Banner Text. It can have up to 30 characters with spaces.</b>');
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\')" maxlength="14" name="welcome" class="span5 banner_txt_val" required="required" placeholder="Enter customer name text" value="<?php echo $txt_new; ?>">');
			$('#welcome_validate').hide();
		}
...
////
	...
	$(document).ready(function() {
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Registration Type<img data-toggle="tooltip" title=' Select the type of registration you would require your visitors to complete to gain access to the Internet.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
    ...
    function choice1(select) {
        ...
        else if(x=="SMS_PAYPAL" || x=="WOW_GUEST"){
...
$(document).ready(function() {
	  ...
	  if(conceptName=="FB_MANUAL" ){
	   ...
	   try {$("#manual").show();}catch(err) {}
	     ...
	     else if(conceptName=="SMS_PAYPAL" || conceptName=="WOW_GUEST"){
...
<div id="imgupload">
	...
	<!-- <img  src=" //$original_bg_Image_Folder.$th_background_image;  style='width:125px;height:100px; display:inline;'>  -->
		...
		var croppicContaineroutputMinimallogo1 = {
				...
				onBeforeImgUpload: function(){ window.img_id = $('#image_1_name').val();console.log('DeletedonBeforeImgUpload')  },
...
<img data-toggle="tooltip" title='Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum size 1000KB. Recommended aspect ratio is 2 by 1.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;">
...
<small id="logo1_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="password" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
													<div id="logo1_up_bc" class="no_crop_parent" style="display: block;">
														...
														<div class="slider_change" style="display:none"></div>
...
<input type="hidden" id="back_color1">
                                                ...
                                                <div class="control-group" id="duotone">
                                                        ...
                                                        <div class="controls">
                                                        	<h3 style="display:  inline-block;">Duotone Overlay of background <span> image<img data-toggle="tooltip" title='Select the overlay color and use the slider to set the transparency.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></span></h3>
...
<br>
															...
															<div class="controls uprel">
																...
																<h3 style="display: inline-block;">Upload logo image<img data-toggle="tooltip" title="Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum Size 200KB. Recommended aspect ratio is 8 by 3." src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
	...
	<p style="font-size: 90%;"><b id="logo2_img_note" style="display: none;"></b></p>
		...
		var croppicContaineroutputMinimallogo2 = {
			    ...
			    rotateControls: false,
				loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
				onBeforeImgUpload: function(){ window.img_logo_id = $('#image_2_name').val();console.log('onBeforeImgUpload') },
...
?>
													<div id="alttxt2" class="control-group">
														...
														<div class="controls">
																...
																<h3 style="display: inline-block;">Logo Alternative Text  <img data-toggle="tooltip" title="Check the box and add in your message instead of a logo. You can use up to 20 characters including space." src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
...
<label class="control-label" for="radiobtns" id="banner-label" style="display: none;">Banner Text</label>
													<div id="wtxt" class="controls">
															...
															<h3 style="display: inline-block;">Banner text<img data-toggle="tooltip" title="You can use up to 14 characters including spaces" src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
...
<?php if(!in_array("welcome_text", $hide_divs_gene_arr)){ ?>
														<div id="txt_hide">
															...
															<input type="text" id="welcome" onkeyup="valid_check(this.value,'welcome_validate')" maxlength="14" name="welcome" class="span5 banner_txt_val" placeholder="Enter customer name text" required onkeyup="valid_check(this.value,'theme_name1_validate')" value="<?php echo $welcome_txt; ?>" autocomplete="off" >
    ...
    if($(a).is(":checked")) {
		...
		$("#m_male").removeAttr('required');
													...
													<div class="control-group">
														...
														<div class="controls">
															<h3 style="display: inline-block;">Select manual registration <span> fields<img data-toggle="tooltip" title='Collecting demographic data from your visitors will give you additional insights and will allow you to create targeted campaigns based on those demographics.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ><span></h3>
														</div>
													</div>
...
<div id="field_color" class="control-group feild">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Field Color<img data-toggle="tooltip" title="You can set the color of the fields depending on the background used." src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
													...
													<div id="field_txt_color" class="control-group feild">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Field Text Color<img data-toggle="tooltip" title="You can set the color of the field text based on the field color used." src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></h3>
...
<div id="manualbutton">
												...
												<div id="mregbtn" class="control-group">
														...
														<div class="controls">
															...
															<h3 style="display: inline-block;">Button text<img data-toggle="tooltip" title="You can use up to 20 characters including spaces." src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></h3>
										...
										<div class="tab-pane <?php if($active_tab == 'assing') echo 'active'; ?>" id="assing">
                                            ...
                                            if(isset($_SESSION['msg_ass'])){
                                                ...
                                                unset($_SESSION['msg_ass']);
                                                                                              ...
                                                                                              <h1 class="head">
 Theme Assignment. <img data-toggle="tooltip" title='Select the theme you would like to assign to multiple locations. Then select the locations and save.' src="layout/WOW/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
