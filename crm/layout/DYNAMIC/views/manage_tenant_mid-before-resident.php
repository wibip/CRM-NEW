                           ...
                           <fieldset>
                                   ...
                                   <div class="control-group middle-large">
                                     ...
                                     <div class="controls">
                                      ...
                                      <button class="btn btn-primary" style="" type="submit" name="search_btn" id="search_btn">Search</button> <img data-toggle="tooltip" title="Click [SEARCH] to show a full list of tenants" src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
