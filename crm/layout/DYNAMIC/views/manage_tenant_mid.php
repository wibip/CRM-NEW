...
$mno_system_package = $db->getValueAsf("SELECT m.`system_package` AS f FROM `exp_mno_distributor` d,`exp_mno` m WHERE  d.`mno_id` = m.`mno_id` AND d.`system_package` = '$system_package'");

$vt_pro = $package_functions->getOptions('VTENANT_NETWORK_PROFILE',$mno_system_package);
...
$nf = new network_functions($vt_pro,'',$mno_package);
} else {
$nf = null;
}
      ...
      if ($status_code == 200 || $status == 200) {
        ...
        if ($password != "") {
         ...
         // $MNO=$db->getValueAsf("SELECT mno_id AS f FROM exp_mno WHERE system_package='$mno_package'");
          ...
          $email_content = $db->getEmailTemplate('CUSTOMER_MAIL',$mno_id,'ADMIN');
        ...
        if($get_property_type=='VTENANT'){
          ...
          $res = mysql_query("SELECT `distributor_name` FROM `exp_mno_distributor` WHERE `distributer_code` = '$user_distributor'");
          $row = mysql_fetch_array($res);
          $prop_name = $row['distributor_name'];
          $vars2 = array(
            '{$Property_Name}' => $prop_name 
          );

          $message_full = strtr($a, $vars);
          $subject = strtr($subject, $vars2);
...
//echo "".$status_code;
  ...
  if($ex1 && $status_code == 200 && ($mg_customer_id!=NULL || $mg_customer_id!='')){
       ...
       if($property_type=='VTENANT'){
         $msg_edit= "<div class='alert alert-success'><button type='button' class='close' data-dismiss='alert'>X</button>
       <strong>Device has been successfully added</strong></div><button style=\"display:none;\" type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\"id=\"auto_click\"></button>
    ...
    if($property_type=='VTENANT'){
         $msg_edit= "<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'>X</button><strong>".$message_functions->showMessage('device_add_session_failed','2001')."</strong></div><button style=\"display:none;\" type=\"button\" class=\"btn btn-primary btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\"id=\"auto_click\"></button>
...
<div class="main">
 ...
 <?php 
         ...
         $max_count = $db->getValueAsf("SELECT  `device_limit` as f FROM `mdu_organizations` WHERE `property_id`='$mg_property_id'");
          ...
          <div align="left" style="vertical-align:top;"><a href="manage_tenant.php?searchid=<?php echo $search_id;?>" class="btn btn-primary btn-small btn-info-iefix" style="text-decoration:none"><i class="icon-white icon-chevron-left"></i> Go Back</a></div>
         
        <div align="center" style="vertical-align:top;">
         <h1 class="head" style="margin-top: 20px;padding-bottom: 15px;"><strong>Manage Residents</strong></h2>
         </div>
         </div>
         <br>
         <br>
                         ...
                         ?>
                           ...
                           <div class="se_field">
                             ...
                             <div class="control-group">
                                     ...
                                     <div class="controls form-group">
                                       <div class="columns" style="margin-bottom: 5px">
                                          <h3><strong>Manually Add Resident Devices</strong></h3>
                                       </div>
                                     </div>
...
<div class="control-group">
      ...
      <li style="line-height: 22px">You can register up to <?php //echo '10'; ?> devices. </li>
      <li style="line-height: 22px">To manually register a device fill in the MAC address and click “Add a New Device Manually".</li>
    ...
    Manage Residents <!-- <img data-toggle="tooltip" title="Use the Search Tenant field to search for existing tenants that have contacted you for assistance with their account. This could include updating personal information, adding or removing devices, upgrading account to a premium service, resetting their account password and also permanently deleting an account." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"> --></span>
                           ...
                           <fieldset>
                                    ...
                                    <!-- <div class="control-group">
                                     ...
                                     <div class="controls">
                                         ...
                                         <a  id="sync_all" name="sync_all" class="btn btn-default" style="text-decoration:none"><i class="btn-icon-only icon-refresh"></i> Sync Records</a>&nbsp;<img data-toggle="tooltip" title="If a tenant record appears to be missing from the search results, then click [sync Records] to download missing records that you may have added manually." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                   ...
                                   <div class="control-group" style="display: none;">
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" for="radiobtns">Limit Search to <img data-toggle="tooltip" title="You can search a resident across all your properties or limit the search to a specific property." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                   ...
                                   <div class="control-group middle-large">
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" for="radiobtns">Search Residents <img data-toggle="tooltip" title="You can search for resident using full or partial First Name, Last Name, or Email or use the Search MAC field." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <div class="controls">
                                      ...
                                      <label class="" style="margin-top: 10px" for="radiobtns">Search MAC <img data-toggle="tooltip" title="You can search for resident using full or partial MAC address of a device or use the Search resident field." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>
                                     ...
                                     <div class="controls">
                                      ...
                                      <button class="btn btn-primary" style="" type="submit" name="search_btn" id="search_btn">Search</button> <img data-toggle="tooltip" title="Click [SEARCH] to show a full list of residents." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
                                   ...
                                   <div class="control-group">
                                     ...
                                     <div class="controls se_ownload_cr">
                                         <!-- <button class="btn btn-primary" style="margin-bottom: 10px" type="submit" name="search_btn" id="search_btn">Search</button> <img data-toggle="tooltip" title="Click [SEARCH] to show a full list of tenants" src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"> -->
                                         <br />
         ...
         ?>    
                                         <a  id="sync_all" name="sync_all" class="btn btn-primary" style="text-decoration:none"><i class="btn-icon-only icon-refresh"></i> Sync Records</a>&nbsp;<img data-toggle="tooltip" title="If a resident record appears to be missing from the search results, then click [Sync Records] to download missing records that you may have added manually." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;">
         ...
         */
         ...
         FROM `mdu_vetenant` c LEFT JOIN `mdu_customer_devices` d ON c.`customer_id`= d.`customer_id` WHERE c.customer_id IN ($customer_list) GROUP BY c.customer_id ORDER BY c.first_name ASC ";
                         ...
                         while($row=mysql_fetch_array($query_results)){
                           ...
                           echo '<td class="td_btn">';              
                           echo '<a id="CM_'.$customer_id.'"  class="btn btn-small btn-primary td_btn_last"><i class="btn-icon-only icon-wrench"></i>Edit</a>';
         ...
         <button class="btn btn-primary" type="submit" name="Delete_btn_device" id="Delete_btn_device">Delete</button>
         </div>    
                                 </div>
...
<div class="tab-pane <?php if($active_tab=="session"){echo"active";}?>" id="session">
      ...
      ?>
       <h1 class="head"><span>
    Session Search <img data-toggle="tooltip" title="You can search for a resident's online sessions using Email, First Name, Last Name or device MAC Address. To get a list of all sessions, click the Search Button." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></span>
</h1>
      ...
      <form id="edit-profile" action="?tab=session" method="post" class="form-horizontal" >
        ...
        <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <label class="" for="radiobtns">Search Resident <img data-toggle="tooltip" title="You can search using the First Name, Last Name, Email Address or a device MAC Address." src="layout/ARRIS/img/help.png" style="width: 20px;margin-bottom: 6px;cursor: pointer;"></label>

              <div class="">
                <input type="text" name="search_word" id="search_word_session" >
                <button class="btn btn-primary" type="submit" name="search_btn_session" id="search_btn_session">Search</button>
                <br />
