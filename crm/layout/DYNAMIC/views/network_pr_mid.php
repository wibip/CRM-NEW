...
but on your terms. <img data-toggle="tooltip" title='You can set a broadcast schedule for each of your SSIDs. This means your SSIDs will only be visible to your visitors during the hours you have specified for each day. Ex. your hours of operations. If you select “Always ON” the SSID is visible 24/7, while “Always Off” means the SSID is turned off.' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
            ...
            <p>To set a schedule for one of your networks use the sliders to set the schedule between 12am and 11pm. Once your satisfied click the "Set" button to enable the schedule. Sliding the sliders to opposite ends enables "Always On". Sliding one slider on top of the other enables "Always Off".</p> <br>
    ...
    <?php if ((in_array("NET_PRI_PASS", $features_array) && !in_array("NET_AUTHENTICATION", $features_array)) || $package_features == "all") { ?>
                    ...
                    <div class="control-group">
                        ...
                        <div>
                            <div class="controls col-lg-5 form-group">
                                ...
                                <label class="" for="radiobtns">Password <img data-toggle="tooltip" title='Your password must be at least 8 characters long and a maximum of 12 characters long. You must use combination of numbers, letters and special characters: $ ! # @' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
