...
function syncCustomer($Response2){/*
       ...
       if (empty($bulk_profile_datasession)) {
        ...
        //$resultArray = uniqueAssocArray($res_arr1, 'Mac', 'Realm');
        //$testarray = uniqueAssocArray($res_arr2, 'Mac', 'Realm');
        //print_r($res_arr2);
        //print_r($res_arr2);
    ...
    */
    ...
    $finalarray=array($bulk_profile_datasession[0],$bulk_profile_datasession[1]);
        //$finalarray=array($res_arr1,$res_arr2);
                                                   ...
                                                   <fieldset>
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls col-lg-5 form-group">
                                                                    ...
                                                                    <input autocomplete="off" type="text" id="ipaddress2" name="ipaddress2" class="span4 li_download_class form-control">
                                                   ...
                                                   <fieldset>
                                                       ...
                                                       <div class="form-actions border-non">
                                                           ...
                                                           <button disabled name="blacklist" id="blacklist" type="submit" class="btn btn-primary" style="text-decoration:none">
                                                            ...
                                                            <?php
                                                           $customer_down_key_string = "task=all_blacklist&mno_id=".$user_distributor;
                                                           ...
                                                           &nbsp;&nbsp;<a href="ajax/export_customer.php?key=<?php echo $customer_down_key?>" class="btn btn-primary" style="text-decoration:none">
                                                               <i class="btn-icon-only icon-download"></i> Download BlackList
                                                           </a>
