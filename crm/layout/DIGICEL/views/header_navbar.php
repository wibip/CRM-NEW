...
/*iend of mported from introPage*/
	...
	@media (max-width: 979px){
		...
		.navbar .nav .active>.dropdown-toggle, .navbar .nav .open.active>.dropdown-toggle, .navbar .nav .open>.dropdown-toggle{
			background-color: #e4002b;
		}
		...
		.navbar .nav>li>a[data-toggle=dropdown]::after{
			margin: 0 !important;
    		margin-top: 5px !important;
    		background: url('layout/<?php echo $camp_layout ?>/img/down-new.png') center center no-repeat;
		...
		.navbar .nav>li.open>a[data-toggle=dropdown]::after{
...
<div class="navbar navbar-fixed-top"  <?php if($top_menu=='bottom'){ ?> style="display: none;" <?php } ?>>
  <div class="navbar-inner">
    ...
    $log_img = '<img class="logo_img" style="max-height: 32px;float: left;" src="layout/'.$camp_layout.'/img/digi_top_logo.png" border="0">';
  ...
  <?php /// MENU STARTING ?>
      ...
      <div class="nav-collapse">
         ...
         $menutype = $db_class1->setVal('menu_type','ADMIN'); //echo NOW ONLY HAVE SUB MENU ;?>
				...
				if($sub_menu_new_link==1){
					...
					<script type="text/javascript">
	                    $(document).ready(function() {
	                        $('<?php echo "#sysmenu".$keym.""; ?>').click(function(event) {
	                        	//$('<?php //echo "#div".$keym.""; ?>').css("display","block");
	                        
		                        if($('<?php echo "#sysmenu".$keym.""; ?>').hasClass('open')){
          		...
          		<?php	echo '<li id="sysmenu'.$keym.'" class="dropdown sysmenu1" style="display: none;">
            		<a href="'.$link_main_m_multy.$extension.'" class="dropdown-toggle" data-toggle="dropdown" > '.$main_menu_name2.'<b class="caret"></b></a>';
           			...
           			echo '<ul class="dropdown-menu" style="display:none;text-align:center;" id="div'.$keym.'">';
          ...
          <li class="dropdown" id="prof"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <i class="icon-user"></i> <?php  echo $full_name; ?> <b class="caret"></b></a>

            <ul class="dropdown-menu" id="prof-menu" style="display: none;text-align: center;">
				<?php
...
<!--<li class="dropdown" style="<?php //echo $li_style; ?>"><a style="<?php //echo $a_style; ?>" href="#" class="dropdown-toggle" data-toggle="dropdown"><span><span>
      ...
      <li class="dropdown" style="<?php echo $li_style; ?>"><a style="<?php echo $a_style; ?>" href="#" class="dropdown-toggle" data-toggle="dropdown">
           ...
           <ul class="dropdown-menu" style="left: -30px" >
				...
				?>
              		<li style="width: '.$width_li.';'.$css_right.';float: right"><a href="profile<?php echo $extension; ?>" style="padding: 0px !important;">Profile</a></li>
				<?php }
					}
				}
				?>
			  ...
			  if($user_type=="MVNO"){
				...
				echo '<hr class="divid" style="display:none"></hr><li class="subLi" style="border-top: 0px;border-bottom: 0px;border-bottom-left-radius: 0px;border-bottom-right-radius: 0px;">Property ID  <div>'.$property_id.'</div></li>';
				echo '<li class="subLi" style="padding-top: 0px;border-top: 0px;border-top-left-radius: 0px;border-top-right-radius: 0px;">Business ID <div>'.$parent_id.'</div></li>';
			  }elseif($user_type=="MVNO_ADMIN"){

				echo '<hr class="divid" style="display:none;border-top: 0px;border-bottom: 0px;border-bottom-left-radius: 0px;border-bottom-right-radius: 0px;"></hr><li class="subLi">Business ID  <div>'.$user_distributor.'</div></li>';
			  }
			   ?>
            </ul>
...
if($menutype=="SUB_MENU"){
	...
	if($top_menu=="bottom"){
				...
				echo '<style> .logo_img{ max-height: 65px !important; float: none !important; } </style>';
	}
...
/* 	if($user_type=="MNO" || $user_type=="ADMIN"){
	...
	foreach ($main_mod_array as $keym => $valuem){
		...
		if($main_menu_clickble=="NO"){
			...
			echo '<ul id="sami_'.$keym.'a" style="display: none;list-style-type: none;position: absolute; background-color: '.$camp_theme_color.';height: 30px; margin-left: -1.5px;'.$style_tag1.'">';
			$link_main_m_multy = '';
		...
		/// Multy Item
			...
			echo '<ul id="sami_'.$keym.'a" style="display: none;list-style-type: none;position: absolute; background-color: '.$camp_theme_color.';height: 30px;">';
			$link_main_m_multy = '';
...
<script type="text/javascript">
  ...
  if($(window).width()<520){
    ...
    $('.nav-tabs:not(.dropdown_tabs):not(.zg-ul-select)>li').removeClass('active');
  }
