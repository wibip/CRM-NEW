...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
    ...
    function choice2(select) {
        ...
        if(x=="default_theme" || x=="red_template" || x=="altice_business_default" || x=="wow_business_default" || x=="digicel_default"){
        ...
        if(x=="red_template" || x=="altice_business_default" || x=="wow_business_default" || x=="digicel_default"){
