                                             ...
                                             <br>
                                                      ...
                                                      <table class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap >
                                                         ...
                                                         <!--      <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">WLAN Name</th> -->
                                                          ...
                                                          <tbody>
                                                          <?php
                                                           $get_private_ssid_q="SELECT d.`zone_id`, a.`ap_code`,s.`wlan_name`,s.vlan,s.`ssid`,s.`network_id`, s.ssid_password, s.is_enable,d.bussiness_address1,d.state_region,d.bussiness_address2
                                                                                FROM
                                                          ...
                                                          $get_private_ssid_res=mysql_query($get_private_ssid_q);
                                                          $i=0;
                                                          while($get_private_ssid=mysql_fetch_assoc($get_private_ssid_res)){
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                    ...
                                                                    <label class="" for="radiobtns">Current SSID Name<img data-toggle="tooltip" title="Name your SSID so your employees can easily identify and connect." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
...
GROUP  BY   s.`ssid`";
                                                                        ...
                                                                        <a href="?t=10&st=7&action=sync_data_tab1&tocken=<?php echo $secret; ?>" class="btn btn-primary" style="align: left; margin-top: 5px;"><i class="btn-icon-only icon-refresh"></i> Refresh</a>
...
GROUP  BY   s.`ssid`";
                        ...
                        ?>
                    </select><div style="display: inline-block" id="ssid_name_error"></div>
                    ...
                    <script type="text/javascript">
                        ...
                        function loadSSIDDetails(ssid){
                            ...
                            var formData={ssid_pr:ssid,dis:"<?php echo $user_distributor; ?>"};
                            var formData_aaa={ssid_aaa:ssid,dis:"<?php echo $user_distributor; ?>"};
                            var formData_aaa_type={ssid_aaa_type:ssid,dis:"<?php echo $user_distributor; ?>"};
                            $.ajax({
                      ...
                      <div class="controls col-lg-5 form-group" style="position: relative;">
                          <select class="span4 form-control sh_pass3" id="encryption_type" name="encryption_type" required>
                              <?php
                                ...
                                $network_enc_r=mysql_query($network_enc_q);
                                while($network_enc=mysql_fetch_assoc($network_enc_r)){
     ...
     <div class="controls col-lg-5 form-group" style="position: relative;">
         ...
         <option value="">Select AAA</option>
             <?php
               ...
               $network_aaa_r=mysql_query($network_aaa_q);
               while($network_aaa=mysql_fetch_assoc($network_aaa_r)){
           ...
           <p style="font-size: small"><b>Note:  There must be a AAA server configured in order to select Enterprise.  Please contact Tier 1 Support at (877) 984-0175 to add your AAA server details if you would like to select Enterprise.</b></p> 
                          <p id="password-strength-text"></p>
     </div>
 </div>
...
<!--encryption type-->
          ...
          <div class="form-actions">
              <button type="submit" name="update_authentication" id="update_authentication" class="btn btn-primary" disabled>Update</button>
          </div>
                                                  ...
                                                  <div class="widget widget-table action-table">
                                                      ...
                                                      <table class="table table-striped table-bordered tablesaw" data-tablesaw-mode="columntoggle" data-tablesaw-minimap >
                                                         ...
                                                         <!--      <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2">WLAN Name</th> -->
                                                          ...
                                                          $get_private_aaa_res=mysql_query($get_private_aaa_q);
                                                          
                                                          while($get_private_aaa_data=mysql_fetch_assoc($get_private_aaa_res)){
                                                      ...
                                                      <fieldset>
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  ...
                                                                  <input autocomplete="off" class="span4 form-control" id="aaa_name" name="aaa_name" type="text" value="<?php echo $sh_aaa_name; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="aaa_port" name="aaa_port" type="text" value="<?php echo $sh_aaa_port; ?>" maxlength="4" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="aaa_prid" name="aaa_prid" type="text" value="<?php echo $sh_aaa_prid; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="aaa_shared_secret" name="aaa_shared_secret" type="text" value="<?php echo $sh_aaa_shared_secret; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="aaa_com_secret" name="aaa_com_secret" type="text" value="<?php echo $sh_aaa_com_secret; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="sec_aaa_prid" name="sec_aaa_prid" type="text" value="<?php echo $sh_se_aaa_prid; ?>" maxlength="32" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="sec_aaa_shared_secret" name="sec_aaa_shared_secret" type="text" value="<?php echo $sh_se_aaa_shared_secret; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                      <input autocomplete="off" class="span4 form-control" id="sec_aaa_com_secret" name="sec_aaa_com_secret" type="text" value="<?php echo $sh_se_aaa_com_secret; ?>" <?php  if(!$_SESSION['s_token']){ echo 'readonly';} ?>>
...
<script type="text/javascript">
                                    ...
                                    $(document).ready(function(){
                                                 ...
                                                 <div class="widget-content table_response" id="act_profile_tbl">
                                                     ...
                                                     <table class="table table-striped table-bordered" >
                                                        ...
                                                        $ssid_discription_q= "SELECT s.`ssid`,a.`ap_id`,s.`description` ,s.`is_enable` FROM `exp_locations_ssid_private` s,`exp_locations_ap_ssid_private` a
                                                         ...
                                                         $ssid_discription_res=mysql_query($ssid_discription_q);
                                                         while($ssid_discription=mysql_fetch_assoc($ssid_discription_res)){
                                             ...
                                             <div class="widget widget-table action-table">
                                                 ...
                                                 <div class="widget-content table_response" id="schedule_tbl">
                                                     ...
                                                     <table class="table table-striped table-bordered" >
                                                         ...
                                                         $get_schedule_names=mysql_query($get_schedule_names_q);
                                                         while($schedule_names=mysql_fetch_assoc($get_schedule_names)){
                                                             ...
                                                             $schedule_active=mysql_query($schedule_active_q);
                                                             while($schedule=mysql_fetch_assoc($schedule_active)){
                                        ...
                                        <div style="font-size: medium" <?php if(isset($subtab8)){?>class="tab-pane fade in active" <?php }else {?> class="tab-pane fade" <?php }?>   id="guestnet_tab_intruduct">
                                                  <div class="header2_part1"><h2>Welcome to your Hotspot Set-up Guide</h2></div>
                                            ...
                                            <div class="widget-content table_response" id="ssid_tb2">
                                                    ...
                                                    <div style="overflow-x:auto;" >
                                                        ...
                                                        <table class="table table-striped table-bordered" >
                                                            ...
                                                            mysql_query($insert_schedule_assign_private);
...
with a great password.<img data-toggle="tooltip" title=" If you would like to restrict access to your Private WiFi network, you can set a password. Choose a password that is easy to remember but hard to guess." src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
                                                          ...
                                                          <div class="control-group">
                                                              ...
                                                              <div >
                                                                  <div class="controls col-lg-5 form-group">
                                                                     ...
                                                                     <label class="" for="radiobtns">Password <img data-toggle="tooltip" title='Your password must be at least 8 characters long and a maximum of 12 characters long. You may use combination of numbers, letters and special characters: $ ! # @' src="layout/ARRIS/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;"></label>
...
<script>
 ...
 //alert(data);
          ...
          if (data.bv.getSubmitButton()) {
           ...
           $('#update_private_aaa').bootstrapValidator({
            framework: 'bootstrap',
            excluded: ':disabled',
            feedbackIcons: {
                valid: 'glyphicon glyphicon-ok',
            ...
            fields: {
                ...
                aaa_prid: {
                    validators: {
                        <?php echo $db->validateField('notEmpty'); ?>,
                        ip: {
                         message: '<p>This is not a valid Primary IP</p>'
                         }
                ...
                aaa_shared_secret: {
                    validators: {
                        <?php echo $db->validateField('notEmpty'); ?>,
                        identical: {
                        field: 'aaa_com_secret',
                        message: '<p>The Shared Secret and Comfirm Secret are not the same.</p>'
                              } 
                    }
                },
                aaa_com_secret: {
                ...
                sec_aaa_shared_secret: {
                    validators: {
                        <?php echo $db->validateField('notEmpty'); ?>,
                        identical: {
                        field: 'sec_aaa_com_secret',
                        message: '<p>The Secondary Shared Secret and Secondary Comfirm Secret are not the same.</p>'
                              } 
                    }
                },
                sec_aaa_com_secret: {
