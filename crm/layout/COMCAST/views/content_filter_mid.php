                                                ...
                                                echo "<button style='margin-left: 5px; margin-top: 5px;float: right;' 
                                                    type='submit' name='qos_change' id='qos_change' class='btn btn-small btn-primary'>Update</button></td>";
                                                        ...
                                                        echo'</form> </td>';
                                                                ...
                                                                /* echo "<td><form style='margin-bottom:0px !important;' action='?t=1' method='post'>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       $dnssecret=md5(uniqid(rand(), true));
                                                                        ...
                                                                        $dns_q = mysql_query("SELECT * FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor'");

 
                                                                        while($row=mysql_fetch_array($dns_q)){
