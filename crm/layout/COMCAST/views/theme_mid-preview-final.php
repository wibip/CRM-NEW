...
$(document).ready(function () { 
    var top = $('#col2').offset().top - parseFloat($('#col2').css('marginTop').replace(/auto/, 0));
    $(window).scroll(function (event) {
        ...
        if (y >= top) {
           ...
           $('#col2').css("top",difference);
       }
   });
});

function display_input() {
	var input1 = document.getElementById("welcome");
	
	$("#txt_display:text").val(input1.value);
}
function display_btn() {
	var btn1 = document.getElementById("sign_up");
	
	$("#btn_display").val(btn1.value);
}
...
make yours a splash page. <img data-toggle="tooltip" title='Guests will automatically be redirected to your customizable webpage upon connection to your Guest WiFi network. Create multiple themes for your location and easily enable/disable stored themes from the “Manage” tab.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;">
</h1>
...
<input type="hidden" id="using">
									...
									<div class="container">
										<div class="row">
											<div class="col1" style="width: 50%;display: inline-block;">
											<form id="edit-profile1" name="editprofile" class="form-horizontal f_controls" method="POST" action="theme.php" autocomplete="off">
												...
												<fieldset>
                                                    ...
                                                    <?php
                                                        ...
                                                        if($count_ssid == 0){
                                                            ...
                                                            $warning_text = '<div class="alert alert-warning" role="alert"><label><i class="icon-warning-sign"></i> Warning! <small>';
...
<?php } ?>
													...
													<!-- /control-group -->
				                       				...
				                       				<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Select  Location/Property<img data-toggle="tooltip" title='You can create a unique splash page for each of your locations.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Select Language<img data-toggle="tooltip" title='[Coming soon] You can create multiple language versions of your splash page.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Browser Heading<img data-toggle="tooltip" title='Set the text you want your user to see in the splash page browser window.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
												...
												<!-- *************************** Text ************************** -->
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Progression<img data-toggle="tooltip" title='Set the progression text your visitors will see while the registration page is loading. Special characters allowed are _.-' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
?>
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Redirection<img data-toggle="tooltip" title='Set the redirection URL  where the visitor will land after finalizing the registration. The Custom URL is the URL of your choice. The Default Website is the URL of your service provider. The Thank You Page is a static local system page.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
<input type="hidden" name="edit_template_name" value="<?php echo $edit_template_name; ?>">
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Template<img data-toggle="tooltip" title='[Coming soon] Select from a list of predefined templates to modify to fit your location.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
    ...
    function choice2(select) {
		...
		if(x=='<?php echo $edit_template_name; ?>'){
			...
			$('#image_back3_name').val("<?php echo $th_background_image3; ?>");
			$('#image_back_name').val("<?php echo $th_background_image2; ?>");
        ...
        if(x=="default_theme" || x=="red_template" || x=="altice_business_default"  || x=="COMCAST_business_default"){
        ...
        if(x=="red_template" || x=="altice_business_default"  || x=="comcast_business_default"){
		...
		if((x=='res_cox_standard_template')){
			...
			$('#welcome').replaceWith('<textarea id="welcome" class="span4" onkeyup="valid_check(this.value,\'welcome_validate\');display_input()" maxlength="350" name="welcome"style="padding: 10px;border: 1px solid #979798;padding-left: 20px !important;padding-right: 20px !important;height: 72px;" ></textarea>');
			...
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\');display_input()" maxlength="30" name="welcome" class="span4 banner_txt_val" required="required" placeholder="Enter customer name text" value="'+ welcome_old +'">');
			$('#welcome_validate').hide();
		}
...
temp_image();
	...
	$(document).ready(function() {
        ...
        var y = '<img id="preview_img" src="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=17" data-zoom-image="<?php echo $base_portal_folder; ?>/template/'+x+'/img/'+xx+'.jpg?v=17" style="max-height:100px;width:60%;max-width: 100%"><p><a id="pre_id" class="fancybox fancybox.iframe" href="<?php echo $base_portal_folder; ?>/checkpoint.php?client_mac=DEMO_MAC&theme='+template_name1+'&realm=<?php echo $db->getValueAsf("SELECT `verification_number` AS f FROM `exp_mno_distributor` WHERE `distributor_code`='$user_distributor' LIMIT 1");?>">Preview Template Layout</a>';
       ...
       // console.log(y);
		...
		if((x=='res_cox_standard_template')){
			...
			$('#welcome').replaceWith('<textarea id="welcome" class="span4 banner_txt_val" onkeyup="valid_check(this.value,\'welcome_validate\');display_input()" maxlength="350" name="welcome"style="padding: 10px;border: 1px solid #979798;padding-left: 20px !important;padding-right: 20px !important;height: 72px;" ><?php echo $txt_new; ?></textarea>');
			$('#welcome_validate').hide();
			...
			$('#banner-def-txt').show();
			$('#banner-under-txt').html('<b>Note: You can add in your business name to the end of the default Banner Text. It can have up to 30 characters with spaces.</b>');
			$('#welcome').replaceWith('<input type="text" id="welcome" onkeyup="valid_check(this.value,\'welcome_validate\');display_input()" maxlength="30" name="welcome" class="span4 banner_txt_val" required="required" placeholder="Enter customer name text" value="<?php echo $txt_new; ?>">');
			$('#welcome_validate').hide();
		}
	...
	$(document).ready(function() {
													...
													<div class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Registration Type<img data-toggle="tooltip" title=' Select the type of registration you would require your visitors to complete to gain access to the Internet.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>
...
<div class="controls">
<label style="display: inline-block;">Illustrative rendering of the template </label>
<div id="template_image" >

</div>
<div class="movertxt">Move over to zoom in <i class="icon-zoom-in"></i></div>
</div>
...
<?php }else{ ?>
<div>
<label style="display:  inline-block;">Upload background image</label>
<img data-toggle="tooltip" title='Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum size 1000KB. To ensure your background image looks good on all types of devices you have the option to upload three versions of your image. Only the desktop version is required.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;">
...
<div class="back-parent one">

													<!-- <div id="logo1_up_bc3" style="display: block;">

														<div class="slider_change3" style="background-color: #191919;opacity: 0.85;"></div> 

					<?php //if($modify_mode==1 && pathinfo($th_background_image, PATHINFO_EXTENSION) && file_exists($original_bg_Image_Folder.$th_background_image)){?>
													<img id="logo_hi_33" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image; ?>" style="max-width: 100%; height: 150px;">
						<?php //}?>
...
<!-- 	<div class="back-parent two">

	<small id="back2_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="back2_up_validate" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
													<div id="back2_up" style="display: block;">

														<div class="slider_change" style="background-color: #191919;opacity: 0.85;"></div> 

					<?php //if($modify_mode==1 && pathinfo($th_background_image2, PATHINFO_EXTENSION) && file_exists($original_bg_Image_Folder.$th_background_image2)){?>
													<img id="back2_up_img" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image2; ?>" style="max-width: 100%;">
						<?php //}?>
						...
						<input type="hidden" name="background_img_check2" id="background_img_check2" value="1" />
					<?php //} else{ ?>
						<input type="hidden" name="background_img_check2" id="background_img_check2" value="0" />
					<?php //} ?>

													<input type="hidden" name="image_back_name" id="image_back_name" value="<?php //echo $th_background_image2; ?>" />
	...
	<p style="font-size: 90%;"><b></b></p>
		...
		var croppicContaineroutputMinimallogo9 = {
				uploadUrl:'plugins/img_upload/img_save_to_file_png_bc.php?baseportal=<?php //echo $base_portal_folder; ?>&imname=image_back_name&himg=back2_up_img',
				cropUrl:'plugins/img_upload/img_crop_to_file_back2.php?discode=<?php //echo $user_distributor; ?>&baseportal=<?php //echo $base_portal_folder; ?>',
				modal:true,
				doubleZoomControls:false,
			    rotateControls: false,
				loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
				onBeforeImgUpload: function(){  },
				onAfterImgUpload: function(){ $('.cropControlUpload').hide(); if($('.new_upload').length == 0) { $("div:not(#back2_up) > .cropControlsUpload").append(" <p class='new_upload'>Please save images</p>"); $("div:not(#back2_up) > .cropControlsUpload").addClass('warning_img'); }  },
				onImgDrag: function(){ console.log('onImgDrag') },
				onImgZoom: function(){ console.log('onImgZoom') },
				onBeforeImgCrop: function(){ console.log('onBeforeImgCroplogo1_up_bc') },
				onAfterImgCrop:function(){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check2').val('1'); $('#back2_up').prepend('<div class="slider_change"></div>');
				setColor($('.slider').slider("option", "value"));  },
				onReset:function(){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check2').val('0'); },
				onError:function(errormessage){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check2').val('0'); }
		}
		var cropContaineroutput9 = new Croppic('back2_up', croppicContaineroutputMinimallogo9);
...
<!-- 	<div class="back-parent there">

	<small id="back3_up_validate" data-bv-validator="notEmpty" data-bv-validator-for="back3_up_validate" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none;margin-left: 40px;"><p>This is a required section</p></small>
													<div id="back3_up" style="display: block;">

														<div class="slider_change" style="background-color: #191919;opacity: 0.85;"></div> 

					<?php //if($modify_mode==1 && pathinfo($th_background_image3, PATHINFO_EXTENSION) && file_exists($original_bg_Image_Folder.$th_background_image3)){?>
													<img id="back3_up_img" class="croppedImg" src="<?php //echo $original_bg_Image_Folder.$th_background_image3; ?>" style="max-width: 100%;">
						<?php //}?>
						...
						<input type="hidden" name="background_img_check3" id="background_img_check3" value="1" />
					<?php //} else{ ?>
						<input type="hidden" name="background_img_check3" id="background_img_check3" value="0" />
					<?php //} ?>

													<input type="hidden" name="image_back3_name" id="image_back3_name" value="<?php //echo $th_background_image3; ?>" />
	...
	<p style="font-size: 90%;"><b></b></p>
		...
		var croppicContaineroutputMinimallogo12 = {
				uploadUrl:'plugins/img_upload/img_save_to_file_png_bc.php?baseportal=<?php //echo $base_portal_folder; ?>&imname=image_back3_name&himg=back3_up_img',
				cropUrl:'plugins/img_upload/img_crop_to_file_back3.php?discode=<?php //echo $user_distributor; ?>&baseportal=<?php //echo $base_portal_folder; ?>',
				modal:true,
				doubleZoomControls:false,
			    rotateControls: false,
				loaderHtml:'<div class="loader bubblingG"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> ',
				onBeforeImgUpload: function(){  },
				onAfterImgUpload: function(){ $('.cropControlUpload').hide(); if($('.new_upload').length == 0) { $("div:not(#back3_up) > .cropControlsUpload").append(" <p class='new_upload'>Please save images</p>"); $("div:not(#back3_up) > .cropControlsUpload").addClass('warning_img'); }  },
				onImgDrag: function(){ console.log('onImgDrag') },
				onImgZoom: function(){ console.log('onImgZoom') },
				onBeforeImgCrop: function(){ console.log('onBeforeImgCroplogo1_up_bc') },
				onAfterImgCrop:function(){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check3').val('1'); $('#back3_up').prepend('<div class="slider_change"></div>'); setColor($('.slider').slider("option", "value")); },
				onReset:function(){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check3').val('0'); },
				onError:function(errormessage){ $('.cropControlUpload').show(); $('.new_upload').remove(); $(".cropControlsUpload").removeClass('warning_img'); $('#background_img_check3').val('0'); }
		}
		var cropContaineroutput12 = new Croppic('back3_up', croppicContaineroutputMinimallogo12);
								    ...
								    $(function () {
								        ...
								        $("#logo_txt1_enable").click(function () {
								            ...
								            if ($(this).is(":checked")) {
								            	...
								            	document.getElementById("image_back3_name").value = "";
								            	document.getElementById("image_back_name").value = "";
...
<input type="hidden" id="back_color1">
                                                ...
                                                <div class="control-group" id="duotone">
                                                        ...
                                                        <div class="controls">
                                                        	<label style="display:  inline-block;"> Overlay of background <span> image<img data-toggle="tooltip" title='Select the overlay color and use the slider to set the transparency.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></span></label>
                                                            ...
                                                            <div class="" style="display: block;">
                                                            	...
                                                            	<?php   if($modify_mode==1){
				                                                    		...
				                                                    		$duotone_color = "#191919";
				                                                    		$duotone_color_bg_slider = "10";
				                                                    		$duotone_color_bg = "";
				                                                    	} ?>

                                                            <div id="duotone_color_div" class="input-group colorpicker-component"><input class="span2" id="duotone_color" name="duotone_color" type="text" value="<?php echo $duotone_color; ?>" ><span class="input-group-addon"><i></i></span>
...
<br>
															...
															<div class="controls uprel">
																...
																<label style="display: inline-block;">Upload logo image<img data-toggle="tooltip" title="Acceptable Image formats are: PNG, GIF, JPEG and JPG. Maximum Size 200KB. Recommended aspect ratio is 8 by 3." src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
													...
													<!-- <div id="logo2_up2" style="display: block;">
					<?php //if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION)){?>
													<img id="logo_hi_22" class="croppedImg" src="<?php //echo $original_logo_Image_Folder.$th_logo_image; ?>" style="width: 230px;height: 79px;">
					<?php //}?>
													</div> -->

													<input type="hidden" name="image_2_name" id="image_2_name" value="<?php echo $th_logo_image; ?>" />

	<p style="font-size: 90%;"><b id="logo2_img_note" style="display: none;"></b>
...
?>
													<div id="alttxt2" class="control-group">
														...
														<div class="controls">
																...
																<label style="display: inline-block;">Logo Alternative Text  <img data-toggle="tooltip" title="Check the box and add in your message instead of a logo. You can use up to 20 characters including space." src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
															...
															<?php if($modify_mode == 1 && (!pathinfo($th_logo_image, PATHINFO_EXTENSION) || !file_exists($original_logo_Image_Folder.$th_logo_image))){  echo "value =\"".$th_logo_image."\" "; } ?>
...
<label class="control-label" for="radiobtns" id="banner-label" style="display: none;">Banner Text</label>
													<div id="wtxt" class="controls">
															...
															<label style="display: inline-block;">Banner text<img data-toggle="tooltip" title="You can use up to 30 characters including spaces" src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
...
<?php if(!in_array("welcome_text", $hide_divs_gene_arr)){ ?>
														<div id="txt_hide">
															...
															<input type="text" id="welcome" onkeyup="valid_check(this.value,'welcome_validate');display_input()" maxlength="30" name="welcome" class="span4 banner_txt_val" placeholder="Enter customer name text" required onkeyup="valid_check(this.value,'theme_name1_validate')" value="<?php echo $welcome_txt; ?>" autocomplete="off" >
...
<div id="sub_banner" class="control-group">


    <div class="controls">
     <label>Tagline <img data-toggle="tooltip" title="You can use up to 120 characters including spaces" src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
     <div>
     	<input type="text" id="sub_banner_text" onkeyup="valid_check(this.value,'sub_banner_text_validate')" maxlength="120" name="sub_banner_text" class="span4 sub_banner_text" placeholder="Tagline" value="<?php echo $extra_fieldsArr['sub_banner_txt']; ?>">

     	<small id="sub_banner_text_validate" data-bv-validator="notEmpty" data-bv-validator-for="sub_banner_text" class="help-block error-wrapper bubble-pointer mbubble-pointer" style="display: none; margin-left: 40px;"><p>This is a required field</p></small>
    ...
    if($(a).is(":checked")) {
		...
		$("#m_male").removeAttr('required');
													...
													<div class="control-group">
														...
														<div class="controls">
															<label style="display: inline-block;">Select manual registration <span> fields<img data-toggle="tooltip" title='Collecting demographic data from your visitors will give you additional insights and will allow you to create targeted campaigns based on those demographics.' src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;" ><span></label>
														</div>
													</div>
														...
														<div class="controls">
															...
															<?php
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="fnamefield" data-role1="first_name" name="m_first_name" id="m_first_name" type="checkbox" class="check_manu" checked>';
															...
															<input type="text" id="first_name" name="first_name" class="span5" value="<?php echo $first_name_text; ?>">
																	...
																	echo '<input onclick="manual_toggle(this)" name="m_first_name" data-role="fnamefield" data-role1="first_name" id="m_first_name" type="checkbox" class="check_manu">';
														...
														<div class="controls">
															...
															<?php
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="lnamefield" name="m_last_name" data-role1="last_name" id="m_last_name" type="checkbox" class="check_manu" checked>';
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="lnamefield" name="m_last_name" data-role1="last_name" id="m_last_name" type="checkbox" class="check_manu">';
														...
														<label for="radiobtns">Email</label>
                                                            ...
                                                            $r = $manual_login_fields['email'];
																...
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="emailfield" data-role1="email" name="m_email" id="m_email" type="checkbox" class="check_manu" checked>';
																	...
																	echo '<input onclick="manual_toggle(this)" data-role1="email" data-role="emailfield" name="m_email" id="m_email" type="checkbox" class="check_manu">';
														...
														<label for="radiobtns">Mobile Number</label>
                                                            ...
                                                            $r = $manual_login_fields['mobile_number'];
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role="mobilefield" data-role1="mobile_number" name="m_mobile" id="m_mobile" type="checkbox" class="check_manu" checked>';
															...
															<input class="span5" id="mobile_number" name="mobile_number" type="text" value="<?php echo $edit_mobile_number_fields; ?>">
																	...
																	echo '<input onclick="manual_toggle(this)" data-role1="mobile_number" data-role="mobilefield" name="m_mobile" id="m_mobile" type="checkbox" class="check_manu">';
	...
	display: inline-block !important;
														...
														<label for="radiobtns">Gender</label>
                                                            ...
                                                            $r = $manual_login_fields['gender'];
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle_gender(this)" name="m_gender" id="m_gender" type="checkbox" class="check_manu" checked>';
													...
													<div id="m_female">
															<input class="span2a" id="female" name="female" type="text" value="<?php echo $female_field; ?>" required>
																	...
																	echo '<input onclick="manual_toggle_gender(this)" name="m_gender" id="m_gender" type="checkbox" class="check_manu">';
...
<?php } ?>
													...
													<div class="control-group" id="m_age_groupd">
														...
														<div class="controls">
														<label for="radiobtns">Age Range</label>
                                                            ...
                                                            $r = $manual_login_fields['age_group'];
																if ($r == 1) {
																	...
																	echo '<input onclick="manual_toggle(this)" data-role1="age_group" data-role="agegrp" name="m_age_group" id="m_age_group" type="checkbox" class="check_manu" checked>';
															...
															<input class="span5" id="age_group" name="age_group" type="text" value="<?php echo $age_group_field; ?>" required>
																	...
																	echo '<input onclick="manual_toggle(this)" data-role1="age_group" data-role="agegrp" name="m_age_group" id="m_age_group" type="checkbox" class="check_manu">';
...
<div id="field_color" class="control-group feild">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Field Color<img data-toggle="tooltip" title="You can set the color of the fields depending on the background used." src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
													...
													<div id="field_txt_color" class="control-group feild">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Field Text Color<img data-toggle="tooltip" title="You can set the color of the field text based on the field color used." src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display: inline-block;"></label>
													...
													<div id="field_preview" class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Field Preview</label>
...
<div id="manualbutton">
												...
												<div id="mregbtn" class="control-group">
														...
														<div class="controls">
															...
															<label style="display: inline-block;">Button text<img data-toggle="tooltip" title="You can use up to 20 characters including spaces." src="layout/COMCAST/img/help.png" style="width: 30px;margin-bottom: 6px;cursor: pointer;display:  inline-block;"></label>

															<div class="input-prepend input-append">

															<input type="text" maxlength="20" id="sign_up" name="sign_up" value="<?php echo $registration_btn ?>" onkeyup="valid_check(this.value,'buttontext_validate');display_btn()">
...
$("#sign_up").keypress(function(event){
	...
	//if(ew == 32 || ew == 8 ||ew == 0 ||ew == 45 ||ew == 95 ||ew == 38)
...
<div id="color">
													...
													<div id="btncolor" class="control-group">
														...
														<label style="display: inline-block;">Button “active” state color </label>
														...
														<label style="display: inline-block;">Button “disabled” state color </label>
...
<?php if(!in_array("welcomepage", $hide_divs_gene_arr)){ ?>
										...
										function ck_topval(set_val){
											...
											var sub_banner_text=document.getElementById('sub_banner_text').value;
											...
											if(sub_banner_text != ''){
												...
												var patt = /[-@<*>$%^&*()_+|~=`{}\[\]:";'<>?.\/]/;
										    	var sub_banner_text = patt.test(sub_banner_text);

											}
											else{
												sub_banner_text = true;
											}
										...
										<div class="col2" id="col2" style="width: max-content;display: inline-block;float: right;">


		<style>
			@media (max-width:600px){
				#logo1_up_bc, #load_grad, #logo1_up_bc > img, #logo_hi_3{
			...
			@media (max-width:1199px) and (min-width:768px){
				...
				#isactive, #theme_submit, #password{
					/*margin-left:-20px !important;*/
				}
			}
        ...
        <div class="control-group" style="">
          ...
          <div class="controls" style="margin-left:0px">
				...
				<div id="logo1_up_bc" style="width: 400px; height: 500px" class="input-prepend input-append"> 


					<?php if(!(isset($_GET['modify']))){?>
						
						<img src="layout/<?php echo $camp_layout; ?>/img/capture1.jpg" style='width:400px;height:500px;object-fit: cover; display:inline;' class=""/>	
						<!-- <div id="load_grad" style="width: 400px; height: 500px;position: absolute;margin-top: -500px;" class="input-prepend input-append"></div> -->
						<?php } ?>
						
						
																								
						<?php if($modify_mode==1 && pathinfo($th_background_image, PATHINFO_EXTENSION) && file_exists($original_bg_Image_Folder.$th_background_image)){?>
							<img id="logo_hi_3" class="croppedImg" src="<?php echo $original_bg_Image_Folder.$th_background_image; ?>" style="width:400px;height:500px;object-fit: cover; display:inline;" class="">
					...
					<div class="input-prepend input-append" id="logo2_up" style="width: 125px; height: 100px;position: absolute;margin-top: -450px;margin-left: 90px;background-image: none;text-align: center;"><!-- margin-left: 137.5px -->


					<?php if($modify_mode!=1){?>
						
						<img id="logo_hi_2" src="layout/<?php echo $camp_layout; ?>/img/logo1.png" style='width:125px !important;height:100px !important; display:inline;' class=""/>	
						<!-- <div id="load_grad" style="width: 400px; height: 500px;position: absolute;margin-top: -500px;" class="input-prepend input-append"></div> -->
						<?php } ?>
					
				
						<?php if($modify_mode==1 && pathinfo($th_logo_image, PATHINFO_EXTENSION) && file_exists($original_logo_Image_Folder.$th_logo_image)){?>

								<img id="logo_hi_2" class="croppedImg" src="<?php echo $original_logo_Image_Folder.$th_logo_image; ?>" style='width:auto;height:100%; display:inline;object-fit: cover;'>
								<input type="hidden" name="image_2_name" id="image_2_name" value="<?php echo $th_logo_image; ?>" />

						<?php 
						} else if(strlen($logo_dft_img)>0)
						{ ?>
								<img src="<?php echo $original_logo_Image_Folder.$logo_dft_img; ?>" style='width:125px;height:100px; display:inline;'>
								<input type="hidden" name="image_2_name" id="image_2_name" value="<?php echo $logo_dft_img; ?>" />
		...
		var cropContaineroutput = new Croppic('logo2_up', croppicContaineroutputMinimallogo2);
				...
				<div class="input-prepend input-append" id="text_dis" style="position:absolute;margin-top:-325px;width: 100%;text-align: center;">
					
					<span class="" name="txt_display" id="txt_display" style="text-align:center;width:300px;background:transparent;color:#fff;border: none;font-size: 30px !important;"><?php if(empty($text1)){ echo "Welcome to the free wifi service"; }else{ echo $text1;} ?></span>

				</div>

				<div id="manual_reg" style="display: none;position: absolute;margin-top: -280px;margin-left: 50px;">
					<input type="text" id="manu_m_first_name" style="display: none;">
					<input type="text" id="manu_m_last_name" style="display: none;">
					<input type="text" id="manu_m_email" style="display: none;">
					<input type="text" id="manu_m_mobile" style="display: none;">
					<input type="text" id="manu_m_gender" style="display: none;">
					<input type="text" id="manu_m_age_group" style="display: none;">
				</div>

				<script type="text/javascript">
					$(document).ready(function() {
						$('#reg_type').on('change', function() {
						  var reg_type = this.value;
						  if(reg_type == 'MANUAL'){
								var chckd=0;

								$('.check_manu').on('click', function() {
									var id = this.id;

									$('#manual_reg').css("display","block");
									$('#btn_dis').css("margin-top","-90px");
									$('#text_dis').css("margin-top","-350px");

									if($(this).is(":checked")){
										$('#manu_'+id).css("display","inline-block");
										chckd = chckd+1;
									}
									else if($(this).is(":not(:checked)")){
										$('#manu_'+id).css("display","none");
										chckd = chckd-1;
									}

									if(chckd%2 == 0){
										$('[id^=manu_]').css("width","150px");

									}else{
										$('[id^=manu_]').css("width","300px");
									}
								});						  	
						  }else{
						  	$('[id^=manu_]').css("display","none");
						  	$('#btn_dis').css("margin-top","-220px");
							$('#text_dis').css("margin-top","-325px");
						  }
						});				
				...
				<div class="input-prepend input-append" id="btn_dis" style="position:absolute;margin-top:-220px;margin-left:100px;width: fit-content;">

					<input type="button" name="btn_display" class="btn btn-primary" id="btn_display" style="width:200px;color:#fff;border-radius: 5px !important;height: 40px !important;" value="<?php if(empty($bt_text1)){ echo "Accept & Connect"; }else{ echo $bt_text1;} ?>" onclick="">
													...
													<fieldset>
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<label style="display: inline-block;">Theme</label>
...
val_check1('logo_txt2_enable');
  <?php } ?>
										...
										var theme_ele = new Array("theme_name1", "location_ssid","language", "title_t","loading" ,"redirect_type","splash_url","template_name", "reg_type" , "logo1_up_bc", "logo2_up", "logo_txt2_enable" , "varimg", "horimg", "btncolor" ,"welcome","sub_banner_text","greeting_txt","is_active");
											...
											function valid_check(this_val,err_elem){
												...
												}else if(err_elem == 'sub_banner_text_validate'){
								...
								if($active_tab == 'create_theme'){
									echo ".zoomContainer{ display: block;  }";
								}else{
									echo ".zoomContainer{ display: none;  }";
								}
