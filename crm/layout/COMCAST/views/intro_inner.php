...
foreach ($main_mod_array as $keym => $valuem){
 ...
 ?>
	...
	<div class="intro-content">
		<a href="<?php  if($link_main_m_multy1=='intro'){ echo 'home'; }else{ echo $link_main_m_multy; } ?>"><b><?php echo $fullintroArray[$main_menu_name2]['desc']; ?>: </b> <?php echo $fullintroArray[$main_menu_name2]['extra']; ?></a>
	</div>
 </li>
