<style type="text/css">
    ...
    .ui-slider .ui-slider-range {
        ...
        font-size: .7em;
        display: block;
        border: 1px solid #146ed2 !important;
        /*box-shadow: 0 1px 0 #AAD6F6 inset;*/
        -moz-border-radius: 6px;
        -webkit-border-radius: 6px;
        -khtml-border-radius: 6px;
        border-radius: 6px;
        background: #1470d7 !important;
                ...
                <form id="tab5_form<?php echo$sID; ?>" name="tab5_form1" method="post" action="?t=2" class="form-horizontal">
                    ...
                    <fieldset class="fieset">
                        ...
                        <div>
                            ...
                            <div class="power_box2" style="    height: 558px;width: 30%;display: inline-block;    background: #d7d7d7;box-sizing: border-box;padding: 20px">
                                <h2>SSID :  <br>
