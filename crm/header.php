	...
	?>
		...
		<div class="navbar navbar-fixed-top" <?php if ($top_menu == 'bottom') { ?> style="display: none;" <?php } ?>>
			<div class="navbar-inner">
				<div id="container_id" class="container">
					...
					<div>
						<ul class="topnav">
							...
							<li><a href="?section=operation">Operations</a></li>
							<li><a href="?section=provision">Provisioning</a></li>
						</ul>
					</div>
				...
				<?php if(isset($_GET['section']) && $_GET['section'] == "operation" ) { ?>
				<div>
					<select>
						<option>Select Operation Account</option>
					</select>
				</div>
				<?php } ?>
				<?php if(isset($_GET['section']) && $_GET['section'] == "provision" ) { ?>
				<div>
					<select>
						<option>Select Provisioning Account</option>
					</select>
				</div>
				<?php } ?>
				<!-- /container -->
