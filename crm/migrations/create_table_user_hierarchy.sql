...
ALTER TABLE `crm_user_hierarchy`  
ADD CONSTRAINT `crm_user_hierarchy_ibfk_4` 
FOREIGN KEY (`category_id`) REFERENCES `crm_user_categories` (`id`) ON DELETE CASCADE; 




INSERT INTO `crm_user_hierarchy` (`operator_id`,`category_id`, `user_id`,`parent_id`,`is_enable`,`create_date`,`create_user`) 
VALUES ('MNO267',2,3443,0,1,'2023-02-08 16:14:26','admin');